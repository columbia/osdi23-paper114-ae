...
(** * Useful Notations *)
Notation "A =s B" := (String.eqb A B) (at level 50): string_scope.
Notation "A <>s B" := (negb (String.eqb A B)) (at level 50): string_scope.
Notation "A & B" := (Z.land A B) (at level 50): Z_scope.
Notation "A |' B" := (Z.lor A B) (at level 50): Z_scope.
Notation "A << B" := (Z.shiftl A B) (at level 30): Z_scope.
Notation "A >> B" := (Z.shiftr A B) (at level 30): Z_scope.
Notation "! A" := (negb A) (at level 70).
Notation "A <>? B" := (negb (A =? B)) (at level 50): Z_scope.
