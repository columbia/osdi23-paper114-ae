; ModuleID = 'crypto/evp/e_idea.c'
source_filename = "crypto/evp/e_idea.c"
...
@idea_cbc = internal constant %struct.evp_cipher_st { i32 34, i32 8, i32 16, i32 8, i64 2, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @idea_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @idea_cbc_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 216, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_set_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_get_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@idea_cfb64 = internal constant %struct.evp_cipher_st { i32 35, i32 1, i32 16, i32 8, i64 3, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @idea_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @idea_cfb64_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 216, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_set_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_get_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@idea_ofb = internal constant %struct.evp_cipher_st { i32 46, i32 1, i32 16, i32 8, i64 4, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @idea_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @idea_ofb_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 216, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_set_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_get_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@idea_ecb = internal constant %struct.evp_cipher_st { i32 36, i32 8, i32 16, i32 0, i64 1, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @idea_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @idea_ecb_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 216, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_set_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* @EVP_CIPHER_get_asn1_iv, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_idea_cbc() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @idea_cbc
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_idea_cfb64() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @idea_cfb64
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_idea_ofb() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @idea_ofb
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_idea_ecb() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @idea_ecb
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @idea_init_key(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %key, i8* nocapture noundef readnone %iv, i32 noundef %enc) #1 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call1 = tail call i32 @EVP_CIPHER_get_mode(%struct.evp_cipher_st* noundef %call) #4
...
if.else:                                          ; preds = %if.then
  ...
  br i1 %cmp5, label %if.then10, label %if.else12

if.then10:                                        ; preds = %if.else, %entry, %if.then
  %call11 = tail call i8* @EVP_CIPHER_CTX_get_cipher_data(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  %ks = bitcast i8* %call11 to %struct.idea_key_st*
  tail call void @IDEA_set_encrypt_key(i8* noundef %key, %struct.idea_key_st* noundef %ks) #4
  br label %if.end15

if.else12:                                        ; preds = %if.else
  %0 = bitcast %struct.idea_key_st* %tmp to i8*
  call void @llvm.lifetime.start.p0i8(i64 216, i8* nonnull %0) #5
  call void @IDEA_set_encrypt_key(i8* noundef %key, %struct.idea_key_st* noundef nonnull %tmp) #4
  %call13 = call i8* @EVP_CIPHER_CTX_get_cipher_data(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  %ks14 = bitcast i8* %call13 to %struct.idea_key_st*
  call void @IDEA_set_decrypt_key(%struct.idea_key_st* noundef nonnull %tmp, %struct.idea_key_st* noundef %ks14) #4
  call void @OPENSSL_cleanse(i8* noundef nonnull %0, i64 noundef 216) #4
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @idea_cbc_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %ks = bitcast i8* %call to %struct.idea_key_st*
  %call1 = tail call i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  tail call void @IDEA_cbc_encrypt(i8* noundef %in.addr.022, i8* noundef %out.addr.021, i64 noundef 4611686018427387904, %struct.idea_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32 noundef %call1) #4
...
if.then:                                          ; preds = %while.end
  ...
  %ks4 = bitcast i8* %call3 to %struct.idea_key_st*
  ...
  tail call void @IDEA_cbc_encrypt(i8* noundef %in.addr.0.lcssa, i8* noundef %out.addr.0.lcssa, i64 noundef %inl.addr.0.lcssa, %struct.idea_key_st* noundef %ks4, i8* noundef nonnull %arraydecay6, i32 noundef %call7) #4
  br label %if.end
...
declare void @IDEA_set_encrypt_key(i8* noundef, %struct.idea_key_st* noundef) local_unnamed_addr #2
...
declare void @IDEA_set_decrypt_key(%struct.idea_key_st* noundef, %struct.idea_key_st* noundef) local_unnamed_addr #2
...
declare void @IDEA_cbc_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.idea_key_st* noundef, i8* noundef, i32 noundef) local_unnamed_addr #2

declare i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define internal i32 @idea_cfb64_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %ks = bitcast i8* %call2 to %struct.idea_key_st*
  %call3 = call i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  call void @IDEA_cfb64_encrypt(i8* noundef %in.addr.031, i8* noundef %out.addr.030, i64 noundef %chunk.133, %struct.idea_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32* noundef nonnull %num, i32 noundef %call3) #4
...
declare void @IDEA_cfb64_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.idea_key_st* noundef, i8* noundef, i32* noundef, i32 noundef) local_unnamed_addr #2

declare i32 @EVP_CIPHER_CTX_set_num(%struct.evp_cipher_ctx_st* noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define internal i32 @idea_ofb_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
  %num = alloca i32, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %ks = bitcast i8* %call1 to %struct.idea_key_st*
  call void @IDEA_ofb64_encrypt(i8* noundef %in.addr.027, i8* noundef %out.addr.026, i64 noundef 4611686018427387904, %struct.idea_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32* noundef nonnull %num) #4
  %1 = load i32, i32* %num, align 4, !tbaa !6
...
if.then:                                          ; preds = %while.end
  ...
  %ks7 = bitcast i8* %call6 to %struct.idea_key_st*
  %arraydecay9 = getelementptr inbounds %struct.evp_cipher_ctx_st, %struct.evp_cipher_ctx_st* %ctx, i64 0, i32 5, i64 0
  call void @IDEA_ofb64_encrypt(i8* noundef %in.addr.0.lcssa, i8* noundef %out.addr.0.lcssa, i64 noundef %inl.addr.0.lcssa, %struct.idea_key_st* noundef %ks7, i8* noundef nonnull %arraydecay9, i32* noundef nonnull %num4) #4
...
declare void @IDEA_ofb64_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.idea_key_st* noundef, i8* noundef, i32* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define internal i32 @idea_ecb_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
  %call = tail call %struct.evp_cipher_st* @EVP_CIPHER_CTX_get0_cipher(%struct.evp_cipher_ctx_st* noundef %ctx) #4
...
for.body:                                         ; preds = %if.end, %for.body
  %i.017 = phi i64 [ 0, %if.end ], [ %add, %for.body ]
  %add.ptr = getelementptr inbounds i8, i8* %in, i64 %i.017
  %add.ptr4 = getelementptr inbounds i8, i8* %out, i64 %i.017
  %call5 = tail call i8* @EVP_CIPHER_CTX_get_cipher_data(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  %ks = bitcast i8* %call5 to %struct.idea_key_st*
  tail call void @IDEA_ecb_encrypt(i8* noundef %add.ptr, i8* noundef %add.ptr4, %struct.idea_key_st* noundef %ks) #4
...
declare void @IDEA_ecb_encrypt(i8* noundef, i8* noundef, %struct.idea_key_st* noundef) local_unnamed_addr #2
