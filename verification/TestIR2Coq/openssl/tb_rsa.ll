; ModuleID = 'crypto/engine/tb_rsa.c'
source_filename = "crypto/engine/tb_rsa.c"
...
@rsa_table = internal global %struct.st_engine_table* null, align 8
@dummy_nid = internal constant i32 1, align 4
@.str = private unnamed_addr constant [23 x i8] c"crypto/engine/tb_rsa.c\00", align 1

; Function Attrs: noinline nounwind uwtable
define void @ENGINE_unregister_RSA(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  tail call void @engine_table_unregister(%struct.st_engine_table** noundef nonnull @rsa_table, %struct.engine_st* noundef %e) #4
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_register_RSA(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %rsa_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 2
  %0 = load %struct.rsa_meth_st*, %struct.rsa_meth_st** %rsa_meth, align 8, !tbaa !4
  %tobool.not = icmp eq %struct.rsa_meth_st* %0, null
  br i1 %tobool.not, label %return, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @rsa_table, void ()* noundef nonnull @engine_unregister_all_RSA, %struct.engine_st* noundef nonnull %e, i32* noundef nonnull @dummy_nid, i32 noundef 1, i32 noundef 0) #4
  br label %return
...
entry:
  tail call void @engine_table_cleanup(%struct.st_engine_table** noundef nonnull @rsa_table) #4
  ret void
}

; Function Attrs: noinline nounwind uwtable
define void @ENGINE_register_all_RSA() local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %call1 = tail call i32 @ENGINE_register_RSA(%struct.engine_st* noundef nonnull %e.07) #5
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_set_default_RSA(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %rsa_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 2
  %0 = load %struct.rsa_meth_st*, %struct.rsa_meth_st** %rsa_meth, align 8, !tbaa !4
  %tobool.not = icmp eq %struct.rsa_meth_st* %0, null
...
if.then:                                          ; preds = %entry
  %call = tail call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @rsa_table, void ()* noundef nonnull @engine_unregister_all_RSA, %struct.engine_st* noundef nonnull %e, i32* noundef nonnull @dummy_nid, i32 noundef 1, i32 noundef 1) #4
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define %struct.engine_st* @ENGINE_get_default_RSA() local_unnamed_addr #0 {
entry:
  %call = tail call %struct.engine_st* @ossl_engine_table_select(%struct.st_engine_table** noundef nonnull @rsa_table, i32 noundef 1, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i32 noundef 62) #4
...
define %struct.rsa_meth_st* @ENGINE_get_RSA(%struct.engine_st* nocapture noundef readonly %e) local_unnamed_addr #2 {
entry:
  %rsa_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 2
  %0 = load %struct.rsa_meth_st*, %struct.rsa_meth_st** %rsa_meth, align 8, !tbaa !4
...
define i32 @ENGINE_set_RSA(%struct.engine_st* nocapture noundef writeonly %e, %struct.rsa_meth_st* noundef %rsa_meth) local_unnamed_addr #3 {
entry:
  %rsa_meth1 = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 2
  store %struct.rsa_meth_st* %rsa_meth, %struct.rsa_meth_st** %rsa_meth1, align 8, !tbaa !4
  ret i32 1
}
