; ModuleID = 'crypto/cryptlib.c'
source_filename = "crypto/cryptlib.c"
...
define void @OPENSSL_showfatal(i8* noundef %fmta, ...) local_unnamed_addr #0 {
entry:
  ...
  %call = call i32 @vfprintf(%struct._IO_FILE* noundef %1, i8* noundef %fmta, %struct.__va_list_tag* noundef nonnull %arraydecay) #8
...
define i32 @OPENSSL_isservice() local_unnamed_addr #4 {
entry:
  ret i32 0
}

; Function Attrs: noinline noreturn nounwind uwtable
define void @OPENSSL_die(i8* noundef %message, i8* noundef %file, i32 noundef %line) local_unnamed_addr #5 {
entry:
  tail call void (i8*, ...) @OPENSSL_showfatal(i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0), i8* noundef %file, i32 noundef %line, i8* noundef %message) #9
...
attributes #5 = { noinline noreturn nounwind uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
