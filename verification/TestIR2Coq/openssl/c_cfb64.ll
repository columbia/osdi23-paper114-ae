; ModuleID = 'crypto/cast/c_cfb64.c'
source_filename = "crypto/cast/c_cfb64.c"
...
define void @CAST_cfb64_encrypt(i8* nocapture noundef readonly %in, i8* nocapture noundef writeonly %out, i64 noundef %length, %struct.cast_key_st* noundef %schedule, i8* noundef %ivec, i32* nocapture noundef %num, i32 noundef %enc) local_unnamed_addr #0 {
entry:
...
if.then2:                                         ; preds = %while.body
  ...
  call void @CAST_encrypt(i32* noundef nonnull %arrayidx, %struct.cast_key_st* noundef %schedule) #4
...
if.then87:                                        ; preds = %while.body84
  ...
  call void @CAST_encrypt(i32* noundef nonnull %arrayidx109, %struct.cast_key_st* noundef %schedule) #4
