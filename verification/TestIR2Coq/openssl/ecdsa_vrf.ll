; ModuleID = 'crypto/ec/ecdsa_vrf.c'
source_filename = "crypto/ec/ecdsa_vrf.c"
...
%struct.ec_key_method_st = type { i8*, i32, i32 (%struct.ec_key_st*)*, void (%struct.ec_key_st*)*, i32 (%struct.ec_key_st*, %struct.ec_key_st*)*, i32 (%struct.ec_key_st*, %struct.ec_group_st*)*, i32 (%struct.ec_key_st*, %struct.bignum_st*)*, i32 (%struct.ec_key_st*, %struct.ec_point_st*)*, i32 (%struct.ec_key_st*)*, i32 (i8**, i64*, %struct.ec_point_st*, %struct.ec_key_st*)*, i32 (i32, i8*, i32, i8*, i32*, %struct.bignum_st*, %struct.bignum_st*, %struct.ec_key_st*)*, i32 (%struct.ec_key_st*, %struct.bignum_ctx*, %struct.bignum_st**, %struct.bignum_st**)*, %struct.ECDSA_SIG_st* (i8*, i32, %struct.bignum_st*, %struct.bignum_st*, %struct.ec_key_st*)*, i32 (i32, i8*, i32, i8*, i32, %struct.ec_key_st*)*, {}* }
...
@.str = private unnamed_addr constant [22 x i8] c"crypto/ec/ecdsa_vrf.c\00", align 1
...
define i32 @ECDSA_do_verify(i8* noundef %dgst, i32 noundef %dgst_len, %struct.ECDSA_SIG_st* noundef %sig, %struct.ec_key_st* noundef %eckey) local_unnamed_addr #0 {
entry:
  ...
  %verify_sig = getelementptr inbounds %struct.ec_key_method_st, %struct.ec_key_method_st* %0, i64 0, i32 14
  %verify_sig1 = bitcast {}** %verify_sig to i32 (i8*, i32, %struct.ECDSA_SIG_st*, %struct.ec_key_st*)**
  %1 = load i32 (i8*, i32, %struct.ECDSA_SIG_st*, %struct.ec_key_st*)*, i32 (i8*, i32, %struct.ECDSA_SIG_st*, %struct.ec_key_st*)** %verify_sig1, align 8, !tbaa !12
  %cmp.not = icmp eq i32 (i8*, i32, %struct.ECDSA_SIG_st*, %struct.ec_key_st*)* %1, null
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 %1(i8* noundef %dgst, i32 noundef %dgst_len, %struct.ECDSA_SIG_st* noundef %sig, %struct.ec_key_st* noundef nonnull %eckey) #2
  br label %return

if.end:                                           ; preds = %entry
  tail call void @ERR_new() #2
  tail call void @ERR_set_debug(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 noundef 31, i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @__func__.ECDSA_do_verify, i64 0, i64 0)) #2
  tail call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 16, i32 noundef 152, i8* noundef null) #2
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define i32 @ECDSA_verify(i32 noundef %type, i8* noundef %dgst, i32 noundef %dgst_len, i8* noundef %sigbuf, i32 noundef %sig_len, %struct.ec_key_st* noundef %eckey) local_unnamed_addr #0 {
entry:
  %meth = getelementptr inbounds %struct.ec_key_st, %struct.ec_key_st* %eckey, i64 0, i32 0
  %0 = load %struct.ec_key_method_st*, %struct.ec_key_method_st** %meth, align 8, !tbaa !4
  %verify = getelementptr inbounds %struct.ec_key_method_st, %struct.ec_key_method_st* %0, i64 0, i32 13
  %1 = load i32 (i32, i8*, i32, i8*, i32, %struct.ec_key_st*)*, i32 (i32, i8*, i32, i8*, i32, %struct.ec_key_st*)** %verify, align 8, !tbaa !14
  %cmp.not = icmp eq i32 (i32, i8*, i32, i8*, i32, %struct.ec_key_st*)* %1, null
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 %1(i32 noundef %type, i8* noundef %dgst, i32 noundef %dgst_len, i8* noundef %sigbuf, i32 noundef %sig_len, %struct.ec_key_st* noundef nonnull %eckey) #2
  br label %return

if.end:                                           ; preds = %entry
  tail call void @ERR_new() #2
  tail call void @ERR_set_debug(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 noundef 47, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @__func__.ECDSA_verify, i64 0, i64 0)) #2
  tail call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 16, i32 noundef 152, i8* noundef null) #2
  br label %return
