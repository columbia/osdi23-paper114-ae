; ModuleID = 'crypto/asn1/a_utctm.c'
source_filename = "crypto/asn1/a_utctm.c"
...
define %struct.asn1_string_st* @ASN1_UTCTIME_dup(%struct.asn1_string_st* noundef %x) local_unnamed_addr #0 {
entry:
  %call = tail call %struct.ASN1_ITEM_st* @ASN1_UTCTIME_it() #4
...
declare %struct.ASN1_ITEM_st* @ASN1_UTCTIME_it() local_unnamed_addr #1

; Function Attrs: noinline nounwind uwtable
define i32 @ossl_asn1_utctime_to_tm(%struct.tm* noundef %tm, %struct.asn1_string_st* noundef %d) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  %call = tail call i32 @ossl_asn1_time_to_tm(%struct.tm* noundef %tm, %struct.asn1_string_st* noundef nonnull %d) #4
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define i32 @ASN1_UTCTIME_check(%struct.asn1_string_st* noundef %d) local_unnamed_addr #0 {
entry:
  %call = tail call i32 @ossl_asn1_utctime_to_tm(%struct.tm* noundef null, %struct.asn1_string_st* noundef %d) #5
  ret i32 %call
}

; Function Attrs: noinline nounwind uwtable
define i32 @ASN1_UTCTIME_set_string(%struct.asn1_string_st* noundef %s, i8* noundef %str) local_unnamed_addr #0 {
entry:
  ...
  %call1 = call i32 @ASN1_UTCTIME_check(%struct.asn1_string_st* noundef nonnull %t) #5
...
; Function Attrs: noinline nounwind uwtable
define %struct.asn1_string_st* @ASN1_UTCTIME_set(%struct.asn1_string_st* noundef %s, i64 noundef %t) local_unnamed_addr #0 {
entry:
  %call = tail call %struct.asn1_string_st* @ASN1_UTCTIME_adj(%struct.asn1_string_st* noundef %s, i64 noundef %t, i32 noundef 0, i64 noundef 0) #5
  ret %struct.asn1_string_st* %call
}

; Function Attrs: noinline nounwind uwtable
define %struct.asn1_string_st* @ASN1_UTCTIME_adj(%struct.asn1_string_st* noundef %s, i64 noundef %t, i32 noundef %offset_day, i64 noundef %offset_sec) local_unnamed_addr #0 {
entry:
...
if.end7:                                          ; preds = %if.then2, %if.end
  %call8 = call %struct.asn1_string_st* @ossl_asn1_time_from_tm(%struct.asn1_string_st* noundef %s, %struct.tm* noundef nonnull %call, i32 noundef 23) #4
  br label %cleanup
...
; Function Attrs: noinline nounwind uwtable
define i32 @ASN1_UTCTIME_cmp_time_t(%struct.asn1_string_st* noundef %s, i64 noundef %t) local_unnamed_addr #0 {
entry:
  %t.addr = alloca i64, align 8
  ...
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %1) #6
  %2 = bitcast i32* %day to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #6
  %3 = bitcast i32* %sec to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #6
  %call = call i32 @ossl_asn1_utctime_to_tm(%struct.tm* noundef nonnull %stm, %struct.asn1_string_st* noundef %s) #5
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %call1 = call %struct.tm* @OPENSSL_gmtime(i64* noundef nonnull %t.addr, %struct.tm* noundef nonnull %ttm) #4
  %cmp = icmp eq %struct.tm* %call1, null
  br i1 %cmp, label %cleanup, label %if.end3

if.end3:                                          ; preds = %if.end
  %call4 = call i32 @OPENSSL_gmtime_diff(i32* noundef nonnull %day, i32* noundef nonnull %sec, %struct.tm* noundef nonnull %ttm, %struct.tm* noundef nonnull %stm) #4
...
cleanup:                                          ; preds = %if.end11, %if.end7, %if.end3, %if.end, %entry
  %retval.0 = phi i32 [ -2, %entry ], [ -2, %if.end ], [ -2, %if.end3 ], [ 1, %if.end7 ], [ %., %if.end11 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #6
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #6
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %1) #6
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %0) #6
  ret i32 %retval.0
}

declare i32 @OPENSSL_gmtime_diff(i32* noundef, i32* noundef, %struct.tm* noundef, %struct.tm* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind uwtable
define i32 @ASN1_UTCTIME_print(%struct.bio_st* noundef %bp, %struct.asn1_string_st* noundef %tm) local_unnamed_addr #0 {
entry:
