; ModuleID = 'test/bn_internal_test.c'
source_filename = "test/bn_internal_test.c"
...
@.str = private unnamed_addr constant [24 x i8] c"test/bn_internal_test.c\00", align 1
...
entry:
  ...
  store %struct.bignum_ctx* %call, %struct.bignum_ctx** @ctx, align 8, !tbaa !3
  %0 = bitcast %struct.bignum_ctx* %call to i8*
  %call1 = tail call i32 @test_ptr(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* noundef %0) #3
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %return, label %if.end

if.end:                                           ; preds = %entry
  tail call void @add_test(i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0), i32 ()* noundef nonnull @test_is_prime_enhanced) #3
  tail call void @add_all_tests(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0), i32 (i32)* noundef nonnull @test_is_composite_enhanced, i32 noundef 5, i32 noundef 1) #3
  tail call void @add_test(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0), i32 ()* noundef nonnull @test_bn_small_factors) #3
  br label %return
...
entry:
  ...
  store i32 0, i32* %status, align 4, !tbaa !7
  %call = tail call %struct.bignum_st* @BN_new() #3
  %1 = bitcast %struct.bignum_st* %call to i8*
  %call1 = tail call i32 @test_ptr(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 33, i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), i8* noundef %1) #3
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %land.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %call2 = tail call i32 @BN_set_word(%struct.bignum_st* noundef %call, i64 noundef 11) #3
  %cmp = icmp ne i32 %call2, 0
  %conv = zext i1 %cmp to i32
  %call3 = tail call i32 @test_true(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 35, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i64 0, i64 0), i32 noundef %conv) #3
  %tobool4.not = icmp eq i32 %call3, 0
  br i1 %tobool4.not, label %land.end, label %land.lhs.true5

land.lhs.true5:                                   ; preds = %land.lhs.true
  %2 = load %struct.bignum_ctx*, %struct.bignum_ctx** @ctx, align 8, !tbaa !3
  %call6 = call i32 @ossl_bn_miller_rabin_is_prime(%struct.bignum_st* noundef %call, i32 noundef 10, %struct.bignum_ctx* noundef %2, %struct.bn_gencb_st* noundef null, i32 noundef 1, i32* noundef nonnull %status) #3
  %cmp7 = icmp ne i32 %call6, 0
  %conv8 = zext i1 %cmp7 to i32
  %call9 = call i32 @test_true(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 38, i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str.7, i64 0, i64 0), i32 noundef %conv8) #3
  %tobool10.not = icmp eq i32 %call9, 0
  br i1 %tobool10.not, label %land.end, label %land.rhs

land.rhs:                                         ; preds = %land.lhs.true5
  %3 = load i32, i32* %status, align 4, !tbaa !7
  %call11 = call i32 @test_int_eq(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 39, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i64 0, i64 0), i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str.9, i64 0, i64 0), i32 noundef %3, i32 noundef 3) #3
...
entry:
  ...
  %call = tail call %struct.bignum_st* @BN_new() #3
  %1 = bitcast %struct.bignum_st* %call to i8*
  %call1 = tail call i32 @test_ptr(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), i8* noundef %1) #3
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %land.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %idxprom = sext i32 %id to i64
  %arrayidx = getelementptr inbounds [5 x i32], [5 x i32]* @composites, i64 0, i64 %idxprom
  %2 = load i32, i32* %arrayidx, align 4, !tbaa !7
  %conv = sext i32 %2 to i64
  %call2 = tail call i32 @BN_set_word(%struct.bignum_st* noundef %call, i64 noundef %conv) #3
  %cmp = icmp ne i32 %call2, 0
  %conv3 = zext i1 %cmp to i32
  %call4 = tail call i32 @test_true(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.10, i64 0, i64 0), i32 noundef %conv3) #3
  %tobool5.not = icmp eq i32 %call4, 0
  br i1 %tobool5.not, label %land.end, label %land.lhs.true6

land.lhs.true6:                                   ; preds = %land.lhs.true
  %3 = load %struct.bignum_ctx*, %struct.bignum_ctx** @ctx, align 8, !tbaa !3
  %call7 = call i32 @ossl_bn_miller_rabin_is_prime(%struct.bignum_st* noundef %call, i32 noundef 10, %struct.bignum_ctx* noundef %3, %struct.bn_gencb_st* noundef null, i32 noundef 1, i32* noundef nonnull %status) #3
  %cmp8 = icmp ne i32 %call7, 0
  %conv9 = zext i1 %cmp8 to i32
  %call10 = call i32 @test_true(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str.7, i64 0, i64 0), i32 noundef %conv9) #3
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %land.end, label %land.rhs

land.rhs:                                         ; preds = %land.lhs.true6
  %4 = load i32, i32* %status, align 4, !tbaa !7
  %call12 = call i32 @test_int_ne(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 59, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i64 0, i64 0), i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str.9, i64 0, i64 0), i32 noundef %4, i32 noundef 3) #3
  %tobool13 = icmp ne i32 %call12, 0
  %phi.cast = zext i1 %tobool13 to i32
  br label %land.end

land.end:                                         ; preds = %land.rhs, %land.lhs.true6, %land.lhs.true, %entry
  %5 = phi i32 [ 0, %land.lhs.true6 ], [ 0, %land.lhs.true ], [ 0, %entry ], [ %phi.cast, %land.rhs ]
  call void @BN_free(%struct.bignum_st* noundef %call) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #4
  ret i32 %5
}
...
entry:
  ...
  %call1 = tail call i32 @test_ptr(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.11, i64 0, i64 0), i8* noundef %0) #3
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %cleanup27, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %call2 = tail call i32 @BN_set_word(%struct.bignum_st* noundef %call, i64 noundef 3) #3
  %cmp = icmp ne i32 %call2, 0
  %conv = zext i1 %cmp to i32
  %call3 = tail call i32 @test_true(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.12, i64 0, i64 0), i32 noundef %conv) #3
  %tobool4.not = icmp eq i32 %call3, 0
  br i1 %tobool4.not, label %cleanup27, label %for.body

for.body:                                         ; preds = %land.lhs.true, %for.body.backedge
  %i.046 = phi i32 [ %i.046.be, %for.body.backedge ], [ 1, %land.lhs.true ]
  %idxprom = zext i32 %i.046 to i64
  %arrayidx = getelementptr inbounds [2048 x i16], [2048 x i16]* @primes, i64 0, i64 %idxprom
  %1 = load i16, i16* %arrayidx, align 2, !tbaa !9
  %2 = add i16 %1, -4
  %3 = icmp ult i16 %2, 748
  br i1 %3, label %land.lhs.true14, label %if.end19

land.lhs.true14:                                  ; preds = %for.body
  %conv15 = zext i16 %1 to i64
  %call16 = tail call i32 @BN_mul_word(%struct.bignum_st* noundef %call, i64 noundef %conv15) #3
  %tobool17.not = icmp eq i32 %call16, 0
  br i1 %tobool17.not, label %cleanup27, label %for.inc

if.end19:                                         ; preds = %for.body
  %cmp21 = icmp ult i16 %1, 752
  %cmp5 = icmp ult i32 %i.046, 2047
  %or.cond = select i1 %cmp21, i1 %cmp5, i1 false
  br i1 %or.cond, label %for.body.backedge, label %for.end

for.inc:                                          ; preds = %land.lhs.true14
  %cmp5.old = icmp ult i32 %i.046, 2047
  br i1 %cmp5.old, label %for.body.backedge, label %for.end

for.body.backedge:                                ; preds = %for.inc, %if.end19
  %i.046.be = add nuw nsw i32 %i.046, 1
  br label %for.body, !llvm.loop !11

for.end:                                          ; preds = %if.end19, %for.inc
  %call25 = tail call %struct.bignum_st* @ossl_bn_get0_small_factors() #3
  %call26 = tail call i32 @test_BN_eq(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.13, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.14, i64 0, i64 0), %struct.bignum_st* noundef %call25, %struct.bignum_st* noundef %call) #3
  br label %cleanup27

cleanup27:                                        ; preds = %land.lhs.true14, %for.end, %land.lhs.true, %entry
  %ret.0 = phi i32 [ %call26, %for.end ], [ 0, %land.lhs.true ], [ 0, %entry ], [ 0, %land.lhs.true14 ]
  tail call void @BN_free(%struct.bignum_st* noundef %call) #3
  ret i32 %ret.0
}
...
entry:
  %0 = load %struct.bignum_ctx*, %struct.bignum_ctx** @ctx, align 8, !tbaa !3
  tail call void @BN_CTX_free(%struct.bignum_ctx* noundef %0) #3
  ret void
}
...
declare dso_local i32 @ossl_bn_miller_rabin_is_prime(%struct.bignum_st* noundef, i32 noundef, %struct.bignum_ctx* noundef, %struct.bn_gencb_st* noundef, i32 noundef, i32* noundef) local_unnamed_addr #1
...
declare dso_local i32 @BN_mul_word(%struct.bignum_st* noundef, i64 noundef) local_unnamed_addr #1
...
declare dso_local %struct.bignum_st* @ossl_bn_get0_small_factors() local_unnamed_addr #1
