; ModuleID = 'crypto/engine/tb_dh.c'
source_filename = "crypto/engine/tb_dh.c"
...
@.str = private unnamed_addr constant [22 x i8] c"crypto/engine/tb_dh.c\00", align 1

; Function Attrs: noinline nounwind uwtable
define void @ENGINE_unregister_DH(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_register_DH(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %dh_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 4
  %0 = load %struct.dh_method*, %struct.dh_method** %dh_meth, align 8, !tbaa !4
  %tobool.not = icmp eq %struct.dh_method* %0, null
  br i1 %tobool.not, label %return, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @dh_table, void ()* noundef nonnull @engine_unregister_all_DH, %struct.engine_st* noundef nonnull %e, i32* noundef nonnull @dummy_nid, i32 noundef 1, i32 noundef 0) #4
  br label %return
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %call1 = tail call i32 @ENGINE_register_DH(%struct.engine_st* noundef nonnull %e.07) #5
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_set_default_DH(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %dh_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 4
  %0 = load %struct.dh_method*, %struct.dh_method** %dh_meth, align 8, !tbaa !4
  %tobool.not = icmp eq %struct.dh_method* %0, null
...
if.then:                                          ; preds = %entry
  %call = tail call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @dh_table, void ()* noundef nonnull @engine_unregister_all_DH, %struct.engine_st* noundef nonnull %e, i32* noundef nonnull @dummy_nid, i32 noundef 1, i32 noundef 1) #4
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define %struct.engine_st* @ENGINE_get_default_DH() local_unnamed_addr #0 {
entry:
  %call = tail call %struct.engine_st* @ossl_engine_table_select(%struct.st_engine_table** noundef nonnull @dh_table, i32 noundef 1, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 noundef 62) #4
...
define %struct.dh_method* @ENGINE_get_DH(%struct.engine_st* nocapture noundef readonly %e) local_unnamed_addr #2 {
entry:
  %dh_meth = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 4
  %0 = load %struct.dh_method*, %struct.dh_method** %dh_meth, align 8, !tbaa !4
...
define i32 @ENGINE_set_DH(%struct.engine_st* nocapture noundef writeonly %e, %struct.dh_method* noundef %dh_meth) local_unnamed_addr #3 {
entry:
  %dh_meth1 = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 4
  store %struct.dh_method* %dh_meth, %struct.dh_method** %dh_meth1, align 8, !tbaa !4
  ret i32 1
}
