; ModuleID = 'crypto/ripemd/rmd_one.c'
source_filename = "crypto/ripemd/rmd_one.c"
...
define i8* @RIPEMD160(i8* noundef %d, i64 noundef %n, i8* noundef %md) local_unnamed_addr #0 {
entry:
  ...
  %spec.store.select = select i1 %cmp, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @RIPEMD160.m, i64 0, i64 0), i8* %md
  %call = call i32 @RIPEMD160_Init(%struct.RIPEMD160state_st* noundef nonnull %c) #4
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %cleanup, label %if.end2

if.end2:                                          ; preds = %entry
  %call3 = call i32 @RIPEMD160_Update(%struct.RIPEMD160state_st* noundef nonnull %c, i8* noundef %d, i64 noundef %n) #4
  %call4 = call i32 @RIPEMD160_Final(i8* noundef %spec.store.select, %struct.RIPEMD160state_st* noundef nonnull %c) #4
