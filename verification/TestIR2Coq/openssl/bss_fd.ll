; ModuleID = 'crypto/bio/bss_fd.c'
source_filename = "crypto/bio/bss_fd.c"
...
@methods_fdp = internal constant %struct.bio_method_st { i32 1284, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i32 (%struct.bio_st*, i8*, i64, i64*)* @bwrite_conv, i32 (%struct.bio_st*, i8*, i32)* @fd_write, i32 (%struct.bio_st*, i8*, i64, i64*)* @bread_conv, i32 (%struct.bio_st*, i8*, i32)* @fd_read, i32 (%struct.bio_st*, i8*)* @fd_puts, i32 (%struct.bio_st*, i8*, i32)* @fd_gets, i64 (%struct.bio_st*, i32, i64, i8*)* @fd_ctrl, i32 (%struct.bio_st*)* @fd_new, i32 (%struct.bio_st*)* @fd_free, i64 (%struct.bio_st*, i32, i32 (%struct.bio_st*, i32, i32)*)* null }, align 8
@.str = private unnamed_addr constant [16 x i8] c"file descriptor\00", align 1

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.bio_method_st* @BIO_s_fd() local_unnamed_addr #0 {
entry:
  ret %struct.bio_method_st* @methods_fdp
}

; Function Attrs: noinline nounwind uwtable
define %struct.bio_st* @BIO_new_fd(i32 noundef %fd, i32 noundef %close_flag) local_unnamed_addr #1 {
entry:
  %call1 = tail call %struct.bio_st* @BIO_new(%struct.bio_method_st* noundef nonnull @methods_fdp) #8
  %cmp = icmp eq %struct.bio_st* %call1, null
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %conv = sext i32 %close_flag to i64
  %call2 = tail call i64 @BIO_int_ctrl(%struct.bio_st* noundef nonnull %call1, i32 noundef 104, i64 noundef %conv, i32 noundef %fd) #8
  br label %cleanup
...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 @BIO_fd_non_fatal_error(i32 noundef %2) #10
  br label %cleanup
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @fd_write(%struct.bio_st* noundef %b, i8* noundef %in, i32 noundef %inl) #1 {
entry:
  %call = tail call i32* @__errno_location() #9
  ...
  %call1 = tail call i64 @write(i32 noundef %0, i8* noundef %in, i64 noundef %conv) #8
  %conv2 = trunc i64 %call1 to i32
  tail call void @BIO_clear_flags(%struct.bio_st* noundef %b, i32 noundef 15) #8
  %cmp = icmp slt i32 %conv2, 1
  br i1 %cmp, label %if.then, label %if.end6

if.then:                                          ; preds = %entry
  %call4 = tail call i32 @BIO_fd_should_retry(i32 noundef %conv2) #10
  %tobool.not = icmp eq i32 %call4, 0
  br i1 %tobool.not, label %if.end6, label %if.then5

if.then5:                                         ; preds = %if.then
  tail call void @BIO_set_flags(%struct.bio_st* noundef nonnull %b, i32 noundef 10) #8
  br label %if.end6
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @fd_read(%struct.bio_st* noundef %b, i8* noundef %out, i32 noundef %outl) #1 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call1 = tail call i64 @read(i32 noundef %0, i8* noundef nonnull %out, i64 noundef %conv) #8
  %conv2 = trunc i64 %call1 to i32
  tail call void @BIO_clear_flags(%struct.bio_st* noundef %b, i32 noundef 15) #8
...
if.then5:                                         ; preds = %if.then
  %call6 = tail call i32 @BIO_fd_should_retry(i32 noundef %conv2) #10
  %tobool.not = icmp eq i32 %call6, 0
  br i1 %tobool.not, label %if.else, label %if.then7

if.then7:                                         ; preds = %if.then5
  tail call void @BIO_set_flags(%struct.bio_st* noundef nonnull %b, i32 noundef 9) #8
  br label %if.end13
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @fd_puts(%struct.bio_st* noundef %bp, i8* noundef %str) #1 {
entry:
  %call = tail call i64 @strlen(i8* noundef %str) #11
  %conv = trunc i64 %call to i32
  %call1 = tail call i32 @fd_write(%struct.bio_st* noundef %bp, i8* noundef %str, i32 noundef %conv) #10
  ret i32 %call1
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @fd_gets(%struct.bio_st* noundef %bp, i8* noundef %buf, i32 noundef %size) #1 {
entry:
...
while.cond:                                       ; preds = %while.body, %entry
  %ptr.0 = phi i8* [ %buf, %entry ], [ %incdec.ptr, %while.body ]
  %cmp = icmp ult i8* %ptr.0, %add.ptr1
  br i1 %cmp, label %land.rhs, label %while.end

land.rhs:                                         ; preds = %while.cond
  %call = tail call i32 @fd_read(%struct.bio_st* noundef %bp, i8* noundef %ptr.0, i32 noundef 1) #10
  %cmp2 = icmp sgt i32 %call, 0
  br i1 %cmp2, label %while.body, label %while.end

while.body:                                       ; preds = %land.rhs
  %incdec.ptr = getelementptr inbounds i8, i8* %ptr.0, i64 1
  %0 = load i8, i8* %ptr.0, align 1, !tbaa !14
  %cmp3 = icmp eq i8 %0, 10
  br i1 %cmp3, label %while.end, label %while.cond, !llvm.loop !15

while.end:                                        ; preds = %while.cond, %while.body, %land.rhs
  %ptr.1 = phi i8* [ %incdec.ptr, %while.body ], [ %ptr.0, %land.rhs ], [ %ptr.0, %while.cond ]
  store i8 0, i8* %ptr.1, align 1, !tbaa !14
  %1 = load i8, i8* %buf, align 1, !tbaa !14
  %cmp7.not = icmp eq i8 %1, 0
  br i1 %cmp7.not, label %if.end12, label %if.then9

if.then9:                                         ; preds = %while.end
  %call10 = tail call i64 @strlen(i8* noundef nonnull %buf) #11
...
; Function Attrs: noinline nounwind uwtable
define internal i64 @fd_ctrl(%struct.bio_st* noundef %b, i32 noundef %cmd, i64 noundef %num, i8* noundef %ptr) #1 {
entry:
...
sw.bb1:                                           ; preds = %entry, %sw.bb
  ...
  %num2 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 9
  %0 = load i32, i32* %num2, align 8, !tbaa !8
  %call = tail call i64 @lseek(i32 noundef %0, i64 noundef %num.addr.0, i32 noundef 0) #8
  br label %sw.epilog

sw.bb3:                                           ; preds = %entry, %entry
  %num4 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 9
  %1 = load i32, i32* %num4, align 8, !tbaa !8
  %call5 = tail call i64 @lseek(i32 noundef %1, i64 noundef 0, i32 noundef 1) #8
  br label %sw.epilog

sw.bb6:                                           ; preds = %entry
  %call7 = tail call i32 @fd_free(%struct.bio_st* noundef %b) #10
  %2 = bitcast i8* %ptr to i32*
  %3 = load i32, i32* %2, align 4, !tbaa !4
  %num8 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 9
  store i32 %3, i32* %num8, align 8, !tbaa !8
  %conv = trunc i64 %num to i32
  %shutdown = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 6
  store i32 %conv, i32* %shutdown, align 4, !tbaa !17
  %init = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 5
  store i32 1, i32* %init, align 8, !tbaa !18
  br label %sw.epilog

sw.bb9:                                           ; preds = %entry
  %init10 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 5
  %4 = load i32, i32* %init10, align 8, !tbaa !18
...
if.then12:                                        ; preds = %if.then
  ...
  %num13 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 9
  %6 = load i32, i32* %num13, align 8, !tbaa !8
  store i32 %6, i32* %5, align 4, !tbaa !4
  br label %if.end

if.end:                                           ; preds = %if.then12, %if.then
  %num14 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 9
  %7 = load i32, i32* %num14, align 8, !tbaa !8
  %conv15 = sext i32 %7 to i64
  br label %sw.epilog

sw.bb17:                                          ; preds = %entry
  %shutdown18 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 6
  %8 = load i32, i32* %shutdown18, align 4, !tbaa !17
  %conv19 = sext i32 %8 to i64
  br label %sw.epilog

sw.bb20:                                          ; preds = %entry
  %conv21 = trunc i64 %num to i32
  %shutdown22 = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 6
  store i32 %conv21, i32* %shutdown22, align 4, !tbaa !17
  br label %sw.epilog
...
sw.bb25:                                          ; preds = %entry
  %flags = getelementptr inbounds %struct.bio_st, %struct.bio_st* %b, i64 0, i32 7
  %9 = load i32, i32* %flags, align 8, !tbaa !13
  %and = lshr i32 %9, 11
  %and.lobit = and i32 %and, 1
  %10 = zext i32 %and.lobit to i64
  br label %sw.epilog

sw.epilog:                                        ; preds = %entry, %sw.bb9, %if.end, %sw.bb25, %sw.bb24, %sw.bb20, %sw.bb17, %sw.bb6, %sw.bb3, %sw.bb1
  %ret.0 = phi i64 [ %10, %sw.bb25 ], [ 1, %sw.bb24 ], [ 1, %sw.bb20 ], [ %conv19, %sw.bb17 ], [ %conv15, %if.end ], [ 1, %sw.bb6 ], [ %call5, %sw.bb3 ], [ %call, %sw.bb1 ], [ -1, %sw.bb9 ], [ 0, %entry ]
  ret i64 %ret.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind uwtable willreturn writeonly
define internal i32 @fd_new(%struct.bio_st* nocapture noundef writeonly %bi) #5 {
entry:
  %init = getelementptr inbounds %struct.bio_st, %struct.bio_st* %bi, i64 0, i32 5
  store i32 0, i32* %init, align 8, !tbaa !18
  %num = getelementptr inbounds %struct.bio_st, %struct.bio_st* %bi, i64 0, i32 9
  store i32 -1, i32* %num, align 8, !tbaa !8
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @fd_free(%struct.bio_st* noundef %a) #1 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %0 = load i32, i32* %shutdown, align 4, !tbaa !17
...
if.then1:                                         ; preds = %if.end
  ...
  %1 = load i32, i32* %init, align 8, !tbaa !18
