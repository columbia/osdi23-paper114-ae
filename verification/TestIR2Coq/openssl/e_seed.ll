; ModuleID = 'crypto/evp/e_seed.c'
source_filename = "crypto/evp/e_seed.c"
...
@seed_cbc = internal constant %struct.evp_cipher_st { i32 777, i32 16, i32 16, i32 16, i64 2, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @seed_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @seed_cbc_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 128, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@seed_cfb128 = internal constant %struct.evp_cipher_st { i32 779, i32 1, i32 16, i32 16, i64 3, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @seed_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @seed_cfb128_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 128, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@seed_ofb = internal constant %struct.evp_cipher_st { i32 778, i32 1, i32 16, i32 16, i64 4, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @seed_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @seed_ofb_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 128, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8
@seed_ecb = internal constant %struct.evp_cipher_st { i32 776, i32 16, i32 16, i32 0, i64 1, i32 1, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i32)* @seed_init_key, i32 (%struct.evp_cipher_ctx_st*, i8*, i8*, i64)* @seed_ecb_cipher, i32 (%struct.evp_cipher_ctx_st*)* null, i32 128, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, %struct.asn1_type_st*)* null, i32 (%struct.evp_cipher_ctx_st*, i32, i32, i8*)* null, i8* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64, i8*, i64, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64*, i64, i8*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_seed_cbc() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @seed_cbc
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_seed_cfb128() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @seed_cfb128
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_seed_ofb() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @seed_ofb
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_cipher_st* @EVP_seed_ecb() local_unnamed_addr #0 {
entry:
  ret %struct.evp_cipher_st* @seed_ecb
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @seed_init_key(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %key, i8* nocapture noundef readnone %iv, i32 noundef %enc) #1 {
entry:
  %call = tail call i8* @EVP_CIPHER_CTX_get_cipher_data(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  %ks = bitcast i8* %call to %struct.seed_key_st*
  tail call void @SEED_set_key(i8* noundef %key, %struct.seed_key_st* noundef %ks) #4
  ret i32 1
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @seed_cbc_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  tail call void @SEED_cbc_encrypt(i8* noundef %in.addr.022, i8* noundef %out.addr.021, i64 noundef 4611686018427387904, %struct.seed_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32 noundef %call1) #4
...
if.then:                                          ; preds = %while.end
  ...
  %ks4 = bitcast i8* %call3 to %struct.seed_key_st*
  ...
  tail call void @SEED_cbc_encrypt(i8* noundef %in.addr.0.lcssa, i8* noundef %out.addr.0.lcssa, i64 noundef %inl.addr.0.lcssa, %struct.seed_key_st* noundef %ks4, i8* noundef nonnull %arraydecay6, i32 noundef %call7) #4
  br label %if.end
...
declare void @SEED_set_key(i8* noundef, %struct.seed_key_st* noundef) local_unnamed_addr #2

declare i8* @EVP_CIPHER_CTX_get_cipher_data(%struct.evp_cipher_ctx_st* noundef) local_unnamed_addr #2

declare void @SEED_cbc_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.seed_key_st* noundef, i8* noundef, i32 noundef) local_unnamed_addr #2

declare i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define internal i32 @seed_cfb128_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %ks = bitcast i8* %call2 to %struct.seed_key_st*
  %call3 = call i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  call void @SEED_cfb128_encrypt(i8* noundef %in.addr.031, i8* noundef %out.addr.030, i64 noundef %chunk.133, %struct.seed_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32* noundef nonnull %num, i32 noundef %call3) #4
...
declare void @SEED_cfb128_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.seed_key_st* noundef, i8* noundef, i32* noundef, i32 noundef) local_unnamed_addr #2
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @seed_ofb_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
  %num = alloca i32, align 4
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  %ks = bitcast i8* %call1 to %struct.seed_key_st*
  call void @SEED_ofb128_encrypt(i8* noundef %in.addr.027, i8* noundef %out.addr.026, i64 noundef 4611686018427387904, %struct.seed_key_st* noundef %ks, i8* noundef nonnull %arraydecay, i32* noundef nonnull %num) #4
  %1 = load i32, i32* %num, align 4, !tbaa !6
...
if.then:                                          ; preds = %while.end
  ...
  %ks7 = bitcast i8* %call6 to %struct.seed_key_st*
  %arraydecay9 = getelementptr inbounds %struct.evp_cipher_ctx_st, %struct.evp_cipher_ctx_st* %ctx, i64 0, i32 5, i64 0
  call void @SEED_ofb128_encrypt(i8* noundef %in.addr.0.lcssa, i8* noundef %out.addr.0.lcssa, i64 noundef %inl.addr.0.lcssa, %struct.seed_key_st* noundef %ks7, i8* noundef nonnull %arraydecay9, i32* noundef nonnull %num4) #4
...
declare void @SEED_ofb128_encrypt(i8* noundef, i8* noundef, i64 noundef, %struct.seed_key_st* noundef, i8* noundef, i32* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define internal i32 @seed_ecb_cipher(%struct.evp_cipher_ctx_st* noundef %ctx, i8* noundef %out, i8* noundef %in, i64 noundef %inl) #1 {
entry:
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  %ks = bitcast i8* %call5 to %struct.seed_key_st*
  %call6 = tail call i32 @EVP_CIPHER_CTX_is_encrypting(%struct.evp_cipher_ctx_st* noundef %ctx) #4
  tail call void @SEED_ecb_encrypt(i8* noundef %add.ptr, i8* noundef %add.ptr4, %struct.seed_key_st* noundef %ks, i32 noundef %call6) #4
...
declare void @SEED_ecb_encrypt(i8* noundef, i8* noundef, %struct.seed_key_st* noundef, i32 noundef) local_unnamed_addr #2
