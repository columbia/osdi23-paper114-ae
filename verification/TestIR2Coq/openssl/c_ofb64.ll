; ModuleID = 'crypto/cast/c_ofb64.c'
source_filename = "crypto/cast/c_ofb64.c"
...
define void @CAST_ofb64_encrypt(i8* nocapture noundef readonly %in, i8* nocapture noundef writeonly %out, i64 noundef %length, %struct.cast_key_st* noundef %schedule, i8* nocapture noundef %ivec, i32* nocapture noundef %num) local_unnamed_addr #0 {
entry:
