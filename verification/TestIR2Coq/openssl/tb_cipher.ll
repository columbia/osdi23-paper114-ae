; ModuleID = 'crypto/engine/tb_cipher.c'
source_filename = "crypto/engine/tb_cipher.c"
...
@cipher_table = internal global %struct.st_engine_table* null, align 8
@.str = private unnamed_addr constant [26 x i8] c"crypto/engine/tb_cipher.c\00", align 1
@__func__.ENGINE_get_cipher = private unnamed_addr constant [18 x i8] c"ENGINE_get_cipher\00", align 1

; Function Attrs: noinline nounwind uwtable
define void @ENGINE_unregister_ciphers(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  tail call void @engine_table_unregister(%struct.st_engine_table** noundef nonnull @cipher_table, %struct.engine_st* noundef %e) #5
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_register_ciphers(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %nids = alloca i32*, align 8
  %ciphers = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 7
  %0 = load i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)*, i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)** %ciphers, align 8, !tbaa !4
  %tobool.not = icmp eq i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* %0, null
  br i1 %tobool.not, label %return, label %if.then

if.then:                                          ; preds = %entry
  %1 = bitcast i32** %nids to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %1) #6
  %call = call i32 %0(%struct.engine_st* noundef nonnull %e, %struct.evp_cipher_st** noundef null, i32** noundef nonnull %nids, i32 noundef 0) #5
...
cleanup:                                          ; preds = %if.then
  ...
  %call3 = call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @cipher_table, void ()* noundef nonnull @engine_unregister_all_ciphers, %struct.engine_st* noundef nonnull %e, i32* noundef %2, i32 noundef %call, i32 noundef 0) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %1) #6
  br label %return
...
entry:
  tail call void @engine_table_cleanup(%struct.st_engine_table** noundef nonnull @cipher_table) #5
  ret void
}
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %call1 = tail call i32 @ENGINE_register_ciphers(%struct.engine_st* noundef nonnull %e.07) #7
...
; Function Attrs: noinline nounwind uwtable
define i32 @ENGINE_set_default_ciphers(%struct.engine_st* noundef %e) local_unnamed_addr #0 {
entry:
  %nids = alloca i32*, align 8
  %ciphers = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 7
  %0 = load i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)*, i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)** %ciphers, align 8, !tbaa !4
...
cleanup:                                          ; preds = %if.then
  %2 = load i32*, i32** %nids, align 8, !tbaa !11
  %call3 = call i32 @engine_table_register(%struct.st_engine_table** noundef nonnull @cipher_table, void ()* noundef nonnull @engine_unregister_all_ciphers, %struct.engine_st* noundef nonnull %e, i32* noundef %2, i32 noundef %call, i32 noundef 1) #5
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %1) #6
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define %struct.engine_st* @ENGINE_get_cipher_engine(i32 noundef %nid) local_unnamed_addr #0 {
entry:
  %call = tail call %struct.engine_st* @ossl_engine_table_select(%struct.st_engine_table** noundef nonnull @cipher_table, i32 noundef %nid, i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i64 0, i64 0), i32 noundef 69) #5
...
; Function Attrs: noinline nounwind uwtable
define %struct.evp_cipher_st* @ENGINE_get_cipher(%struct.engine_st* noundef %e, i32 noundef %nid) local_unnamed_addr #0 {
entry:
  %ret = alloca %struct.evp_cipher_st*, align 8
  %0 = bitcast %struct.evp_cipher_st** %ret to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %0) #6
  %call = tail call i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* @ENGINE_get_ciphers(%struct.engine_st* noundef %e) #7
  %tobool.not = icmp eq i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* %call, null
  br i1 %tobool.not, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %entry
  %call1 = call i32 %call(%struct.engine_st* noundef %e, %struct.evp_cipher_st** noundef nonnull %ret, i32** noundef null, i32 noundef %nid) #5
  %tobool2.not = icmp eq i32 %call1, 0
  br i1 %tobool2.not, label %if.then, label %if.end

if.then:                                          ; preds = %lor.lhs.false, %entry
  call void @ERR_new() #5
  call void @ERR_set_debug(i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @__func__.ENGINE_get_cipher, i64 0, i64 0)) #5
  call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 38, i32 noundef 146, i8* noundef null) #5
  br label %cleanup

if.end:                                           ; preds = %lor.lhs.false
  %1 = load %struct.evp_cipher_st*, %struct.evp_cipher_st** %ret, align 8, !tbaa !11
  br label %cleanup

cleanup:                                          ; preds = %if.end, %if.then
  %retval.0 = phi %struct.evp_cipher_st* [ %1, %if.end ], [ null, %if.then ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %0) #6
  ret %struct.evp_cipher_st* %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readonly uwtable willreturn
define i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* @ENGINE_get_ciphers(%struct.engine_st* nocapture noundef readonly %e) local_unnamed_addr #3 {
entry:
  %ciphers = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 7
  %0 = load i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)*, i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)** %ciphers, align 8, !tbaa !4
  ret i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* %0
}
...
define i32 @ENGINE_set_ciphers(%struct.engine_st* nocapture noundef writeonly %e, i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* noundef %f) local_unnamed_addr #4 {
entry:
  %ciphers = getelementptr inbounds %struct.engine_st, %struct.engine_st* %e, i64 0, i32 7
  store i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)* %f, i32 (%struct.engine_st*, %struct.evp_cipher_st**, i32**, i32)** %ciphers, align 8, !tbaa !4
  ret i32 1
}
