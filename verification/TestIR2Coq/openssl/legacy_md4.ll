; ModuleID = 'crypto/evp/legacy_md4.c'
source_filename = "crypto/evp/legacy_md4.c"
...
@md4_md = internal constant %struct.evp_md_st { i32 257, i32 396, i32 16, i64 0, i32 1, i32 (%struct.evp_md_ctx_st*)* @md4_init, i32 (%struct.evp_md_ctx_st*, i8*, i64)* @md4_update, i32 (%struct.evp_md_ctx_st*, i8*)* @md4_final, i32 (%struct.evp_md_ctx_st*, %struct.evp_md_ctx_st*)* null, i32 (%struct.evp_md_ctx_st*)* null, i32 64, i32 0, i32 (%struct.evp_md_ctx_st*, i32, i32, i8*)* null, i32 0, i8* null, i8* null, %struct.ossl_provider_st* null, i32 0, i8* null, i8* (i8*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, i8*, i64)* null, i32 (i8*, i8*, i64*, i64)* null, i32 (i8*, i8*, i64, i8*, i64*, i64)* null, void (i8*)* null, i8* (i8*)* null, i32 (%struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, i32 (i8*, %struct.ossl_param_st*)* null, %struct.ossl_param_st* (i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null, %struct.ossl_param_st* (i8*, i8*)* null }, align 8

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readnone uwtable willreturn
define nonnull %struct.evp_md_st* @EVP_md4() local_unnamed_addr #0 {
entry:
  ret %struct.evp_md_st* @md4_md
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @md4_init(%struct.evp_md_ctx_st* noundef %ctx) #1 {
entry:
  %call = tail call i8* @EVP_MD_CTX_get0_md_data(%struct.evp_md_ctx_st* noundef %ctx) #3
  %0 = bitcast i8* %call to %struct.MD4state_st*
  %call1 = tail call i32 @MD4_Init(%struct.MD4state_st* noundef %0) #3
  ret i32 %call1
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @md4_update(%struct.evp_md_ctx_st* noundef %ctx, i8* noundef %data, i64 noundef %count) #1 {
entry:
  %call = tail call i8* @EVP_MD_CTX_get0_md_data(%struct.evp_md_ctx_st* noundef %ctx) #3
  %0 = bitcast i8* %call to %struct.MD4state_st*
  %call1 = tail call i32 @MD4_Update(%struct.MD4state_st* noundef %0, i8* noundef %data, i64 noundef %count) #3
  ret i32 %call1
}

; Function Attrs: noinline nounwind uwtable
define internal i32 @md4_final(%struct.evp_md_ctx_st* noundef %ctx, i8* noundef %md) #1 {
entry:
  %call = tail call i8* @EVP_MD_CTX_get0_md_data(%struct.evp_md_ctx_st* noundef %ctx) #3
  %0 = bitcast i8* %call to %struct.MD4state_st*
  %call1 = tail call i32 @MD4_Final(i8* noundef %md, %struct.MD4state_st* noundef %0) #3
  ret i32 %call1
}

declare i32 @MD4_Init(%struct.MD4state_st* noundef) local_unnamed_addr #2

declare i8* @EVP_MD_CTX_get0_md_data(%struct.evp_md_ctx_st* noundef) local_unnamed_addr #2

declare i32 @MD4_Update(%struct.MD4state_st* noundef, i8* noundef, i64 noundef) local_unnamed_addr #2

declare i32 @MD4_Final(i8* noundef, %struct.MD4state_st* noundef) local_unnamed_addr #2
