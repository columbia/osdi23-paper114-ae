; ModuleID = 'crypto/x509/v3_ia5.c'
source_filename = "crypto/x509/v3_ia5.c"
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %call = tail call i8* @CRYPTO_malloc(i64 noundef %conv19, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 noundef 34) #4
  %cmp3 = icmp eq i8* %call, null
  br i1 %cmp3, label %if.then5, label %if.end6

if.then5:                                         ; preds = %if.end
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 noundef 35, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.i2s_ASN1_IA5STRING, i64 0, i64 0)) #4
  tail call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 34, i32 noundef 786688, i8* noundef null) #4
  br label %cleanup

if.end6:                                          ; preds = %if.end
  %data = getelementptr inbounds %struct.asn1_string_st, %struct.asn1_string_st* %ia5, i64 0, i32 2
...
cleanup:                                          ; preds = %entry, %lor.lhs.false, %if.end6, %if.then5
  %retval.0 = phi i8* [ null, %if.then5 ], [ %call, %if.end6 ], [ null, %lor.lhs.false ], [ null, %entry ]
  ret i8* %retval.0
}

; Function Attrs: noinline nounwind uwtable
define %struct.asn1_string_st* @s2i_ASN1_IA5STRING(%struct.v3_ext_method* nocapture readnone %method, %struct.v3_ext_ctx* nocapture readnone %ctx, i8* noundef %str) #1 {
entry:
...
if.then:                                          ; preds = %entry
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 noundef 48, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.s2i_ASN1_IA5STRING, i64 0, i64 0)) #4
  tail call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 34, i32 noundef 107, i8* noundef null) #4
  br label %cleanup

if.end:                                           ; preds = %entry
  %call = tail call %struct.asn1_string_st* @ASN1_IA5STRING_new() #4
...
if.then6:                                         ; preds = %if.end3
  tail call void @ASN1_IA5STRING_free(%struct.asn1_string_st* noundef nonnull %call) #4
  br label %cleanup

err:                                              ; preds = %if.end
  tail call void @ERR_new() #4
  tail call void @ERR_set_debug(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.s2i_ASN1_IA5STRING, i64 0, i64 0)) #4
  tail call void (i32, i32, i8*, ...) @ERR_set_error(i32 noundef 34, i32 noundef 786688, i8* noundef null) #4
  br label %cleanup

cleanup:                                          ; preds = %if.end3, %err, %if.then6, %if.then
  %retval.0 = phi %struct.asn1_string_st* [ null, %if.then ], [ null, %err ], [ null, %if.then6 ], [ %call, %if.end3 ]
