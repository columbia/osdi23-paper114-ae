...
@memremap.__already_done.1 = internal unnamed_addr global i1 false, section ".data.once", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"memremap attempted on ram %pa size: %#lx\0A\00", align 1
@.str.3 = private unnamed_addr constant [22 x i8] c"devm_memremap_release\00", align 1
@memstart_addr = external dso_local local_unnamed_addr global i64, align 8

; Function Attrs: noinline nounwind null_pointer_is_valid
define weak dso_local i8* @ioremap_cache(i64 noundef %offset, i64 noundef %size) local_unnamed_addr #0 {
entry:
  ...
  %call = call i8* @__ioremap(i64 noundef %offset, i64 noundef %size, i64 %or4) #4
  ret i8* %call
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i8* @memremap(i64 noundef %offset, i64 noundef %size, i64 noundef %flags) local_unnamed_addr #0 {
entry:
  %offset.addr = alloca i64, align 8
  store i64 %offset, i64* %offset.addr, align 8
  %call = call i32 @region_intersects(i64 noundef %offset, i64 noundef %size, i64 noundef 16777728, i64 noundef 0) #4
  %tobool.not = icmp eq i64 %flags, 0
  br i1 %tobool.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %cmp = icmp eq i32 %call, 2
  br i1 %cmp, label %if.then1, label %if.end40

if.then1:                                         ; preds = %if.end
  %.b174 = load i1, i1* @memremap.__already_done, align 1
  br i1 %.b174, label %cleanup, label %if.then7, !prof !8

if.then7:                                         ; preds = %if.then1
  store i1 true, i1* @memremap.__already_done, align 1
  call void (i8*, ...) @__warn_printk(i8* noundef getelementptr inbounds ([50 x i8], [50 x i8]* @.str, i64 0, i64 0), i64* noundef nonnull %offset.addr, i64 noundef %size) #4
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/iomem.c\22; .popsection; .long 14472b - 14470b; .short 82; .short (1 << 0)|((1 << 3) | ((9) << 8)); .popsection; 14471: brk 0x800", ""() #5, !srcloc !9
  br label %cleanup
...
if.then42:                                        ; preds = %if.end40
  ...
  br i1 %cmp43, label %if.end47, label %if.then49

if.end47:                                         ; preds = %if.then42
  %call46 = call fastcc i8* @try_ram_remap(i64 noundef %offset) #6
  %tobool48.not = icmp eq i8* %call46, null
  br i1 %tobool48.not, label %if.then49, label %cleanup

if.then49:                                        ; preds = %if.then42, %if.end47
  %call50 = call fastcc i8* @arch_memremap_wb(i64 noundef %offset, i64 noundef %size) #6
  br label %if.end52

if.end52:                                         ; preds = %if.then49, %if.end40
  %addr.1 = phi i8* [ %call50, %if.then49 ], [ null, %if.end40 ]
  %tobool53 = icmp eq i8* %addr.1, null
  %cmp54 = icmp eq i32 %call, 0
  %or.cond = select i1 %tobool53, i1 %cmp54, i1 false
  %cmp57 = icmp ne i64 %flags, 1
  %or.cond146 = and i1 %cmp57, %or.cond
  br i1 %or.cond146, label %if.then59, label %if.end113

if.then59:                                        ; preds = %if.end52
  %.b172173 = load i1, i1* @memremap.__already_done.1, align 1
  br i1 %.b172173, label %cleanup, label %if.then75, !prof !8

if.then75:                                        ; preds = %if.then59
  store i1 true, i1* @memremap.__already_done.1, align 1
  call void (i8*, ...) @__warn_printk(i8* noundef getelementptr inbounds ([42 x i8], [42 x i8]* @.str.2, i64 0, i64 0), i64* noundef nonnull %offset.addr, i64 noundef %size) #4
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/iomem.c\22; .popsection; .long 14472b - 14470b; .short 108; .short (1 << 0)|((1 << 3) | ((9) << 8)); .popsection; 14471: brk 0x800", ""() #5, !srcloc !10
  br label %cleanup

if.end113:                                        ; preds = %if.end52
  br i1 %tobool53, label %land.lhs.true115, label %cleanup

land.lhs.true115:                                 ; preds = %if.end113
  %and116 = and i64 %flags, 2
  %tobool117.not = icmp eq i64 %and116, 0
  br i1 %tobool117.not, label %land.lhs.true128, label %if.end126

if.end126:                                        ; preds = %land.lhs.true115
  %0 = load i8, i8* @arm64_use_ng_mappings, align 1, !range !7
  %tobool119.not = icmp eq i8 %0, 0
  %or124 = select i1 %tobool119.not, i64 29273397577910035, i64 29273397577912083
  %call125 = call i8* @__ioremap(i64 noundef %offset, i64 noundef %size, i64 %or124) #4
  %tobool127.not = icmp eq i8* %call125, null
  br i1 %tobool127.not, label %land.lhs.true128, label %cleanup

land.lhs.true128:                                 ; preds = %land.lhs.true115, %if.end126
  %and129 = and i64 %flags, 4
...
if.then131:                                       ; preds = %land.lhs.true128
  ...
  %tobool134.not = icmp eq i8 %1, 0
  %or141 = select i1 %tobool134.not, i64 29273397577910027, i64 29273397577912075
  %call143 = call i8* @__ioremap(i64 noundef %offset, i64 noundef %size, i64 %or141) #4
  br label %cleanup

cleanup:                                          ; preds = %if.end113, %if.end47, %if.end126, %land.lhs.true128, %if.then131, %if.then59, %if.then75, %if.then1, %if.then7, %entry
  %retval.0 = phi i8* [ null, %entry ], [ null, %if.then7 ], [ null, %if.then1 ], [ null, %if.then75 ], [ null, %if.then59 ], [ %call125, %if.end126 ], [ %call143, %if.then131 ], [ null, %land.lhs.true128 ], [ %call46, %if.end47 ], [ %addr.1, %if.end113 ]
  ret i8* %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @region_intersects(i64 noundef, i64 noundef, i64 noundef, i64 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @__warn_printk(i8* noundef, ...) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i8* @try_ram_remap(i64 noundef %offset) unnamed_addr #0 {
entry:
  %shr = lshr i64 %offset, 12
  %call = call i32 @pfn_valid(i64 noundef %shr) #4
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i8* @arch_memremap_wb(i64 noundef %offset, i64 noundef %size) unnamed_addr #0 {
entry:
  %call = call i8* @ioremap_cache(i64 noundef %offset, i64 noundef %size) #6
  ret i8* %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @memunmap(i8* noundef %addr) local_unnamed_addr #0 {
entry:
  %call = call i1 @is_vmalloc_addr(i8* noundef %addr) #4
  br i1 %call, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  call void @iounmap(i8* noundef %addr) #4
  br label %if.end
...
; Function Attrs: null_pointer_is_valid
declare dso_local i1 @is_vmalloc_addr(i8* noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @iounmap(i8* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i8* @devm_memremap(%struct.device* noundef %dev, i64 noundef %offset, i64 noundef %size, i64 noundef %flags) local_unnamed_addr #0 {
entry:
  %call1 = call noalias i8* @__devres_alloc_node(void (%struct.device*, i8*)* noundef nonnull @devm_memremap_release, i64 noundef 8, i32 noundef 3264, i32 noundef -1, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i64 0, i64 0)) #4
  %0 = bitcast i8* %call1 to i8**
  %tobool.not = icmp eq i8* %call1, null
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call2 = call fastcc i8* @ERR_PTR(i64 noundef -12) #6
  br label %cleanup

if.end:                                           ; preds = %entry
  %call3 = call i8* @memremap(i64 noundef %offset, i64 noundef %size, i64 noundef %flags) #6
  %tobool4.not = icmp eq i8* %call3, null
  br i1 %tobool4.not, label %if.else, label %if.then5

if.then5:                                         ; preds = %if.end
  store i8* %call3, i8** %0, align 8
  call void @devres_add(%struct.device* noundef %dev, i8* noundef nonnull %call1) #4
  br label %cleanup

if.else:                                          ; preds = %if.end
  call void @devres_free(i8* noundef nonnull %call1) #4
  %call6 = call fastcc i8* @ERR_PTR(i64 noundef -6) #6
  br label %cleanup

cleanup:                                          ; preds = %if.then5, %if.else, %if.then
  %retval.0 = phi i8* [ %call3, %if.then5 ], [ %call6, %if.else ], [ %call2, %if.then ]
  ret i8* %retval.0
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal void @devm_memremap_release(%struct.device* nocapture noundef readnone %dev, i8* nocapture noundef readonly %res) #0 {
entry:
  %0 = bitcast i8* %res to i8**
  %1 = load i8*, i8** %0, align 8
  call void @memunmap(i8* noundef %1) #6
  ret void
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @devm_memunmap(%struct.device* noundef %dev, i8* noundef %addr) local_unnamed_addr #0 {
entry:
  %call = call i32 @devres_release(%struct.device* noundef %dev, void (%struct.device*, i8*)* noundef nonnull @devm_memremap_release, i32 (%struct.device*, i8*, i8*)* noundef nonnull @devm_memremap_match, i8* noundef %addr) #4
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.end, label %if.then, !prof !8

if.then:                                          ; preds = %entry
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/iomem.c\22; .popsection; .long 14472b - 14470b; .short 165; .short (1 << 0)|(((9) << 8)); .popsection; 14471: brk 0x800", ""() #5, !srcloc !11
  br label %if.end
...
define internal i32 @devm_memremap_match(%struct.device* nocapture noundef readnone %dev, i8* nocapture noundef readonly %res, i8* noundef readnone %match_data) #3 {
entry:
  %0 = bitcast i8* %res to i8**
  %1 = load i8*, i8** %0, align 8
