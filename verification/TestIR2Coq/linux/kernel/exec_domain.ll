; ModuleID = 'kernel/exec_domain.c'
source_filename = "kernel/exec_domain.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall6.init\22, \22a\22\09\09"
module asm "__initcall__kmod_exec_domain__368_35_proc_execdomains_init6:\09\09\09"
...
@__UNIQUE_ID___addressable_proc_execdomains_init369 = internal global i8* bitcast (i32 ()* @proc_execdomains_init to i8*), section ".discard.addressable", align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_execdomains_init369 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_execdomains_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @execdomains_proc_show, i8* noundef null) #3
  ret i32 0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i64 @__arm64_sys_personality(%struct.pt_regs* nocapture noundef readonly %regs) local_unnamed_addr #1 {
entry:
  %arrayidx = getelementptr %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 0, i32 0, i32 0, i64 0
  %0 = load i64, i64* %arrayidx, align 8
  %call = call fastcc i64 @__se_sys_personality(i64 noundef %0) #4
  ret i64 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__se_sys_personality(i64 noundef %personality) unnamed_addr #1 {
entry:
  %conv = trunc i64 %personality to i32
  %call = call fastcc i64 @__do_sys_personality(i32 noundef %conv) #4
  ret i64 %call
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @execdomains_proc_show(%struct.seq_file* noundef %m, i8* nocapture noundef readnone %v) #1 {
entry:
  call void @seq_puts(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0)) #3
  ret i32 0
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__do_sys_personality(i32 noundef %personality) unnamed_addr #1 {
entry:
  %0 = call i64 asm "mrs $0, sp_el0", "=r"() #5, !srcloc !7
