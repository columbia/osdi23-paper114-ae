; ModuleID = 'kernel/sched/stop_task.c'
...
%struct.sched_class = type { {}*, {}*, void (%struct.rq*)*, i1 (%struct.rq*, %struct.task_struct*)*, {}*, %struct.task_struct* (%struct.rq*)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*, i1)*, i32 (%struct.rq*, %struct.task_struct*, %struct.rq_flags*)*, i32 (%struct.task_struct*, i32, i32)*, %struct.task_struct* (%struct.rq*)*, void (%struct.task_struct*, i32)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.task_struct*, %struct.cpumask*, i32)*, void (%struct.rq*)*, void (%struct.rq*)*, %struct.rq* (%struct.task_struct*, %struct.rq*)*, {}*, void (%struct.task_struct*)*, void (%struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*)*, {}*, i32 (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*)* }
...
@stop_sched_class = dso_local local_unnamed_addr constant { void (%struct.rq*, %struct.task_struct*, i32)*, void (%struct.rq*, %struct.task_struct*, i32)*, void (%struct.rq*)*, i1 (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*, i32)*, %struct.task_struct* (%struct.rq*)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*, i1)*, i32 (%struct.rq*, %struct.task_struct*, %struct.rq_flags*)*, i32 (%struct.task_struct*, i32, i32)*, %struct.task_struct* (%struct.rq*)*, void (%struct.task_struct*, i32)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.task_struct*, %struct.cpumask*, i32)*, void (%struct.rq*)*, void (%struct.rq*)*, %struct.rq* (%struct.task_struct*, %struct.rq*)*, void (%struct.rq*, %struct.task_struct*, i32)*, void (%struct.task_struct*)*, void (%struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*, %struct.task_struct*, i32)*, i32 (%struct.rq*, %struct.task_struct*)*, void (%struct.rq*)* } { void (%struct.rq*, %struct.task_struct*, i32)* @enqueue_task_stop, void (%struct.rq*, %struct.task_struct*, i32)* @dequeue_task_stop, void (%struct.rq*)* @yield_task_stop, i1 (%struct.rq*, %struct.task_struct*)* null, void (%struct.rq*, %struct.task_struct*, i32)* @check_preempt_curr_stop, %struct.task_struct* (%struct.rq*)* @pick_next_task_stop, void (%struct.rq*, %struct.task_struct*)* @put_prev_task_stop, void (%struct.rq*, %struct.task_struct*, i1)* @set_next_task_stop, i32 (%struct.rq*, %struct.task_struct*, %struct.rq_flags*)* @balance_stop, i32 (%struct.task_struct*, i32, i32)* @select_task_rq_stop, %struct.task_struct* (%struct.rq*)* @pick_task_stop, void (%struct.task_struct*, i32)* null, void (%struct.rq*, %struct.task_struct*)* null, void (%struct.task_struct*, %struct.cpumask*, i32)* @set_cpus_allowed_common, void (%struct.rq*)* null, void (%struct.rq*)* null, %struct.rq* (%struct.task_struct*, %struct.rq*)* null, void (%struct.rq*, %struct.task_struct*, i32)* @task_tick_stop, void (%struct.task_struct*)* null, void (%struct.task_struct*)* null, void (%struct.rq*, %struct.task_struct*)* null, void (%struct.rq*, %struct.task_struct*)* @switched_to_stop, void (%struct.rq*, %struct.task_struct*, i32)* @prio_changed_stop, i32 (%struct.rq*, %struct.task_struct*)* null, void (%struct.rq*)* @update_curr_stop }, section "__stop_sched_class", align 8

; Function Attrs: nofree noinline norecurse nounwind null_pointer_is_valid
define internal void @enqueue_task_stop(%struct.rq* nocapture noundef %rq, %struct.task_struct* nocapture noundef readnone %p, i32 noundef %flags) #0 {
entry:
  call fastcc void @add_nr_running(%struct.rq* noundef %rq) #8
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal void @dequeue_task_stop(%struct.rq* nocapture noundef %rq, %struct.task_struct* nocapture noundef readnone %p, i32 noundef %flags) #1 {
entry:
  call fastcc void @sub_nr_running(%struct.rq* noundef %rq) #8
  ret void
}

; Function Attrs: noinline noreturn nounwind null_pointer_is_valid
define internal void @yield_task_stop(%struct.rq* nocapture noundef readnone %rq) #2 {
entry:
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/sched/stop_task.c\22; .popsection; .long 14472b - 14470b; .short 69; .short 0; .popsection; 14471: brk 0x800", ""() #9, !srcloc !7
  unreachable
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @check_preempt_curr_stop(%struct.rq* nocapture noundef %rq, %struct.task_struct* nocapture noundef %p, i32 noundef %flags) #3 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal %struct.task_struct* @pick_next_task_stop(%struct.rq* nocapture noundef readonly %rq) #1 {
entry:
  %call = call %struct.task_struct* @pick_task_stop(%struct.rq* noundef %rq) #8
  %tobool.not = icmp eq %struct.task_struct* %call, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  call void @set_next_task_stop(%struct.rq* noundef %rq, %struct.task_struct* noundef nonnull %call, i1 noundef true) #8
  br label %if.end
...
define internal void @put_prev_task_stop(%struct.rq* nocapture noundef readonly %rq, %struct.task_struct* nocapture noundef readnone %prev) #4 {
entry:
  ...
  %call = call fastcc i64 @rq_clock_task(%struct.rq* noundef %rq) #8
  ...
  br i1 %cmp, label %if.then, label %do.end, !prof !8

if.then:                                          ; preds = %entry
  br label %do.end

do.end:                                           ; preds = %entry, %if.then
  %delta_exec.0 = phi i64 [ 0, %if.then ], [ %sub, %entry ]
  ...
  %add = add i64 %2, %delta_exec.0
  store i64 %add, i64* %sum_exec_runtime, align 8
  call fastcc void @account_group_exec_runtime(%struct.task_struct* noundef %0, i64 noundef %delta_exec.0) #8
  %call4 = call fastcc i64 @rq_clock_task(%struct.rq* noundef %rq) #8
  store i64 %call4, i64* %exec_start, align 64
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal void @set_next_task_stop(%struct.rq* nocapture noundef readonly %rq, %struct.task_struct* nocapture noundef writeonly %stop, i1 noundef %first) #1 {
entry:
  %call = call fastcc i64 @rq_clock_task(%struct.rq* noundef %rq) #8
  %exec_start = getelementptr inbounds %struct.task_struct, %struct.task_struct* %stop, i64 0, i32 20, i32 4
  store i64 %call, i64* %exec_start, align 64
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal i32 @balance_stop(%struct.rq* nocapture noundef readonly %rq, %struct.task_struct* nocapture noundef readnone %prev, %struct.rq_flags* nocapture noundef readnone %rf) #5 {
entry:
  %call = call fastcc i1 @sched_stop_runnable(%struct.rq* noundef %rq) #8
  %conv = zext i1 %call to i32
  ret i32 %conv
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal i32 @select_task_rq_stop(%struct.task_struct* noundef %p, i32 noundef %cpu, i32 noundef %flags) #6 {
entry:
  %call = call fastcc i32 @task_cpu(%struct.task_struct* noundef %p) #8
  ret i32 %call
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal %struct.task_struct* @pick_task_stop(%struct.rq* nocapture noundef readonly %rq) #5 {
entry:
  %call = call fastcc i1 @sched_stop_runnable(%struct.rq* noundef %rq) #8
...
return:                                           ; preds = %entry, %if.end
  %retval.0 = phi %struct.task_struct* [ %0, %if.end ], [ null, %entry ]
  ret %struct.task_struct* %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @set_cpus_allowed_common(%struct.task_struct* noundef, %struct.cpumask* noundef, i32 noundef) #7

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @task_tick_stop(%struct.rq* nocapture noundef %rq, %struct.task_struct* nocapture noundef %curr, i32 noundef %queued) #3 {
entry:
  ret void
}

; Function Attrs: noinline noreturn nounwind null_pointer_is_valid
define internal void @switched_to_stop(%struct.rq* nocapture noundef readnone %rq, %struct.task_struct* nocapture noundef readnone %p) #2 {
entry:
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/sched/stop_task.c\22; .popsection; .long 14472b - 14470b; .short 105; .short 0; .popsection; 14471: brk 0x800", ""() #9, !srcloc !9
  unreachable
}

; Function Attrs: noinline noreturn nounwind null_pointer_is_valid
define internal void @prio_changed_stop(%struct.rq* nocapture noundef readnone %rq, %struct.task_struct* nocapture noundef readnone %p, i32 noundef %oldprio) #2 {
entry:
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/sched/stop_task.c\22; .popsection; .long 14472b - 14470b; .short 111; .short 0; .popsection; 14471: brk 0x800", ""() #9, !srcloc !10
  unreachable
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @update_curr_stop(%struct.rq* nocapture noundef %rq) #3 {
entry:
  ret void
}

; Function Attrs: nofree noinline norecurse nounwind null_pointer_is_valid
define internal fastcc void @add_nr_running(%struct.rq* nocapture noundef %rq) unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal fastcc void @sub_nr_running(%struct.rq* nocapture noundef %rq) unnamed_addr #1 {
entry:
  %nr_running = getelementptr inbounds %struct.rq, %struct.rq* %rq, i64 0, i32 1
  %0 = load i32, i32* %nr_running, align 4
  %sub = add i32 %0, -1
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i64 @rq_clock_task(%struct.rq* nocapture noundef readonly %rq) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @account_group_exec_runtime(%struct.task_struct* nocapture noundef readonly %tsk, i64 noundef %ns) unnamed_addr #4 {
entry:
  %call = call fastcc %struct.thread_group_cputimer* @get_running_cputimer(%struct.task_struct* noundef %tsk) #8
...
if.end:                                           ; preds = %entry
  ...
  call fastcc void @__ll_sc_atomic64_add(i64 noundef %ns, %struct.atomic64_t* noundef %sum_exec_runtime) #10
  br label %cleanup
...
; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc %struct.thread_group_cputimer* @get_running_cputimer(%struct.task_struct* nocapture noundef readonly %tsk) unnamed_addr #6 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %.cputimer1 = select i1 %tobool3.not, %struct.thread_group_cputimer* null, %struct.thread_group_cputimer* %cputimer1, !prof !8
  br label %cleanup
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @__ll_sc_atomic64_add(i64 noundef %i, %struct.atomic64_t* noundef %v) unnamed_addr #4 {
entry:
  %counter = getelementptr inbounds %struct.atomic64_t, %struct.atomic64_t* %v, i64 0, i32 0
  %0 = call { i64, i64 } asm sideeffect "// atomic64_add\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09add\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,Ir,*Q"(i64* elementtype(i64) %counter, i64 %i, i64* elementtype(i64) %counter) #9, !srcloc !11
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i1 @sched_stop_runnable(%struct.rq* nocapture noundef readonly %rq) unnamed_addr #5 {
entry:
  %stop = getelementptr inbounds %struct.rq, %struct.rq* %rq, i64 0, i32 11
  %0 = load %struct.task_struct*, %struct.task_struct** %stop, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call fastcc i32 @task_on_rq_queued(%struct.task_struct* noundef nonnull %0) #8
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i32 @task_on_rq_queued(%struct.task_struct* nocapture noundef readonly %p) unnamed_addr #5 {
entry:
...
attributes #2 = { noinline noreturn nounwind null_pointer_is_valid "disable-tail-calls"="true" "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+v8a,-aes,-crypto,-fp-armv8,-neon,-sha2" "warn-stack-size"="2048" }
...
!9 = !{i64 2157114687}
!10 = !{i64 2157115975}
!11 = !{i64 2147986033, i64 2147986547, i64 2147986577, i64 2147986603, i64 2147986635, i64 2147986664}
