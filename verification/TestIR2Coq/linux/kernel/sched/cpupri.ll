; ModuleID = 'kernel/sched/cpupri.c'
...
define dso_local i32 @cpupri_find(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask) local_unnamed_addr #0 {
entry:
  %call = call i32 @cpupri_find_fitness(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask, i1 (%struct.task_struct*, i32)* noundef null) #6
  ret i32 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @cpupri_find_fitness(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask, i1 (%struct.task_struct*, i32)* noundef readonly %fitness_fn) local_unnamed_addr #0 {
entry:
  %prio = getelementptr inbounds %struct.task_struct, %struct.task_struct* %p, i64 0, i32 15
  %0 = load i32, i32* %prio, align 4
  %call = call fastcc i32 @convert_prio(i32 noundef %0) #6
  %cmp859 = icmp sgt i32 %call, 0
  br i1 %cmp859, label %for.body.lr.ph, label %for.end29

for.body.lr.ph:                                   ; preds = %entry
  %tobool14 = icmp ne %struct.cpumask* %lowest_mask, null
  %tobool15 = icmp ne i1 (%struct.task_struct*, i32)* %fitness_fn, null
  %or.cond = and i1 %tobool14, %tobool15
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %idx.060 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.inc ]
  %call10 = call fastcc i32 @__cpupri_find(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask, i32 noundef %idx.060) #6
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %for.inc, label %if.end13

if.end13:                                         ; preds = %for.body
  br i1 %or.cond, label %for.cond18.preheader, label %cleanup

for.cond18.preheader:                             ; preds = %if.end13
  %call1956 = call i32 @cpumask_next(i32 noundef -1, %struct.cpumask* noundef nonnull %lowest_mask) #7
  %1 = load i32, i32* @nr_cpu_ids, align 4
  %cmp2057 = icmp ult i32 %call1956, %1
  br i1 %cmp2057, label %for.body22, label %for.end

for.body22:                                       ; preds = %for.cond18.preheader, %if.end25
  %call1958 = phi i32 [ %call19, %if.end25 ], [ %call1956, %for.cond18.preheader ]
  %call23 = call i1 %fitness_fn(%struct.task_struct* noundef %p, i32 noundef %call1958) #8
  br i1 %call23, label %if.end25, label %if.then24

if.then24:                                        ; preds = %for.body22
  call fastcc void @cpumask_clear_cpu(i32 noundef %call1958, %struct.cpumask* noundef nonnull %lowest_mask) #6
  br label %if.end25

if.end25:                                         ; preds = %if.then24, %for.body22
  %call19 = call i32 @cpumask_next(i32 noundef %call1958, %struct.cpumask* noundef nonnull %lowest_mask) #7
  %2 = load i32, i32* @nr_cpu_ids, align 4
  %cmp20 = icmp ult i32 %call19, %2
  br i1 %cmp20, label %for.body22, label %for.end

for.end:                                          ; preds = %if.end25, %for.cond18.preheader
  %call26 = call fastcc i1 @cpumask_empty(%struct.cpumask* noundef nonnull %lowest_mask) #6
  br i1 %call26, label %for.inc, label %cleanup

for.inc:                                          ; preds = %for.end, %for.body
  %inc = add nuw nsw i32 %idx.060, 1
  %exitcond.not = icmp eq i32 %inc, %call
  br i1 %exitcond.not, label %for.end29, label %for.body

for.end29:                                        ; preds = %for.inc, %entry
  %tobool30.not = icmp eq i1 (%struct.task_struct*, i32)* %fitness_fn, null
  br i1 %tobool30.not, label %cleanup, label %if.then31

if.then31:                                        ; preds = %for.end29
  %call32 = call i32 @cpupri_find(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask) #6
  br label %cleanup

cleanup:                                          ; preds = %for.end, %if.end13, %for.end29, %if.then31
  %retval.0 = phi i32 [ %call32, %if.then31 ], [ 0, %for.end29 ], [ 1, %if.end13 ], [ 1, %for.end ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal fastcc i32 @convert_prio(i32 noundef %prio) unnamed_addr #1 {
entry:
  switch i32 %prio, label %sw.caserange [
...
sw.caserange:                                     ; preds = %entry
  %0 = call i32 @llvm.usub.sat.i32(i32 99, i32 %prio)
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %sw.caserange, %entry, %sw.bb3, %sw.bb2
  %cpupri.0 = phi i32 [ 100, %sw.bb3 ], [ 0, %sw.bb2 ], [ %prio, %entry ], [ %0, %sw.caserange ]
  ret i32 %cpupri.0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @__cpupri_find(%struct.cpupri* noundef %cp, %struct.task_struct* noundef %p, %struct.cpumask* noundef %lowest_mask, i32 noundef %idx) unnamed_addr #0 {
entry:
  %idxprom = sext i32 %idx to i64
  %counter.i = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom, i32 0, i32 0
  %0 = load volatile i32, i32* %counter.i, align 4
  %tobool.not = icmp eq i32 %0, 0
  call void asm sideeffect "dmb ishld", "~{memory}"() #9, !srcloc !7
...
if.end3:                                          ; preds = %entry
  ...
  %arraydecay = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom, i32 1, i64 0
  %call4 = call i32 @cpumask_next_and(i32 noundef -1, %struct.cpumask* noundef %cpus_mask, %struct.cpumask* noundef %arraydecay) #7
  %1 = load i32, i32* @nr_cpu_ids, align 4
  %cmp.not = icmp ult i32 %call4, %1
  br i1 %cmp.not, label %if.end6, label %cleanup

if.end6:                                          ; preds = %if.end3
  %tobool7.not = icmp eq %struct.cpumask* %lowest_mask, null
  br i1 %tobool7.not, label %if.end16, label %if.then8

if.then8:                                         ; preds = %if.end6
  call fastcc void @cpumask_and(%struct.cpumask* noundef nonnull %lowest_mask, %struct.cpumask* noundef %cpus_mask, %struct.cpumask* noundef %arraydecay) #6
  %call13 = call fastcc i1 @cpumask_empty(%struct.cpumask* noundef nonnull %lowest_mask) #6
  br i1 %call13, label %cleanup, label %if.end16

if.end16:                                         ; preds = %if.then8, %if.end6
  br label %cleanup

cleanup:                                          ; preds = %if.then8, %if.end3, %entry, %if.end16
  %retval.0 = phi i32 [ 1, %if.end16 ], [ 0, %entry ], [ 0, %if.end3 ], [ 0, %if.then8 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call fastcc void @clear_bit(i64 noundef %conv, i64* noundef %arraydecay) #6
  ret void
}
...
entry:
  ...
  %call = call fastcc i1 @bitmap_empty(i64* noundef %arraydecay) #6
  ret i1 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @cpupri_set(%struct.cpupri* noundef %cp, i32 noundef %cpu, i32 noundef %newpri) local_unnamed_addr #0 {
entry:
  %cpu_to_pri = getelementptr inbounds %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 1
  %0 = load i32*, i32** %cpu_to_pri, align 8
  %idxprom = sext i32 %cpu to i64
  %arrayidx = getelementptr i32, i32* %0, i64 %idxprom
  %1 = load i32, i32* %arrayidx, align 4
  %call = call fastcc i32 @convert_prio(i32 noundef %newpri) #6
  %cmp8 = icmp eq i32 %call, %1
  br i1 %cmp8, label %cleanup, label %if.end11

if.end11:                                         ; preds = %entry
  %cmp12.not = icmp eq i32 %call, -1
  br i1 %cmp12.not, label %if.end24, label %if.end24.thread, !prof !8

if.end24:                                         ; preds = %if.end11
  %cmp25.not = icmp eq i32 %1, -1
  br i1 %cmp25.not, label %if.end45, label %if.end41, !prof !8

if.end24.thread:                                  ; preds = %if.end11
  %idxprom22 = sext i32 %call to i64
  %arraydecay = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom22, i32 1, i64 0
  call fastcc void @cpumask_set_cpu(i32 noundef %cpu, %struct.cpumask* noundef %arraydecay) #6
  call void asm sideeffect "dmb ish", "~{memory}"() #9, !srcloc !9
  %count = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom22, i32 0
  call fastcc void @__ll_sc_atomic_add(%struct.atomic_t* noundef %count) #8
  %cmp25.not67 = icmp eq i32 %1, -1
  br i1 %cmp25.not67, label %if.end45, label %if.then40, !prof !8

if.then40:                                        ; preds = %if.end24.thread
  call void asm sideeffect "dmb ish", "~{memory}"() #9, !srcloc !10
  br label %if.end41

if.end41:                                         ; preds = %if.end24, %if.then40
  %idxprom3770 = sext i32 %1 to i64
  %count42 = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom3770, i32 0
  call fastcc void @__ll_sc_atomic_sub(%struct.atomic_t* noundef %count42) #8
  call void asm sideeffect "dmb ish", "~{memory}"() #9, !srcloc !11
  %arraydecay44 = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %idxprom3770, i32 1, i64 0
  call fastcc void @cpumask_clear_cpu(i32 noundef %cpu, %struct.cpumask* noundef %arraydecay44) #6
  br label %if.end45

if.end45:                                         ; preds = %if.end24.thread, %if.end41, %if.end24
...
entry:
  %conv = zext i32 %cpu to i64
  %arraydecay = getelementptr inbounds %struct.cpumask, %struct.cpumask* %dstp, i64 0, i32 0, i64 0
  call fastcc void @set_bit(i64 noundef %conv, i64* noundef %arraydecay) #6
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @cpupri_init(%struct.cpupri* noundef %cp) local_unnamed_addr #0 {
entry:
  br label %for.body

for.body:                                         ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %counter.i = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %indvars.iv, i32 0, i32 0
  store volatile i32 0, i32* %counter.i, align 4
  %mask = getelementptr %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 0, i64 %indvars.iv, i32 1
  call fastcc void @zalloc_cpumask_var([1 x %struct.cpumask]* noundef %mask) #6
...
for.end:                                          ; preds = %for.body
  ...
  %call1 = call fastcc i8* @kcalloc(i64 noundef %conv) #6
  %cpu_to_pri = getelementptr inbounds %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 1
  %1 = bitcast i32** %cpu_to_pri to i8**
  store i8* %call1, i8** %1, align 8
  %tobool.not = icmp eq i8* %call1, null
  br i1 %tobool.not, label %cleanup26, label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.end
  %call645 = call i32 @cpumask_next(i32 noundef -1, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #7
  %2 = load i32, i32* @nr_cpu_ids, align 4
  %cmp746 = icmp ult i32 %call645, %2
  br i1 %cmp746, label %for.body9.preheader, label %cleanup26

for.body9.preheader:                              ; preds = %for.cond5.preheader
  %3 = bitcast i8* %call1 to i32*
  %idxprom1150 = sext i32 %call645 to i64
  %arrayidx1251 = getelementptr i32, i32* %3, i64 %idxprom1150
  store i32 -1, i32* %arrayidx1251, align 4
  %call652 = call i32 @cpumask_next(i32 noundef %call645, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #7
  %4 = load i32, i32* @nr_cpu_ids, align 4
  %cmp753 = icmp ult i32 %call652, %4
  br i1 %cmp753, label %for.body9.for.body9_crit_edge, label %cleanup26

for.body9.for.body9_crit_edge:                    ; preds = %for.body9.preheader, %for.body9.for.body9_crit_edge
  %call654 = phi i32 [ %call6, %for.body9.for.body9_crit_edge ], [ %call652, %for.body9.preheader ]
  %.pre = load i32*, i32** %cpu_to_pri, align 8
  %idxprom11 = sext i32 %call654 to i64
  %arrayidx12 = getelementptr i32, i32* %.pre, i64 %idxprom11
  store i32 -1, i32* %arrayidx12, align 4
  %call6 = call i32 @cpumask_next(i32 noundef %call654, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #7
  %5 = load i32, i32* @nr_cpu_ids, align 4
  %cmp7 = icmp ult i32 %call6, %5
  br i1 %cmp7, label %for.body9.for.body9_crit_edge, label %cleanup26

cleanup26:                                        ; preds = %for.body9.for.body9_crit_edge, %for.body9.preheader, %for.end, %for.cond5.preheader
  %retval.0 = phi i32 [ 0, %for.cond5.preheader ], [ -12, %for.end ], [ 0, %for.body9.preheader ], [ 0, %for.body9.for.body9_crit_edge ]
  ret i32 %retval.0
}
...
entry:
  ...
  call fastcc void @cpumask_clear(%struct.cpumask* noundef %arraydecay) #6
  ret void
}
...
entry:
  %call = call fastcc i8* @kmalloc_array(i64 noundef %n) #6
  ret i8* %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @cpupri_cleanup(%struct.cpupri* nocapture noundef readonly %cp) local_unnamed_addr #0 {
entry:
  %cpu_to_pri = getelementptr inbounds %struct.cpupri, %struct.cpupri* %cp, i64 0, i32 1
  %0 = bitcast i32** %cpu_to_pri to i8**
...
; Function Attrs: mustprogress nofree nounwind null_pointer_is_valid readonly willreturn
declare dso_local i32 @cpumask_next_and(i32 noundef, %struct.cpumask* noundef, %struct.cpumask* noundef) local_unnamed_addr #2
...
entry:
  ...
  call fastcc void @bitmap_and(i64* noundef %arraydecay, i64* noundef %arraydecay2, i64* noundef %arraydecay4) #6
  ret void
}
...
entry:
  %call = call i32 @__bitmap_and(i64* noundef %dst, i64* noundef %src1, i64* noundef %src2, i32 noundef 256) #8
  ret void
}
...
entry:
  ...
  call fastcc void @__ll_sc_atomic64_andnot(i64 noundef %shl.i, %struct.atomic64_t* noundef %0) #8
  ret void
}
...
entry:
  ...
  %0 = call { i64, i64 } asm sideeffect "// atomic64_andnot\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09bic\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,r,*Q"(i64* elementtype(i64) %counter, i64 %i, i64* elementtype(i64) %counter) #9, !srcloc !12
  ret void
}
...
entry:
  %call = call fastcc i64 @find_first_bit(i64* noundef %src) #6
...
entry:
  ...
  %shl.i = shl nuw i64 1, %rem.i
  %0 = bitcast i64* %add.ptr.i to %struct.atomic64_t*
  call fastcc void @__ll_sc_atomic64_or(i64 noundef %shl.i, %struct.atomic64_t* noundef %0) #8
  ret void
}
...
entry:
  %counter = getelementptr inbounds %struct.atomic64_t, %struct.atomic64_t* %v, i64 0, i32 0
  %0 = call { i64, i64 } asm sideeffect "// atomic64_or\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09orr\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,Lr,*Q"(i64* elementtype(i64) %counter, i64 %i, i64* elementtype(i64) %counter) #9, !srcloc !13
  ret void
}
...
entry:
  ...
  %0 = call { i32, i64 } asm sideeffect "// atomic_add\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09${0:w}, $2\0A\09add\09${0:w}, ${0:w}, ${3:w}\0A\09stxr\09${1:w}, ${0:w}, $2\0A\09cbnz\09${1:w}, 1b\0A", "=&r,=&r,=*Q,Ir,*Q"(i32* elementtype(i32) %counter, i32 1, i32* elementtype(i32) %counter) #9, !srcloc !14
  ret void
}
...
entry:
  %counter = getelementptr inbounds %struct.atomic_t, %struct.atomic_t* %v, i64 0, i32 0
  %0 = call { i32, i64 } asm sideeffect "// atomic_sub\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09${0:w}, $2\0A\09sub\09${0:w}, ${0:w}, ${3:w}\0A\09stxr\09${1:w}, ${0:w}, $2\0A\09cbnz\09${1:w}, 1b\0A", "=&r,=&r,=*Q,Jr,*Q"(i32* elementtype(i32) %counter, i32 1, i32* elementtype(i32) %counter) #9, !srcloc !15
  ret void
}
...
entry:
  %arraydecay = getelementptr inbounds %struct.cpumask, %struct.cpumask* %dstp, i64 0, i32 0, i64 0
  call fastcc void @bitmap_zero(i64* noundef %arraydecay) #6
  ret void
}
...
!10 = !{i64 2157121355}
!11 = !{i64 2157121447}
!12 = !{i64 2148030401, i64 2148030922, i64 2148030952, i64 2148030978, i64 2148031010, i64 2148031039}
!13 = !{i64 2148019831, i64 2148020342, i64 2148020372, i64 2148020398, i64 2148020430, i64 2148020459}
!14 = !{i64 2147950751, i64 2147951267, i64 2147951297, i64 2147951324, i64 2147951358, i64 2147951388}
!15 = !{i64 2147960472, i64 2147960988, i64 2147961018, i64 2147961045, i64 2147961079, i64 2147961109}
