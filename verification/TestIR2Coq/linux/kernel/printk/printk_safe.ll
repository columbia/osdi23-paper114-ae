...
entry:
  ...
  %call = call fastcc i64 @__kern_my_cpu_offset() #8
  %add = add i64 %call, ptrtoint (i32* @printk_context to i64)
  %0 = inttoptr i64 %add to i8*
  call fastcc void @__percpu_add_case_32(i8* noundef %0, i64 noundef 1) #8
...
entry:
  ...
  %1 = call { i32, i32 } asm sideeffect "1:\09ldxr\09${1:w}, $2\0Aadd\09${1:w}, ${1:w}, ${3:w}\0A\09stxr\09${0:w}, ${1:w}, $2\0A\09cbnz\09${0:w}, 1b", "=&r,=&r,=*Q,r,*Q"(i32* elementtype(i32) %0, i32 %conv, i32* elementtype(i32) %0) #7, !srcloc !10
  ret void
}
...
entry:
  ...
  %2 = call i64 asm ".if 1 == 1\0A661:\0A\09mrs $0, tpidr_el1\0A662:\0A.pushsection .altinstructions,\22a\22\0A .word 661b - .\0A .word 663f - .\0A .hword 31\0A .byte 662b-661b\0A .byte 664f-663f\0A.popsection\0A.subsection 1\0A663:\0A\09mrs $0, tpidr_el2\0A664:\0A\09.org\09. - (664b-663b) + (662b-661b)\0A\09.org\09. - (662b-661b) + (664b-663b)\0A\09.previous\0A.endif\0A", "=r,*Q"(i64* elementtype(i64) %1) #9, !srcloc !11
  ret i64 %2
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @vprintk(i8* noundef %fmt, %"struct.std::__va_list"* nocapture noundef readonly %args) local_unnamed_addr #0 {
entry:
  %byval-temp = alloca %"struct.std::__va_list", align 8
  %byval-temp13 = alloca %"struct.std::__va_list", align 8
  call void asm sideeffect "", "~{memory}"() #7, !srcloc !14
  %call = call fastcc i64 @__kern_my_cpu_offset() #8
  %add = add i64 %call, ptrtoint (i32* @printk_context to i64)
  %0 = inttoptr i64 %add to i8*
  %call6 = call fastcc i64 @__percpu_read_32(i8* noundef %0) #8
...
lor.lhs.false:                                    ; preds = %entry
  %call9 = call fastcc i32 @preempt_count() #8
  %1 = and i32 %call9, 15728640
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call12 = call i32 @vprintk_store(i32 noundef 0, i32 noundef -1, %struct.dev_printk_info* noundef null, i8* noundef %fmt, %"struct.std::__va_list"* noundef nonnull %byval-temp) #10
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %2) #7
  call void @defer_console_output() #10
  br label %return

if.end:                                           ; preds = %lor.lhs.false
  %4 = bitcast %"struct.std::__va_list"* %byval-temp13 to i8*
  ...
  %call14 = call i32 @vprintk_default(i8* noundef %fmt, %"struct.std::__va_list"* noundef nonnull %byval-temp13) #10
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %4) #7
  br label %return

return:                                           ; preds = %if.end, %if.then
  %retval.0 = phi i32 [ %call12, %if.then ], [ %call14, %if.end ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i64 @__percpu_read_32(i8* noundef %ptr) unnamed_addr #3 {
entry:
  %0 = bitcast i8* %ptr to i32*
...
entry:
  %0 = call i64 asm "mrs $0, sp_el0", "=r"() #11, !srcloc !16
...
declare dso_local i32 @vprintk_store(i32 noundef, i32 noundef, %struct.dev_printk_info* noundef, i8* noundef, %"struct.std::__va_list"* noundef) local_unnamed_addr #4

; Function Attrs: argmemonly mustprogress nofree nounwind willreturn
declare void @llvm.memcpy.p0i8.p0i8.i64(i8* noalias nocapture writeonly, i8* noalias nocapture readonly, i64, i1 immarg) #5

; Function Attrs: null_pointer_is_valid
declare dso_local void @defer_console_output() local_unnamed_addr #4

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @vprintk_default(i8* noundef, %"struct.std::__va_list"* noundef) local_unnamed_addr #4
...
!8 = !{i64 2153589658}
!9 = !{i64 2153590480}
!10 = !{i64 2148860319, i64 2148860361, i64 2148860420, i64 2148860473}
!11 = !{i64 2148835429, i64 2148835476, i64 2148835482, i64 2148835519, i64 2148835537, i64 2148836464, i64 2148836512, i64 2148836560, i64 2148836623, i64 2148836672, i64 2148835615, i64 2148835640, i64 2148835666, i64 2148835672, i64 2148835709, i64 2148835715, i64 2148835765, i64 2148835811, i64 2148835844}
!12 = !{i64 2153595304}
!13 = !{i64 2153596126}
!14 = !{i64 2153600899}
!15 = !{i64 2153601721}
