...
@irqs_resend = internal global [130 x i64] zeroinitializer, align 8
@resend_tasklet = internal global { %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 } { %struct.tasklet_struct* null, i64 0, %struct.atomic_t zeroinitializer, i8 1, { void (%struct.tasklet_struct*)* } { void (%struct.tasklet_struct*)* @resend_irqs }, i64 0 }, align 8
@nr_irqs = external dso_local local_unnamed_addr global i32, align 4
@gic_nonsecure_priorities = external dso_local global %struct.static_key_false, align 4

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @check_irq_resend(%struct.irq_desc* noundef %desc, i1 noundef %inject) local_unnamed_addr #0 {
entry:
  %call = call fastcc i1 @irq_settings_is_level(%struct.irq_desc* noundef %desc) #4
...
if.end10:                                         ; preds = %if.end4
  %and12 = and i32 %0, -513
  store i32 %and12, i32* %core_internal_state__do_not_mess_with_it, align 4
  %call13 = call fastcc i32 @try_retrigger(%struct.irq_desc* noundef %desc) #4
  %tobool14.not = icmp eq i32 %call13, 0
  br i1 %tobool14.not, label %if.end17, label %if.then19

if.end17:                                         ; preds = %if.end10
  %call16 = call fastcc i32 @irq_sw_resend(%struct.irq_desc* noundef %desc) #4
  %tobool18.not = icmp eq i32 %call16, 0
  br i1 %tobool18.not, label %if.then19, label %cleanup

if.then19:                                        ; preds = %if.end10, %if.end17
  %1 = load i32, i32* %core_internal_state__do_not_mess_with_it, align 4
  %or = or i32 %1, 64
  br label %cleanup.sink.split

cleanup.sink.split:                               ; preds = %if.then, %if.then19
  %or.sink = phi i32 [ %or, %if.then19 ], [ %and, %if.then ]
  %retval.0.ph = phi i32 [ 0, %if.then19 ], [ -22, %if.then ]
  store i32 %or.sink, i32* %core_internal_state__do_not_mess_with_it, align 4
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %if.end17, %if.end4, %if.end
  %retval.0 = phi i32 [ -16, %if.end ], [ 0, %if.end4 ], [ %call16, %if.end17 ], [ %retval.0.ph, %cleanup.sink.split ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i1 @irq_settings_is_level(%struct.irq_desc* nocapture noundef readonly %desc) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @try_retrigger(%struct.irq_desc* noundef %desc) unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  %call = call i32 %1(%struct.irq_data* noundef %irq_data) #5
  br label %return

if.end:                                           ; preds = %entry
  %call6 = call i32 @irq_chip_retrigger_hierarchy(%struct.irq_data* noundef %irq_data) #5
  br label %return
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @irq_sw_resend(%struct.irq_desc* nocapture noundef readonly %desc) unnamed_addr #0 {
entry:
  %call = call fastcc i32 @irq_desc_get_irq(%struct.irq_desc* noundef %desc) #4
  %call2 = call fastcc i1 @irq_settings_is_nested_thread(%struct.irq_desc* noundef %desc) #4
  br i1 %call2, label %if.then3, label %if.end7

if.then3:                                         ; preds = %entry
  %parent_irq = getelementptr inbounds %struct.irq_desc, %struct.irq_desc* %desc, i64 0, i32 27
  %0 = load i32, i32* %parent_irq, align 32
  %tobool.not = icmp eq i32 %0, 0
  br i1 %tobool.not, label %cleanup, label %if.end7

if.end7:                                          ; preds = %if.then3, %entry
  %irq.0 = phi i32 [ %call, %entry ], [ %0, %if.then3 ]
  %conv = zext i32 %irq.0 to i64
  call fastcc void @set_bit(i64 noundef %conv) #4
  call fastcc void @tasklet_schedule() #4
  br label %cleanup

cleanup:                                          ; preds = %if.then3, %if.end7
  %retval.0 = phi i32 [ 0, %if.end7 ], [ -22, %if.then3 ]
  ret i32 %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @irq_chip_retrigger_hierarchy(%struct.irq_data* noundef) local_unnamed_addr #2

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i32 @irq_desc_get_irq(%struct.irq_desc* nocapture noundef readonly %desc) unnamed_addr #1 {
entry:
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i1 @irq_settings_is_nested_thread(%struct.irq_desc* nocapture noundef readonly %desc) unnamed_addr #1 {
entry:
  %status_use_accessors = getelementptr inbounds %struct.irq_desc, %struct.irq_desc* %desc, i64 0, i32 5
  %0 = load i32, i32* %status_use_accessors, align 16
  %and = and i32 %0, 32768
...
entry:
  ...
  %add.ptr.i = getelementptr [130 x i64], [130 x i64]* @irqs_resend, i64 0, i64 %idx.ext.i
  %rem.i = and i64 %nr, 63
  %shl.i = shl nuw i64 1, %rem.i
  %0 = bitcast i64* %add.ptr.i to %struct.atomic64_t*
  call fastcc void @__ll_sc_atomic64_or(i64 noundef %shl.i, %struct.atomic64_t* noundef %0) #5
  ret void
}
...
entry:
  %call = call fastcc i1 @test_and_set_bit() #4
  br i1 %call, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  call void @__tasklet_schedule(%struct.tasklet_struct* noundef bitcast ({ %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }* @resend_tasklet to %struct.tasklet_struct*)) #5
  br label %if.end
...
entry:
  ...
  %0 = call { i64, i64 } asm sideeffect "// atomic64_or\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09orr\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,Lr,*Q"(i64* elementtype(i64) %counter, i64 %i, i64* elementtype(i64) %counter) #6, !srcloc !7
  ret void
}
...
entry:
  %0 = load volatile i64, i64* getelementptr inbounds ({ %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }, { %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }* @resend_tasklet, i64 0, i32 1), align 8
  %and.i = and i64 %0, 1
  %tobool.not.i = icmp eq i64 %and.i, 0
  br i1 %tobool.not.i, label %if.end.i, label %arch_test_and_set_bit.exit

if.end.i:                                         ; preds = %entry
  %call.i.i.i = call fastcc i64 @__ll_sc_atomic64_fetch_or() #5
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @__tasklet_schedule(%struct.tasklet_struct* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__ll_sc_atomic64_fetch_or() unnamed_addr #0 {
entry:
  %0 = call { i64, i64, i64 } asm sideeffect "// atomic64_fetch_or\0A\09prfm\09pstl1strm, $3\0A1:\09ldxr\09$0, $3\0A\09orr\09$1, $0, $4\0A\09stlxr\09${2:w}, $1, $3\0A\09cbnz\09${2:w}, 1b\0A\09dmb ish", "=&r,=&r,=&r,=*Q,Lr,*Q,~{memory}"(i64* elementtype(i64) getelementptr inbounds ({ %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }, { %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }* @resend_tasklet, i64 0, i32 1), i64 1, i64* elementtype(i64) getelementptr inbounds ({ %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }, { %struct.tasklet_struct*, i64, %struct.atomic_t, i8, { void (%struct.tasklet_struct*)* }, i64 }* @resend_tasklet, i64 0, i32 1)) #6, !srcloc !8
  %asmresult = extractvalue { i64, i64, i64 } %0, 0
  ret i64 %asmresult
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal void @resend_irqs(%struct.tasklet_struct* nocapture noundef readnone %unused) #0 {
entry:
  %0 = load i32, i32* @nr_irqs, align 4
  %call13 = call fastcc i1 @bitmap_empty(i32 noundef %0) #4
  br i1 %call13, label %while.end, label %while.body

while.body:                                       ; preds = %entry, %while.cond.backedge
  %1 = load i32, i32* @nr_irqs, align 4
  %conv = sext i32 %1 to i64
  %call1 = call fastcc i64 @find_first_bit(i64 noundef %conv) #4
  %conv2 = trunc i64 %call1 to i32
  %sext = shl i64 %call1, 32
  %conv3 = ashr exact i64 %sext, 32
  call fastcc void @clear_bit(i64 noundef %conv3) #4
  %call4 = call %struct.irq_desc* @irq_to_desc(i32 noundef %conv2) #5
  %tobool.not = icmp eq %struct.irq_desc* %call4, null
  br i1 %tobool.not, label %while.cond.backedge, label %do.body

do.body:                                          ; preds = %while.body
  call fastcc void @arch_local_irq_disable() #4
  %handle_irq = getelementptr inbounds %struct.irq_desc, %struct.irq_desc* %call4, i64 0, i32 3
  %2 = load void (%struct.irq_desc*)*, void (%struct.irq_desc*)** %handle_irq, align 32
  call void %2(%struct.irq_desc* noundef nonnull %call4) #5
  call fastcc void @arch_local_irq_enable() #4
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %do.body, %while.body
  %3 = load i32, i32* @nr_irqs, align 4
  %call = call fastcc i1 @bitmap_empty(i32 noundef %3) #4
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i1 @bitmap_empty(i32 noundef %nbits) unnamed_addr #0 {
entry:
  %conv = zext i32 %nbits to i64
  %call = call fastcc i64 @find_first_bit(i64 noundef %conv) #4
  %cmp5 = icmp eq i64 %call, %conv
  ret i1 %cmp5
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @find_first_bit(i64 noundef %size) unnamed_addr #0 {
entry:
  %call5 = call i64 @_find_first_bit(i64* noundef getelementptr inbounds ([130 x i64], [130 x i64]* @irqs_resend, i64 0, i64 0), i64 noundef %size) #5
  ret i64 %call5
}
...
entry:
  ...
  %shl.i = shl nuw i64 1, %rem.i
  %0 = bitcast i64* %add.ptr.i to %struct.atomic64_t*
  call fastcc void @__ll_sc_atomic64_andnot(i64 noundef %shl.i, %struct.atomic64_t* noundef %0) #5
  ret void
}
...
entry:
  %counter = getelementptr inbounds %struct.atomic64_t, %struct.atomic64_t* %v, i64 0, i32 0
  %0 = call { i64, i64 } asm sideeffect "// atomic64_andnot\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09bic\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,r,*Q"(i64* elementtype(i64) %counter, i64 %i, i64* elementtype(i64) %counter) #6, !srcloc !12
  ret void
}
...
!7 = !{i64 2147886462, i64 2147886973, i64 2147887003, i64 2147887029, i64 2147887061, i64 2147887090}
!8 = !{i64 2147887308, i64 2147887960, i64 2147887990, i64 2147888021, i64 2147888053, i64 2147888088, i64 2147888113}
!9 = !{!"branch_weights", i32 1, i32 2000}
!10 = !{i64 2148947703, i64 2148947750, i64 2148947756, i64 2148947793, i64 2148947811, i64 2148949152, i64 2148949200, i64 2148949248, i64 2148949311, i64 2148949360, i64 2148947889, i64 2148947914, i64 2148947940, i64 2148947946, i64 2148948818, i64 2148948858, i64 2148948876, i64 2148948908, i64 2148948936, i64 2148948990, i64 2148949010, i64 2148949107, i64 2148947969, i64 2148947983, i64 2148947989, i64 2148948039, i64 2148948085, i64 2148948118}
!11 = !{i64 2148938247, i64 2148938294, i64 2148938300, i64 2148938337, i64 2148938355, i64 2148939695, i64 2148939743, i64 2148939791, i64 2148939854, i64 2148939903, i64 2148938433, i64 2148938458, i64 2148938484, i64 2148938490, i64 2148939361, i64 2148939401, i64 2148939419, i64 2148939451, i64 2148939479, i64 2148939533, i64 2148939553, i64 2148939650, i64 2148938513, i64 2148938527, i64 2148938533, i64 2148938583, i64 2148938629, i64 2148938662}
!12 = !{i64 2147897032, i64 2147897553, i64 2147897583, i64 2147897609, i64 2147897641, i64 2147897670}
