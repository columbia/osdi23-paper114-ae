...
define dso_local %struct.page** @dma_common_find_pages(i8* noundef %cpu_addr) local_unnamed_addr #0 {
entry:
  %call = call %struct.vm_struct* @find_vm_area(i8* noundef %cpu_addr) #3
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %1 = load %struct.page**, %struct.page*** %pages, align 8
  br label %cleanup

cleanup:                                          ; preds = %entry, %lor.lhs.false, %if.end
  %retval.0 = phi %struct.page** [ %1, %if.end ], [ null, %lor.lhs.false ], [ null, %entry ]
  ret %struct.page** %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.vm_struct* @find_vm_area(i8* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i8* @dma_common_pages_remap(%struct.page** noundef %pages, i64 noundef %size, i64 %prot.coerce, i8* nocapture noundef readnone %caller) local_unnamed_addr #0 {
entry:
  %add = add i64 %size, 4095
  %shr = lshr i64 %add, 12
  %conv = trunc i64 %shr to i32
  %call = call i8* @vmap(%struct.page** noundef %pages, i32 noundef %conv, i64 noundef 16, i64 %prot.coerce) #3
  %tobool.not = icmp eq i8* %call, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call2 = call %struct.vm_struct* @find_vm_area(i8* noundef nonnull %call) #3
  %pages3 = getelementptr inbounds %struct.vm_struct, %struct.vm_struct* %call2, i64 0, i32 4
  store %struct.page** %pages, %struct.page*** %pages3, align 8
  br label %if.end
...
; Function Attrs: null_pointer_is_valid
declare dso_local i8* @vmap(%struct.page** noundef, i32 noundef, i64 noundef, i64) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i8* @dma_common_contiguous_remap(%struct.page* noundef %page, i64 noundef %size, i64 %prot.coerce, i8* nocapture noundef readnone %caller) local_unnamed_addr #0 {
entry:
  %add = add i64 %size, 4095
  %shr = lshr i64 %add, 12
  %conv = trunc i64 %shr to i32
  ...
  %call = call fastcc i8* @kmalloc_array(i64 noundef %conv1) #4
...
for.body.preheader:                               ; preds = %for.cond.preheader
  %wide.trip.count = and i64 %shr, 4294967295
  %min.iters.check = icmp ult i64 %wide.trip.count, 2
  br i1 %min.iters.check, label %for.body.preheader24, label %vector.ph

vector.ph:                                        ; preds = %for.body.preheader
  %n.mod.vf = and i64 %shr, 1
  %n.vec = sub nsw i64 %wide.trip.count, %n.mod.vf
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %induction23 = or i64 %index, 1
  %1 = getelementptr %struct.page, %struct.page* %page, i64 %index
  %2 = getelementptr %struct.page, %struct.page* %page, i64 %induction23
  %3 = getelementptr %struct.page*, %struct.page** %0, i64 %index
  %4 = getelementptr %struct.page*, %struct.page** %0, i64 %induction23
  store %struct.page* %1, %struct.page** %3, align 8
  store %struct.page* %2, %struct.page** %4, align 8
...
for.body:                                         ; preds = %for.body.preheader24, %for.body
  ...
  %arrayidx = getelementptr %struct.page*, %struct.page** %0, i64 %indvars.iv
  store %struct.page* %add.ptr, %struct.page** %arrayidx, align 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !9

for.end:                                          ; preds = %for.body, %middle.block, %for.cond.preheader
  %call4 = call i8* @vmap(%struct.page** noundef nonnull %0, i32 noundef %conv, i64 noundef 16, i64 %prot.coerce) #3
  call void @kfree(i8* noundef nonnull %call) #3
  br label %cleanup

cleanup:                                          ; preds = %entry, %for.end
  %retval.0 = phi i8* [ %call4, %for.end ], [ null, %entry ]
  ret i8* %retval.0
}
...
if.end8:                                          ; preds = %entry
  ...
  %call9 = call noalias align 128 i8* @__kmalloc(i64 noundef %2, i32 noundef 3264) #3
  br label %cleanup
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @dma_common_free_remap(i8* noundef %cpu_addr, i64 noundef %size) local_unnamed_addr #0 {
entry:
  %call = call %struct.vm_struct* @find_vm_area(i8* noundef %cpu_addr) #3
  %tobool.not = icmp eq %struct.vm_struct* %call, null
...
do.end:                                           ; preds = %entry, %lor.lhs.false
  call void (i8*, ...) @__warn_printk(i8* noundef getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i8* noundef %cpu_addr) #3
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22kernel/dma/remap.c\22; .popsection; .long 14472b - 14470b; .short 65; .short (1 << 0)|((1 << 3) | ((9) << 8)); .popsection; 14471: brk 0x800", ""() #5, !srcloc !11
  br label %cleanup

if.end18:                                         ; preds = %lor.lhs.false
  call void @vunmap(i8* noundef %cpu_addr) #3
  br label %cleanup
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @vunmap(i8* noundef) local_unnamed_addr #1
