; ModuleID = 'block/blk-timeout.c'
source_filename = "block/blk-timeout.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall7.init\22, \22a\22\09\09"
module asm "__initcall__kmod_blk_timeout__409_99_blk_timeout_init7:\09\09\09"
...
@__UNIQUE_ID___addressable_blk_timeout_init410 = internal global i8* bitcast (i32 ()* @blk_timeout_init to i8*), section ".discard.addressable", align 8
@blk_timeout_mask = internal unnamed_addr global i1 false, section ".data..read_mostly", align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_blk_timeout_init410 to i8*)], section "llvm.metadata"

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @blk_abort_request(%struct.request* noundef %req) local_unnamed_addr #0 {
entry:
  %0 = load volatile i64, i64* @jiffies, align 64
  %deadline = getelementptr inbounds %struct.request, %struct.request* %req, i64 0, i32 26
  ...
  %timeout_work = getelementptr inbounds %struct.request_queue, %struct.request_queue* %1, i64 0, i32 26
  %call = call i32 @kblockd_schedule_work(%struct.work_struct* noundef %timeout_work) #5
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @kblockd_schedule_work(%struct.work_struct* noundef) local_unnamed_addr #1
...
entry:
  store i1 true, i1* @blk_timeout_mask, align 8
  ret i32 0
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define dso_local i64 @blk_rq_timeout(i64 noundef %timeout) local_unnamed_addr #3 {
entry:
  %0 = load volatile i64, i64* @jiffies, align 64
  %add = add i64 %0, 1250
  %call = call fastcc i64 @blk_round_jiffies(i64 noundef %add) #6
  %sub = sub i64 %call, %timeout
  %cmp = icmp slt i64 %sub, 0
  %spec.select = select i1 %cmp, i64 %call, i64 %timeout
  ret i64 %spec.select
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i64 @blk_round_jiffies(i64 noundef %j) unnamed_addr #4 {
entry:
  %.b = load i1, i1* @blk_timeout_mask, align 8
  %0 = select i1 %.b, i64 255, i64 0
  %add = add i64 %j, 1
  %add1 = add i64 %add, %0
  ret i64 %add1
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @blk_add_timer(%struct.request* noundef %req) local_unnamed_addr #0 {
entry:
  %q1 = getelementptr inbounds %struct.request, %struct.request* %req, i64 0, i32 0
  %0 = load %struct.request_queue*, %struct.request_queue** %q1, align 8
  %timeout = getelementptr inbounds %struct.request, %struct.request* %req, i64 0, i32 25
  %1 = load i32, i32* %timeout, align 8
  %tobool.not = icmp eq i32 %1, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %rq_timeout = getelementptr inbounds %struct.request_queue, %struct.request_queue* %0, i64 0, i32 21
  %2 = load i32, i32* %rq_timeout, align 8
  store i32 %2, i32* %timeout, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %add = add i64 %5, %conv
  %deadline = getelementptr inbounds %struct.request, %struct.request* %req, i64 0, i32 26
  store volatile i64 %add, i64* %deadline, align 8
  %call = call fastcc i64 @blk_round_jiffies(i64 noundef %add) #6
  %call10 = call i64 @blk_rq_timeout(i64 noundef %call) #6
  %timeout11 = getelementptr inbounds %struct.request_queue, %struct.request_queue* %0, i64 0, i32 25
  %call12 = call fastcc i32 @timer_pending(%struct.timer_list* noundef %timeout11) #6
  %tobool13.not = icmp eq i32 %call12, 0
  %expires18.phi.trans.insert = getelementptr inbounds %struct.request_queue, %struct.request_queue* %0, i64 0, i32 25, i32 1
  %.pre = load i64, i64* %expires18.phi.trans.insert, align 8
  %sub = sub i64 %call10, %.pre
  %cmp = icmp slt i64 %sub, 0
  %or.cond48 = select i1 %tobool13.not, i1 true, i1 %cmp
  br i1 %or.cond48, label %if.then16, label %if.end30

if.then16:                                        ; preds = %if.end
  %sub19 = sub i64 %.pre, %call10
  %call21 = call fastcc i32 @timer_pending(%struct.timer_list* noundef %timeout11) #6
  %tobool22 = icmp eq i32 %call21, 0
  %cmp24 = icmp ugt i64 %sub19, 124
  %or.cond = select i1 %tobool22, i1 true, i1 %cmp24
  br i1 %or.cond, label %if.then26, label %if.end30

if.then26:                                        ; preds = %if.then16
  %call28 = call i32 @mod_timer(%struct.timer_list* noundef %timeout11, i64 noundef %call10) #5
  br label %if.end30

if.end30:                                         ; preds = %if.end, %if.then26, %if.then16
  ret void
}
...
entry:
  ...
  %call = call fastcc i32 @hlist_unhashed_lockless(%struct.hlist_node* noundef %entry1) #6
