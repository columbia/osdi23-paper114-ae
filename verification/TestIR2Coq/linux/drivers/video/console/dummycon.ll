; ModuleID = 'drivers/video/console/dummycon.c'
...
@dummy_con = dso_local local_unnamed_addr constant { %struct.module*, i8* ()*, void (%struct.vc_data*, i32)*, void (%struct.vc_data*)*, void (%struct.vc_data*, i32, i32, i32, i32)*, void (%struct.vc_data*, i32, i32, i32)*, void (%struct.vc_data*, i16*, i32, i32, i32)*, void (%struct.vc_data*, i32)*, i1 (%struct.vc_data*, i32, i32, i32, i32)*, i32 (%struct.vc_data*)*, i32 (%struct.vc_data*, i32, i32)*, i32 (%struct.vc_data*, %struct.console_font*, i32)*, i32 (%struct.vc_data*, %struct.console_font*)*, i32 (%struct.vc_data*, %struct.console_font*, i8*)*, i32 (%struct.vc_data*, i32, i32, i32)*, void (%struct.vc_data*, i8*)*, void (%struct.vc_data*, i32)*, i32 (%struct.vc_data*)*, void (%struct.vc_data*)*, i8 (%struct.vc_data*, i8, i32, i1, i1, i1, i1)*, void (%struct.vc_data*, i16*, i32)*, i16* (%struct.vc_data*, i32)*, i64 (%struct.vc_data*, i64, i32*, i32*)*, void (%struct.vc_data*)*, i32 (%struct.vc_data*)*, i32 (%struct.vc_data*)* } { %struct.module* null, i8* ()* @dummycon_startup, void (%struct.vc_data*, i32)* @dummycon_init, void (%struct.vc_data*)* @dummycon_deinit, void (%struct.vc_data*, i32, i32, i32, i32)* @dummycon_clear, void (%struct.vc_data*, i32, i32, i32)* @dummycon_putc, void (%struct.vc_data*, i16*, i32, i32, i32)* @dummycon_putcs, void (%struct.vc_data*, i32)* @dummycon_cursor, i1 (%struct.vc_data*, i32, i32, i32, i32)* @dummycon_scroll, i32 (%struct.vc_data*)* @dummycon_switch, i32 (%struct.vc_data*, i32, i32)* @dummycon_blank, i32 (%struct.vc_data*, %struct.console_font*, i32)* null, i32 (%struct.vc_data*, %struct.console_font*)* null, i32 (%struct.vc_data*, %struct.console_font*, i8*)* null, i32 (%struct.vc_data*, i32, i32, i32)* null, void (%struct.vc_data*, i8*)* null, void (%struct.vc_data*, i32)* null, i32 (%struct.vc_data*)* null, void (%struct.vc_data*)* null, i8 (%struct.vc_data*, i8, i32, i1, i1, i1, i1)* null, void (%struct.vc_data*, i16*, i32)* null, i16* (%struct.vc_data*, i32)* null, i64 (%struct.vc_data*, i64, i32*, i32*)* null, void (%struct.vc_data*)* null, i32 (%struct.vc_data*)* null, i32 (%struct.vc_data*)* null }, align 8
...
define internal void @dummycon_init(%struct.vc_data* noundef %vc, i32 noundef %init) #1 {
entry:
  ...
  store i16 %bf.set, i16* %vc_can_do_color, align 8
  %tobool.not = icmp eq i32 %init, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %vc_cols = getelementptr inbounds %struct.vc_data, %struct.vc_data* %vc, i64 0, i32 4
  store i32 80, i32* %vc_cols, align 4
  %vc_rows = getelementptr inbounds %struct.vc_data, %struct.vc_data* %vc, i64 0, i32 5
  store i32 25, i32* %vc_rows, align 8
  br label %if.end

if.else:                                          ; preds = %entry
  %call = call i32 @vc_resize(%struct.vc_data* noundef %vc, i32 noundef 80, i32 noundef 25) #3
  br label %if.end
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @dummycon_deinit(%struct.vc_data* nocapture noundef %vc) #0 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @dummycon_clear(%struct.vc_data* nocapture noundef %vc, i32 noundef %sy, i32 noundef %sx, i32 noundef %height, i32 noundef %width) #0 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @dummycon_putc(%struct.vc_data* nocapture noundef %vc, i32 noundef %c, i32 noundef %ypos, i32 noundef %xpos) #0 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @dummycon_putcs(%struct.vc_data* nocapture noundef %vc, i16* nocapture noundef %s, i32 noundef %count, i32 noundef %ypos, i32 noundef %xpos) #0 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @dummycon_cursor(%struct.vc_data* nocapture noundef %vc, i32 noundef %mode) #0 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i1 @dummycon_scroll(%struct.vc_data* nocapture noundef readnone %vc, i32 noundef %top, i32 noundef %bottom, i32 noundef %dir, i32 noundef %lines) #0 {
entry:
  ret i1 false
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i32 @dummycon_switch(%struct.vc_data* nocapture noundef readnone %vc) #0 {
entry:
  ret i32 0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i32 @dummycon_blank(%struct.vc_data* nocapture noundef readnone %vc, i32 noundef %blank, i32 noundef %mode_switch) #0 {
entry:
  ret i32 0
}
