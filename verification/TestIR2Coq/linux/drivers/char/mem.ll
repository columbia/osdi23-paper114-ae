; ModuleID = 'drivers/char/mem.c'
source_filename = "drivers/char/mem.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_mem__441_777_chr_dev_init5:\09\09\09"
...
%struct.tty_struct = type { i32, %struct.kref, %struct.device*, %struct.tty_driver*, %struct.tty_operations*, i32, %struct.ld_semaphore, %struct.tty_ldisc*, %struct.mutex, %struct.mutex, %struct.mutex, %struct.rw_semaphore, %struct.mutex, %struct.ktermios, %struct.ktermios, [64 x i8], i64, i32, %struct.winsize, %struct.anon.39, %struct.anon.40, i32, i32, i32, %struct.tty_struct*, %struct.fasync_struct*, %struct.wait_queue_head, %struct.wait_queue_head, %struct.work_struct, i8*, i8*, %struct.spinlock, %struct.list_head, i32, i8*, i32, %struct.work_struct, %struct.tty_port* }
...
%struct.anon.39 = type { %struct.spinlock, i8, i8, [0 x i64] }
%struct.anon.40 = type { %struct.spinlock, %struct.pid*, %struct.pid*, i8, i8, [0 x i64] }
...
%struct.tty_buffer = type { %union.anon.38, i32, i32, i32, i32, i32, [0 x i64] }
%union.anon.38 = type { %struct.tty_buffer* }
...
%struct.bio = type { %struct.bio*, %struct.block_device*, i32, i16, i16, i16, i8, %struct.atomic_t, %struct.bvec_iter, void (%struct.bio*)*, i8*, %union.anon.43, i16, i16, %struct.atomic_t, %struct.bio_vec*, %struct.bio_set*, [0 x %struct.bio_vec] }
%struct.bvec_iter = type { i64, i32, i32, i32 }
%union.anon.43 = type {}
%struct.bio_vec = type { %struct.page*, i32, i32 }
%struct.page = type { i64, %union.anon.13, %union.anon.63, %struct.atomic_t, [8 x i8] }
...
%struct.request = type { %struct.request_queue*, %struct.blk_mq_ctx*, %struct.blk_mq_hw_ctx*, i32, i32, i32, i32, i32, i64, %struct.bio*, %struct.bio*, %struct.list_head, %union.anon.69, %union.anon.70, %union.anon.71, %struct.gendisk*, %struct.block_device*, i64, i64, i16, i16, i16, i16, i32, %struct.refcount_struct, i32, i64, %union.anon.74, void (%struct.request*, i8)*, i8* }
...
%struct.kiocb = type { %struct.file*, i64, void (%struct.kiocb*, i64, i64)*, i8*, i32, i16, i16, %union.anon.64 }
%union.anon.64 = type { %struct.wait_page_queue* }
%struct.wait_page_queue = type { %struct.page*, i32, %struct.wait_queue_entry }
%struct.wait_queue_entry = type { i32, i8*, i32 (%struct.wait_queue_entry*, i32, i32, i8*)*, %struct.list_head }
%struct.iov_iter = type { i8, i8, i64, i64, %union.anon.65, %union.anon.66 }
%union.anon.65 = type { %struct.iovec* }
...
%struct.memdev = type { i8*, i16, %struct.file_operations*, i32 }
%struct.splice_desc = type { i64, i32, i32, %union.anon.85, i64, i64*, i64, i8 }
%union.anon.85 = type { i8* }

@__UNIQUE_ID___addressable_chr_dev_init442 = internal global i8* bitcast (i32 ()* @chr_dev_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [4 x i8] c"mem\00", align 1
@memory_fops = internal constant %struct.file_operations { %struct.module* null, i64 (%struct.file*, i64, i32)* @noop_llseek, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.kiocb*, %struct.iov_iter*)* null, i64 (%struct.kiocb*, %struct.iov_iter*)* null, i32 (%struct.kiocb*, i1)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.poll_table_struct*)* null, i64 (%struct.file*, i32, i64)* null, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* null, i64 0, i32 (%struct.inode*, %struct.file*)* @memory_open, i32 (%struct.file*, i8*)* null, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i64, i64, i32)* null, i32 (i32, %struct.file*, i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.file*, %struct.page*, i32, i64, i64*, i32)* null, i64 (%struct.file*, i64, i64, i64, i64)* null, i32 (i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.pipe_inode_info*, %struct.file*, i64*, i64, i32)* null, i64 (%struct.file*, i64*, %struct.pipe_inode_info*, i64, i32)* null, i32 (%struct.file*, i64, %struct.file_lock**, i8**)* null, i64 (%struct.file*, i32, i64, i64)* null, void (%struct.seq_file*, %struct.file*)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i32 (%struct.file*, i64, i64, i32)* null }, align 8
...
@mem_class = internal unnamed_addr global %struct.class* null, align 8
@devlist = internal unnamed_addr constant [12 x %struct.memdev] [%struct.memdev zeroinitializer, %struct.memdev zeroinitializer, %struct.memdev zeroinitializer, %struct.memdev { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i16 438, %struct.file_operations* @null_fops, i32 0 }, %struct.memdev zeroinitializer, %struct.memdev { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i16 438, %struct.file_operations* @zero_fops, i32 0 }, %struct.memdev zeroinitializer, %struct.memdev { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i16 438, %struct.file_operations* @full_fops, i32 0 }, %struct.memdev { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i32 0, i32 0), i16 438, %struct.file_operations* @random_fops, i32 0 }, %struct.memdev { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), i16 438, %struct.file_operations* @urandom_fops, i32 0 }, %struct.memdev zeroinitializer, %struct.memdev { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i32 0, i32 0), i16 420, %struct.file_operations* @kmsg_fops, i32 0 }], align 8
@.str.2 = private unnamed_addr constant [5 x i8] c"null\00", align 1
@null_fops = internal constant %struct.file_operations { %struct.module* null, i64 (%struct.file*, i64, i32)* @null_lseek, i64 (%struct.file*, i8*, i64, i64*)* @read_null, i64 (%struct.file*, i8*, i64, i64*)* @write_null, i64 (%struct.kiocb*, %struct.iov_iter*)* @read_iter_null, i64 (%struct.kiocb*, %struct.iov_iter*)* @write_iter_null, i32 (%struct.kiocb*, i1)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.poll_table_struct*)* null, i64 (%struct.file*, i32, i64)* null, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* null, i64 0, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i8*)* null, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i64, i64, i32)* null, i32 (i32, %struct.file*, i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.file*, %struct.page*, i32, i64, i64*, i32)* null, i64 (%struct.file*, i64, i64, i64, i64)* null, i32 (i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.pipe_inode_info*, %struct.file*, i64*, i64, i32)* @splice_write_null, i64 (%struct.file*, i64*, %struct.pipe_inode_info*, i64, i32)* null, i32 (%struct.file*, i64, %struct.file_lock**, i8**)* null, i64 (%struct.file*, i32, i64, i64)* null, void (%struct.seq_file*, %struct.file*)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i32 (%struct.file*, i64, i64, i32)* null }, align 8
@.str.3 = private unnamed_addr constant [5 x i8] c"zero\00", align 1
@zero_fops = internal constant %struct.file_operations { %struct.module* null, i64 (%struct.file*, i64, i32)* @null_lseek, i64 (%struct.file*, i8*, i64, i64*)* @read_zero, i64 (%struct.file*, i8*, i64, i64*)* @write_null, i64 (%struct.kiocb*, %struct.iov_iter*)* @read_iter_zero, i64 (%struct.kiocb*, %struct.iov_iter*)* @write_iter_null, i32 (%struct.kiocb*, i1)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.poll_table_struct*)* null, i64 (%struct.file*, i32, i64)* null, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* @mmap_zero, i64 0, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i8*)* null, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i64, i64, i32)* null, i32 (i32, %struct.file*, i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.file*, %struct.page*, i32, i64, i64*, i32)* null, i64 (%struct.file*, i64, i64, i64, i64)* @get_unmapped_area_zero, i32 (i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.pipe_inode_info*, %struct.file*, i64*, i64, i32)* null, i64 (%struct.file*, i64*, %struct.pipe_inode_info*, i64, i32)* null, i32 (%struct.file*, i64, %struct.file_lock**, i8**)* null, i64 (%struct.file*, i32, i64, i64)* null, void (%struct.seq_file*, %struct.file*)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i32 (%struct.file*, i64, i64, i32)* null }, align 8
@.str.4 = private unnamed_addr constant [5 x i8] c"full\00", align 1
@full_fops = internal constant %struct.file_operations { %struct.module* null, i64 (%struct.file*, i64, i32)* @null_lseek, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.file*, i8*, i64, i64*)* @write_full, i64 (%struct.kiocb*, %struct.iov_iter*)* @read_iter_zero, i64 (%struct.kiocb*, %struct.iov_iter*)* null, i32 (%struct.kiocb*, i1)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.dir_context*)* null, i32 (%struct.file*, %struct.poll_table_struct*)* null, i64 (%struct.file*, i32, i64)* null, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* null, i64 0, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i8*)* null, i32 (%struct.inode*, %struct.file*)* null, i32 (%struct.file*, i64, i64, i32)* null, i32 (i32, %struct.file*, i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.file*, %struct.page*, i32, i64, i64*, i32)* null, i64 (%struct.file*, i64, i64, i64, i64)* null, i32 (i32)* null, i32 (%struct.file*, i32, %struct.file_lock*)* null, i64 (%struct.pipe_inode_info*, %struct.file*, i64*, i64, i32)* null, i64 (%struct.file*, i64*, %struct.pipe_inode_info*, i64, i32)* null, i32 (%struct.file*, i64, %struct.file_lock**, i8**)* null, i64 (%struct.file*, i32, i64, i64)* null, void (%struct.seq_file*, %struct.file*)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i64 (%struct.file*, i64, %struct.file*, i64, i64, i32)* null, i32 (%struct.file*, i64, i64, i32)* null }, align 8
...
@.str.6 = private unnamed_addr constant [8 x i8] c"urandom\00", align 1
@urandom_fops = external dso_local constant %struct.file_operations, align 8
@.str.7 = private unnamed_addr constant [5 x i8] c"kmsg\00", align 1
@kmsg_fops = external dso_local constant %struct.file_operations, align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_chr_dev_init442 to i8*)], section "llvm.metadata"

; Function Attrs: noinline nounwind null_pointer_is_valid
define weak dso_local i32 @phys_mem_access_prot_allowed(%struct.file* noundef %file, i64 noundef %pfn, i64 noundef %size, %struct.pgprot_t* noundef %vma_prot) local_unnamed_addr #0 {
entry:
  ret i32 1
}
...
do.end:                                           ; preds = %entry
  %call1 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 noundef 1) #10
  br label %if.end

if.end:                                           ; preds = %do.end, %entry
  %call3 = call %struct.class* @__class_create(%struct.module* noundef null, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), %struct.lock_class_key* noundef nonnull @chr_dev_init.__key) #11
  store %struct.class* %call3, %struct.class** @mem_class, align 8
  %0 = bitcast %struct.class* %call3 to i8*
  %call4 = call fastcc i1 @IS_ERR(i8* noundef %0) #9
  br i1 %call4, label %if.then5, label %if.end7

if.then5:                                         ; preds = %if.end
  %call6 = call fastcc i64 @PTR_ERR(i8* noundef %0) #9
  %conv = trunc i64 %call6 to i32
  br label %cleanup

if.end7:                                          ; preds = %if.end
  %devnode = getelementptr inbounds %struct.class, %struct.class* %call3, i64 0, i32 6
  store i8* (%struct.device*, i16*)* @mem_devnode, i8* (%struct.device*, i16*)** %devnode, align 8
  br label %for.body

for.body:                                         ; preds = %if.end7, %for.inc
  %indvars.iv = phi i64 [ 1, %if.end7 ], [ %indvars.iv.next, %for.inc ]
  %1 = lshr i64 1111, %indvars.iv
  %2 = and i64 %1, 1
  %tobool10.not.not = icmp eq i64 %2, 0
  br i1 %tobool10.not.not, label %if.end12, label %for.inc

if.end12:                                         ; preds = %for.body
  %name = getelementptr [12 x %struct.memdev], [12 x %struct.memdev]* @devlist, i64 0, i64 %indvars.iv, i32 0
  %3 = load i8*, i8** %name, align 8
  %4 = load %struct.class*, %struct.class** @mem_class, align 8
  %5 = trunc i64 %indvars.iv to i32
  %or = or i32 %5, 1048576
  %call20 = call %struct.device* (%struct.class*, %struct.device*, i32, i8*, i8*, ...) @device_create(%struct.class* noundef %4, %struct.device* noundef null, i32 noundef %or, i8* noundef null, i8* noundef %3) #11
  br label %for.inc
...
for.end:                                          ; preds = %for.inc
  %call21 = call i32 @tty_init() #10
  br label %cleanup

cleanup:                                          ; preds = %for.end, %if.then5
  %retval.0 = phi i32 [ %conv, %if.then5 ], [ %call21, %for.end ]
  ret i32 %retval.0
}
...
entry:
  %call = call i32 @__register_chrdev(i32 noundef 1, i32 noundef 0, i32 noundef 256, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), %struct.file_operations* noundef nonnull @memory_fops) #11
  ret i32 %call
}
...
define internal noalias i8* @mem_devnode(%struct.device* nocapture noundef readonly %dev, i16* noundef writeonly %mode) #5 {
entry:
...
land.lhs.true:                                    ; preds = %entry
  ...
  %1 = lshr i64 1111, %idxprom
  %2 = and i64 %1, 1
  %tobool2.not.not = icmp eq i64 %2, 0
  br i1 %tobool2.not.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %mode1 = getelementptr [12 x %struct.memdev], [12 x %struct.memdev]* @devlist, i64 0, i64 %idxprom, i32 1
  %3 = load i16, i16* %mode1, align 8
  store i16 %3, i16* %mode, align 2
  br label %if.end
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__register_chrdev(i32 noundef, i32 noundef, i32 noundef, i8* noundef, %struct.file_operations* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @noop_llseek(%struct.file* noundef, i64 noundef, i32 noundef) #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @memory_open(%struct.inode* noundef %inode, %struct.file* noundef %filp) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  br i1 %tobool.not.not, label %if.end3, label %cleanup

if.end3:                                          ; preds = %if.end
  %fops = getelementptr [12 x %struct.memdev], [12 x %struct.memdev]* @devlist, i64 0, i64 %0, i32 2
  %3 = load %struct.file_operations*, %struct.file_operations** %fops, align 8
  %f_op = getelementptr inbounds %struct.file, %struct.file* %filp, i64 0, i32 3
  store %struct.file_operations* %3, %struct.file_operations** %f_op, align 8
  %fmode = getelementptr [12 x %struct.memdev], [12 x %struct.memdev]* @devlist, i64 0, i64 %0, i32 3
  %4 = load i32, i32* %fmode, align 8
  ...
  %open = getelementptr inbounds %struct.file_operations, %struct.file_operations* %3, i64 0, i32 14
  %6 = load i32 (%struct.inode*, %struct.file*)*, i32 (%struct.inode*, %struct.file*)** %open, align 8
  %tobool6.not = icmp eq i32 (%struct.inode*, %struct.file*)* %6, null
  br i1 %tobool6.not, label %cleanup, label %if.then7

if.then7:                                         ; preds = %if.end3
  %call10 = call i32 %6(%struct.inode* noundef %inode, %struct.file* noundef %filp) #11
  br label %cleanup

cleanup:                                          ; preds = %if.end3, %if.end, %entry, %if.then7
  %retval.0 = phi i32 [ %call10, %if.then7 ], [ -6, %entry ], [ -6, %if.end ], [ 0, %if.end3 ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i32 @iminor(%struct.inode* nocapture noundef readonly %inode) unnamed_addr #6 {
entry:
...
define internal i64 @null_lseek(%struct.file* nocapture noundef writeonly %file, i64 noundef %offset, i32 noundef %orig) #7 {
entry:
  %f_pos = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 10
  store i64 0, i64* %f_pos, align 8
  ret i64 0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @read_null(%struct.file* nocapture noundef readnone %file, i8* nocapture noundef readnone %buf, i64 noundef %count, i64* nocapture noundef readnone %ppos) #4 {
entry:
  ret i64 0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @write_null(%struct.file* nocapture noundef readnone %file, i8* nocapture noundef readnone %buf, i64 noundef returned %count, i64* nocapture noundef readnone %ppos) #4 {
entry:
  ret i64 %count
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @read_iter_null(%struct.kiocb* nocapture noundef readnone %iocb, %struct.iov_iter* nocapture noundef readnone %to) #4 {
entry:
  ret i64 0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @write_iter_null(%struct.kiocb* nocapture noundef readnone %iocb, %struct.iov_iter* noundef %from) #0 {
entry:
  %call = call fastcc i64 @iov_iter_count(%struct.iov_iter* noundef %from) #9
  call void @iov_iter_advance(%struct.iov_iter* noundef %from, i64 noundef %call) #11
  ret i64 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @splice_write_null(%struct.pipe_inode_info* noundef %pipe, %struct.file* noundef %out, i64* noundef %ppos, i64 noundef %len, i32 noundef %flags) #0 {
entry:
  %call = call i64 @splice_from_pipe(%struct.pipe_inode_info* noundef %pipe, %struct.file* noundef %out, i64* noundef %ppos, i64 noundef %len, i32 noundef %flags, i32 (%struct.pipe_inode_info*, %struct.pipe_buffer*, %struct.splice_desc*)* noundef nonnull @pipe_to_null) #11
  ret i64 %call
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @iov_iter_advance(%struct.iov_iter* noundef, i64 noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @splice_from_pipe(%struct.pipe_inode_info* noundef, %struct.file* noundef, i64* noundef, i64 noundef, i32 noundef, i32 (%struct.pipe_inode_info*, %struct.pipe_buffer*, %struct.splice_desc*)* noundef) local_unnamed_addr #3

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal i32 @pipe_to_null(%struct.pipe_inode_info* nocapture noundef readnone %info, %struct.pipe_buffer* nocapture noundef readnone %buf, %struct.splice_desc* nocapture noundef readonly %sd) #6 {
entry:
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @read_zero(%struct.file* nocapture noundef readnone %file, i8* noundef %buf, i64 noundef %count, i64* nocapture noundef readnone %ppos) #0 {
entry:
  %tobool.not46 = icmp eq i64 %count, 0
  br i1 %tobool.not46, label %cleanup17, label %while.body

while.body:                                       ; preds = %entry, %cleanup
  %count.addr.048 = phi i64 [ %sub8, %cleanup ], [ %count, %entry ]
  %cleared.047 = phi i64 [ %add7, %cleanup ], [ 0, %entry ]
  %cmp = icmp ult i64 %count.addr.048, 4096
  %cond = select i1 %cmp, i64 %count.addr.048, i64 4096
  %add.ptr = getelementptr i8, i8* %buf, i64 %cleared.047
  %call = call fastcc i64 @__clear_user(i8* noundef %add.ptr, i64 noundef %cond) #9
  %tobool1.not = icmp eq i64 %call, 0
  br i1 %tobool1.not, label %if.end6, label %if.then, !prof !7

if.then:                                          ; preds = %while.body
  %sub = sub i64 %cond, %call
  %add = add i64 %sub, %cleared.047
  %tobool4.not = icmp eq i64 %add, 0
  br i1 %tobool4.not, label %cleanup17, label %cleanup.thread

if.end6:                                          ; preds = %while.body
  %add7 = add i64 %cond, %cleared.047
  %0 = call i64 asm "mrs $0, sp_el0", "=r"() #12, !srcloc !8
  %1 = inttoptr i64 %0 to %struct.task_struct*
  %call10 = call fastcc i32 @signal_pending(%struct.task_struct* noundef %1) #9
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %cleanup, label %cleanup.thread

cleanup.thread:                                   ; preds = %if.end6, %if.then
  %cleared.1.ph = phi i64 [ %add, %if.then ], [ %add7, %if.end6 ]
  br label %cleanup17

cleanup:                                          ; preds = %if.end6
  %sub8 = sub i64 %count.addr.048, %cond
  call fastcc void @_cond_resched() #9
  %tobool.not = icmp eq i64 %sub8, 0
  br i1 %tobool.not, label %cleanup17, label %while.body

cleanup17:                                        ; preds = %cleanup, %entry, %if.then, %cleanup.thread
  %retval.2 = phi i64 [ %cleared.1.ph, %cleanup.thread ], [ -14, %if.then ], [ 0, %entry ], [ %add7, %cleanup ]
  ret i64 %retval.2
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @read_iter_zero(%struct.kiocb* nocapture noundef readnone %iocb, %struct.iov_iter* noundef %iter) #0 {
entry:
  %call41 = call fastcc i64 @iov_iter_count(%struct.iov_iter* noundef %iter) #9
  %tobool.not42 = icmp eq i64 %call41, 0
  br i1 %tobool.not42, label %cleanup21, label %while.body

while.body:                                       ; preds = %entry, %cleanup
  %call45 = phi i64 [ %call, %cleanup ], [ %call41, %entry ]
  %written.043 = phi i64 [ %add, %cleanup ], [ 0, %entry ]
  %0 = icmp ult i64 %call45, 4096
  %spec.store.select = select i1 %0, i64 %call45, i64 4096
  %call2 = call i64 @iov_iter_zero(i64 noundef %spec.store.select, %struct.iov_iter* noundef %iter) #11
  %tobool3.not = icmp eq i64 %call2, 0
  br i1 %tobool3.not, label %land.lhs.true, label %if.end8

land.lhs.true:                                    ; preds = %while.body
  %call4 = call fastcc i64 @iov_iter_count(%struct.iov_iter* noundef %iter) #9
  %tobool5.not = icmp eq i64 %call4, 0
  br i1 %tobool5.not, label %if.end8, label %if.then6

if.then6:                                         ; preds = %land.lhs.true
  %tobool7.not = icmp eq i64 %written.043, 0
  %cond = select i1 %tobool7.not, i64 -14, i64 %written.043
  br label %cleanup21

if.end8:                                          ; preds = %land.lhs.true, %while.body
  %add = add i64 %call2, %written.043
  %1 = call i64 asm "mrs $0, sp_el0", "=r"() #12, !srcloc !8
  %2 = inttoptr i64 %1 to %struct.task_struct*
  %call10 = call fastcc i32 @signal_pending(%struct.task_struct* noundef %2) #9
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %cleanup, label %if.then12

if.then12:                                        ; preds = %if.end8
  %tobool13.not = icmp eq i64 %add, 0
  %cond17 = select i1 %tobool13.not, i64 -512, i64 %add
  br label %cleanup21

cleanup:                                          ; preds = %if.end8
  call fastcc void @_cond_resched() #9
  %call = call fastcc i64 @iov_iter_count(%struct.iov_iter* noundef %iter) #9
  %tobool.not = icmp eq i64 %call, 0
  br i1 %tobool.not, label %cleanup21, label %while.body

cleanup21:                                        ; preds = %cleanup, %entry, %if.then6, %if.then12
  %retval.2 = phi i64 [ %cond, %if.then6 ], [ %cond17, %if.then12 ], [ 0, %entry ], [ %add, %cleanup ]
  ret i64 %retval.2
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @mmap_zero(%struct.file* nocapture noundef readnone %file, %struct.vm_area_struct* noundef %vma) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %call = call i32 @shmem_zero_setup(%struct.vm_area_struct* noundef %vma) #11
  br label %return

if.end:                                           ; preds = %entry
  call fastcc void @vma_set_anonymous(%struct.vm_area_struct* noundef %vma) #9
  br label %return
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @get_unmapped_area_zero(%struct.file* noundef %file, i64 noundef %addr, i64 noundef %len, i64 noundef %pgoff, i64 noundef %flags) #0 {
entry:
  %and = and i64 %flags, 1
  %tobool.not = icmp eq i64 %and, 0
  br i1 %tobool.not, label %if.end, label %if.then
...
if.then:                                          ; preds = %entry
  %call = call i64 @shmem_get_unmapped_area(%struct.file* noundef null, i64 noundef %addr, i64 noundef %len, i64 noundef %pgoff, i64 noundef %flags) #11
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  %get_unmapped_area = getelementptr inbounds %struct.mm_struct, %struct.mm_struct* %2, i64 0, i32 0, i32 3
  %3 = load i64 (%struct.file*, i64, i64, i64, i64)*, i64 (%struct.file*, i64, i64, i64, i64)** %get_unmapped_area, align 8
  %call2 = call i64 %3(%struct.file* noundef %file, i64 noundef %addr, i64 noundef %len, i64 noundef %pgoff, i64 noundef %flags) #11
  br label %return
...
entry:
  %call = call fastcc i64 @__range_ok(i8* noundef %to, i64 noundef %n) #9
  %tobool.not = icmp eq i64 %call, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call2 = call fastcc i8* @__uaccess_mask_ptr(i8* noundef %to) #9
  %call3 = call i64 @__arch_clear_user(i8* noundef %call2, i64 noundef %n) #11
  br label %if.end
...
entry:
  %0 = call { i64, i64 } asm sideeffect "\09adds\09$0, $3, $2\0A\09csel\09$1, xzr, $1, hi\0A\09csinv\09$0, $0, xzr, cc\0A\09sbcs\09xzr, $0, $1\0A\09cset\09$0, ls\0A", "=&r,=r,Ir,0,1,~{cc}"(i64 %size, i8* %addr, i64 549755813887) #13, !srcloc !9
  %asmresult = extractvalue { i64, i64 } %0, 0
  ret i64 %asmresult
}

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @__arch_clear_user(i8* noundef, i64 noundef) local_unnamed_addr #3
...
entry:
  ...
  %2 = call i8* asm sideeffect "\09bics\09xzr, $3, $2\0A\09csel\09$0, $1, xzr, eq\0A", "=&r,r,r,r,~{cc}"(i8* %ptr, i64 549755813887, i8* %1) #13, !srcloc !10
  call void asm sideeffect "hint #20", "~{memory}"() #13, !srcloc !11
  ret i8* %2
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i64 @iov_iter_zero(i64 noundef, %struct.iov_iter* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @shmem_zero_setup(%struct.vm_area_struct* noundef) local_unnamed_addr #3
...
; Function Attrs: null_pointer_is_valid
declare dso_local i64 @shmem_get_unmapped_area(%struct.file* noundef, i64 noundef, i64 noundef, i64 noundef, i64 noundef) local_unnamed_addr #3

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @write_full(%struct.file* nocapture noundef readnone %file, i8* nocapture noundef readnone %buf, i64 noundef %count, i64* nocapture noundef readnone %ppos) #4 {
entry:
  ret i64 -28
}
...
!8 = !{i64 1365746}
!9 = !{i64 4597212, i64 4597295, i64 4597519, i64 4597739, i64 4597762}
!10 = !{i64 4601914, i64 4601938}
!11 = !{i64 2152116753}
