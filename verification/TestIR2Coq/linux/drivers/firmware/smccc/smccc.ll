; ModuleID = 'drivers/firmware/smccc/smccc.c'
source_filename = "drivers/firmware/smccc/smccc.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall6.init\22, \22a\22\09\09"
module asm "__initcall__kmod_smccc__167_61_smccc_devices_init6:\09\09\09"
module asm ".long\09smccc_devices_init - .\09"
...
@__UNIQUE_ID___addressable_smccc_devices_init168 = internal global i8* bitcast (i32 ()* @smccc_devices_init to i8*), section ".discard.addressable", align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_smccc_devices_init168 to i8*)], section "llvm.metadata"
...
define dso_local void @arm_smccc_version_init(i32 noundef %version, i32 noundef %conduit) local_unnamed_addr #0 section ".init.text" {
entry:
  store i32 %version, i32* @smccc_version, align 4
  store i32 %conduit, i32* @smccc_conduit, align 4
  store i8 0, i8* @smccc_trng_available, align 1
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define dso_local i32 @arm_smccc_1_1_get_conduit() local_unnamed_addr #1 {
entry:
  %0 = load i32, i32* @smccc_version, align 4
  %cmp = icmp ult i32 %0, 65537
  %1 = load i32, i32* @smccc_conduit, align 4
  %retval.0 = select i1 %cmp, i32 0, i32 %1
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define dso_local i32 @arm_smccc_get_version() local_unnamed_addr #1 {
entry:
  %0 = load i32, i32* @smccc_version, align 4
  ret i32 %0
}
...
entry:
  %0 = load i8, i8* @smccc_trng_available, align 1, !range !7
  %tobool.not = icmp eq i8 %0, 0
  br i1 %tobool.not, label %if.end5, label %if.then

if.then:                                          ; preds = %entry
  %call = call fastcc %struct.platform_device* @platform_device_register_simple() #9
  %1 = bitcast %struct.platform_device* %call to i8*
  %call1 = call fastcc i1 @IS_ERR(i8* noundef %1) #9
  br i1 %call1, label %do.end, label %if.end5

do.end:                                           ; preds = %if.then
  %call3 = call fastcc i64 @PTR_ERR(i8* noundef %1) #9
  %call4 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i64 0, i64 0), i64 noundef %call3) #10
  br label %if.end5
...
define internal fastcc %struct.platform_device* @platform_device_register_simple() unnamed_addr #4 {
entry:
  %call = call fastcc %struct.platform_device* @platform_device_register_resndata() #9
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc %struct.platform_device* @platform_device_register_resndata() unnamed_addr #4 {
entry:
  %pdevinfo = alloca %struct.platform_device_info, align 8
  %0 = bitcast %struct.platform_device_info* %pdevinfo to i8*
  call void @llvm.lifetime.start.p0i8(i64 88, i8* nonnull %0) #11
  %name2 = getelementptr inbounds %struct.platform_device_info, %struct.platform_device_info* %pdevinfo, i64 0, i32 3
  %1 = bitcast %struct.platform_device_info* %pdevinfo to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(56) %1, i8 0, i64 56, i1 false)
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i8** %name2, align 8
  %id3 = getelementptr inbounds %struct.platform_device_info, %struct.platform_device_info* %pdevinfo, i64 0, i32 4
  store i32 -1, i32* %id3, align 8
  %num_res = getelementptr inbounds %struct.platform_device_info, %struct.platform_device_info* %pdevinfo, i64 0, i32 6
  store i32 0, i32* %num_res, align 8
  %data5 = getelementptr inbounds %struct.platform_device_info, %struct.platform_device_info* %pdevinfo, i64 0, i32 7
  ...
  store i64 0, i64* %size_data, align 8
  ...
  store %struct.property_entry* null, %struct.property_entry** %properties, align 8
  %call = call %struct.platform_device* @platform_device_register_full(%struct.platform_device_info* noundef nonnull %pdevinfo) #12
  call void @llvm.lifetime.end.p0i8(i64 88, i8* nonnull %0) #11
  ret %struct.platform_device* %call
}
...
declare dso_local %struct.platform_device* @platform_device_register_full(%struct.platform_device_info* noundef) local_unnamed_addr #8
