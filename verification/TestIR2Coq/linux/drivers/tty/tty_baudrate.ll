; ModuleID = 'drivers/tty/tty_baudrate.c'
...
define dso_local i32 @tty_termios_baud_rate(%struct.ktermios* nocapture noundef %termios) local_unnamed_addr #0 {
entry:
  %c_cflag = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 2
...
if.then:                                          ; preds = %entry
  %c_ospeed = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 7
...
if.then6:                                         ; preds = %if.then2
  %and8 = and i32 %0, -4097
  store i32 %and8, i32* %c_cflag, align 4
  br label %cond.false
...
if.end11:                                         ; preds = %if.end
  ...
  br i1 %cmp12, label %cleanup, label %cond.false

cond.false:                                       ; preds = %if.else, %if.then6, %if.end11
  %cbaud.025 = phi i32 [ %and, %if.end11 ], [ %add, %if.else ], [ 0, %if.then6 ]
  %idxprom = zext i32 %cbaud.025 to i64
  %arrayidx = getelementptr [31 x i32], [31 x i32]* @baud_table, i64 0, i64 %idxprom
  br label %cleanup.sink.split

cleanup.sink.split:                               ; preds = %if.then, %cond.false
  %arrayidx.sink = phi i32* [ %arrayidx, %cond.false ], [ %c_ospeed, %if.then ]
  %1 = load i32, i32* %arrayidx.sink, align 4
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %if.end11
  %retval.0 = phi i32 [ 0, %if.end11 ], [ %1, %cleanup.sink.split ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define dso_local i32 @tty_termios_input_baud_rate(%struct.ktermios* nocapture noundef %termios) local_unnamed_addr #0 {
entry:
  %c_cflag = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 2
  %0 = load i32, i32* %c_cflag, align 4
  %shr = lshr i32 %0, 16
...
if.then:                                          ; preds = %entry
  %call = call i32 @tty_termios_baud_rate(%struct.ktermios* noundef %termios) #2
  br label %cleanup

if.then2:                                         ; preds = %entry
  %c_ispeed = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 6
  %1 = load i32, i32* %c_ispeed, align 4
  br label %cleanup
...
if.then9:                                         ; preds = %if.then5
  %and11 = and i32 %0, -268435457
  store i32 %and11, i32* %c_cflag, align 4
  br label %cond.false
...
cond.false:                                       ; preds = %if.else, %if.then9, %if.end14
  %cbaud.030 = phi i32 [ %and, %if.end14 ], [ %add, %if.else ], [ 0, %if.then9 ]
  %idxprom = zext i32 %cbaud.030 to i64
  %arrayidx = getelementptr [31 x i32], [31 x i32]* @baud_table, i64 0, i64 %idxprom
  %3 = load i32, i32* %arrayidx, align 4
  br label %cleanup

cleanup:                                          ; preds = %cond.false, %if.end14, %if.then2, %if.then
  %retval.0 = phi i32 [ %call, %if.then ], [ %1, %if.then2 ], [ %3, %cond.false ], [ 0, %if.end14 ]
  ret i32 %retval.0
}

; Function Attrs: nofree noinline norecurse nosync nounwind null_pointer_is_valid
define dso_local void @tty_termios_encode_baud_rate(%struct.ktermios* nocapture noundef %termios, i32 noundef %ibaud, i32 noundef %obaud) local_unnamed_addr #1 {
entry:
  ...
  %c_ispeed = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 6
  store i32 %spec.select, i32* %c_ispeed, align 4
  %c_ospeed = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 7
  store i32 %obaud, i32* %c_ospeed, align 4
  %c_cflag = getelementptr inbounds %struct.ktermios, %struct.ktermios* %termios, i64 0, i32 2
  %0 = load i32, i32* %c_cflag, align 4
  %1 = and i32 %0, 269418496
  %tobool.not = icmp ne i32 %1, 0
  %and5 = and i32 %0, 4111
  %cmp6 = icmp eq i32 %and5, 4096
  %2 = and i32 %0, 269422607
  %3 = icmp eq i32 %2, 4096
  %oclose.0 = select i1 %cmp6, i32 0, i32 %div1
  %cmp15 = icmp eq i32 %1, 268435456
  %4 = or i1 %cmp15, %3
  %spec.select108 = select i1 %4, i32 0, i32 %div
  %and21 = and i32 %0, -269422608
  store i32 %and21, i32* %c_cflag, align 4
  %sub = sub i32 %obaud, %oclose.0
  %add = add i32 %oclose.0, %obaud
  %sub31 = sub i32 %spec.select, %spec.select108
  %add36 = add i32 %spec.select108, %spec.select
  br label %do.body

do.body:                                          ; preds = %do.cond, %entry
  %5 = phi i32 [ %13, %do.cond ], [ %and21, %entry ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %do.cond ], [ 0, %entry ]
  %ifound.0 = phi i32 [ %ifound.1, %do.cond ], [ -1, %entry ]
  %ofound.0 = phi i32 [ %ofound.1, %do.cond ], [ -1, %entry ]
  %arrayidx = getelementptr [31 x i32], [31 x i32]* @baud_table, i64 0, i64 %indvars.iv
  %6 = load i32, i32* %arrayidx, align 4
  %cmp22.not = icmp ugt i32 %sub, %6
  %cmp25.not = icmp ult i32 %add, %6
  %or.cond109 = or i1 %cmp22.not, %cmp25.not
  br i1 %or.cond109, label %if.end30, label %if.then26

if.then26:                                        ; preds = %do.body
  %arrayidx28 = getelementptr [31 x i32], [31 x i32]* @baud_bits, i64 0, i64 %indvars.iv
...
if.end30:                                         ; preds = %if.then26, %do.body
  %9 = phi i32 [ %or, %if.then26 ], [ %5, %do.body ]
  %ofound.1 = phi i32 [ %8, %if.then26 ], [ %ofound.0, %do.body ]
  %cmp34.not = icmp ugt i32 %sub31, %6
  %cmp39.not = icmp ult i32 %add36, %6
  %or.cond110 = or i1 %cmp34.not, %cmp39.not
  br i1 %or.cond110, label %do.cond, label %if.then40

if.then40:                                        ; preds = %if.end30
  %10 = zext i32 %ofound.1 to i64
  %cmp41 = icmp ne i64 %indvars.iv, %10
  %or.cond = select i1 %cmp41, i1 true, i1 %tobool.not
  %11 = trunc i64 %indvars.iv to i32
  br i1 %or.cond, label %if.else, label %do.cond

if.else:                                          ; preds = %if.then40
  %arrayidx46 = getelementptr [31 x i32], [31 x i32]* @baud_bits, i64 0, i64 %indvars.iv
  %12 = load i32, i32* %arrayidx46, align 4
  %shl = shl i32 %12, 16
  %or48 = or i32 %9, %shl
  store i32 %or48, i32* %c_cflag, align 4
  br label %do.cond

do.cond:                                          ; preds = %if.then40, %if.end30, %if.else
  %13 = phi i32 [ %or48, %if.else ], [ %9, %if.end30 ], [ %9, %if.then40 ]
  %ifound.1 = phi i32 [ %11, %if.else ], [ %ifound.0, %if.end30 ], [ %11, %if.then40 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31
  br i1 %exitcond.not, label %do.end, label %do.body

do.end:                                           ; preds = %do.cond
  %cmp52 = icmp eq i32 %ofound.1, -1
  br i1 %cmp52, label %if.then53, label %if.end56

if.then53:                                        ; preds = %do.end
  %or55 = or i32 %13, 4096
  store i32 %or55, i32* %c_cflag, align 4
  br label %if.end56

if.end56:                                         ; preds = %if.then53, %do.end
  %14 = phi i32 [ %or55, %if.then53 ], [ %13, %do.end ]
  %cmp57 = icmp eq i32 %ifound.1, -1
  br i1 %cmp57, label %land.lhs.true58, label %if.end64

land.lhs.true58:                                  ; preds = %if.end56
  %cmp59 = icmp ne i32 %spec.select, %obaud
  %or.cond65 = select i1 %cmp59, i1 true, i1 %tobool.not
  br i1 %or.cond65, label %if.then61, label %if.end64

if.then61:                                        ; preds = %land.lhs.true58
  %or63 = or i32 %14, 268435456
  store i32 %or63, i32* %c_cflag, align 4
  br label %if.end64

if.end64:                                         ; preds = %land.lhs.true58, %if.then61, %if.end56
  ret void
}

; Function Attrs: nofree noinline norecurse nosync nounwind null_pointer_is_valid
define dso_local void @tty_encode_baud_rate(%struct.tty_struct* nocapture noundef %tty, i32 noundef %ibaud, i32 noundef %obaud) local_unnamed_addr #1 {
entry:
  %termios = getelementptr inbounds %struct.tty_struct, %struct.tty_struct* %tty, i64 0, i32 13
  call void @tty_termios_encode_baud_rate(%struct.ktermios* noundef %termios, i32 noundef %ibaud, i32 noundef %obaud) #2
  ret void
}
