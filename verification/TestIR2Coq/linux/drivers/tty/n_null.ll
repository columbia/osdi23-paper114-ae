; ModuleID = 'drivers/tty/n_null.c'
source_filename = "drivers/tty/n_null.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall6.init\22, \22a\22\09\09"
module asm "__initcall__kmod_n_null__214_63_n_null_init6:\09\09\09"
...
@null_ldisc = internal global %struct.tty_ldisc_ops { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32 27, i32 0, i32 (%struct.tty_struct*)* @n_null_open, void (%struct.tty_struct*)* @n_null_close, void (%struct.tty_struct*)* null, i64 (%struct.tty_struct*, %struct.file*, i8*, i64, i8**, i64)* @n_null_read, i64 (%struct.tty_struct*, %struct.file*, i8*, i64)* @n_null_write, i32 (%struct.tty_struct*, %struct.file*, i32, i64)* null, i32 (%struct.tty_struct*, %struct.file*, i32, i64)* null, void (%struct.tty_struct*, %struct.ktermios*)* null, i32 (%struct.tty_struct*, %struct.file*, %struct.poll_table_struct*)* null, i32 (%struct.tty_struct*)* null, void (%struct.tty_struct*, i8*, i8*, i32)* @n_null_receivebuf, void (%struct.tty_struct*)* null, void (%struct.tty_struct*, i32)* null, i32 (%struct.tty_struct*, i8*, i8*, i32)* null, %struct.module* null }, align 8
@__UNIQUE_ID___addressable_n_null_init215 = internal global i8* bitcast (i32 ()* @n_null_init to i8*), section ".discard.addressable", align 8
@__exitcall_n_null_exit = internal global void ()* @n_null_exit, section ".exitcall.exit", align 8
@__UNIQUE_ID_file216 = internal constant [31 x i8] c"n_null.file=drivers/tty/n_null\00", section ".modinfo", align 1
@__UNIQUE_ID_license217 = internal constant [19 x i8] c"n_null.license=GPL\00", section ".modinfo", align 1
@__UNIQUE_ID_author218 = internal constant [23 x i8] c"n_null.author=Alan Cox\00", section ".modinfo", align 1
@__UNIQUE_ID_alias219 = internal constant [26 x i8] c"n_null.alias=tty-ldisc-27\00", section ".modinfo", align 1
@__UNIQUE_ID_description220 = internal constant [37 x i8] c"n_null.description=Null ldisc driver\00", section ".modinfo", align 1
@.str = private unnamed_addr constant [7 x i8] c"n_null\00", align 1
@llvm.compiler.used = appending global [8 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_n_null_init215 to i8*), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__UNIQUE_ID_alias219, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_author218, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__UNIQUE_ID_description220, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__UNIQUE_ID_file216, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__UNIQUE_ID_license217, i32 0, i32 0), i8* bitcast (void ()** @__exitcall_n_null_exit to i8*), i8* bitcast (void ()* @n_null_exit to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal void @n_null_exit() #0 section ".exit.text" {
entry:
  call void @tty_unregister_ldisc(%struct.tty_ldisc_ops* noundef nonnull @null_ldisc) #3
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @tty_unregister_ldisc(%struct.tty_ldisc_ops* noundef) local_unnamed_addr #1

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @n_null_init() #0 section ".init.text" {
entry:
  %call = call i32 @tty_register_ldisc(%struct.tty_ldisc_ops* noundef nonnull @null_ldisc) #3
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %do.end6, label %do.body3, !prof !7

do.body3:                                         ; preds = %entry
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22drivers/tty/n_null.c\22; .popsection; .long 14472b - 14470b; .short 54; .short 0; .popsection; 14471: brk 0x800", ""() #4, !srcloc !8
  unreachable
...
define internal i32 @n_null_open(%struct.tty_struct* nocapture noundef readnone %tty) #2 {
entry:
  ret i32 0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @n_null_close(%struct.tty_struct* nocapture noundef %tty) #2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @n_null_read(%struct.tty_struct* nocapture noundef readnone %tty, %struct.file* nocapture noundef readnone %file, i8* nocapture noundef readnone %buf, i64 noundef %nr, i8** nocapture noundef readnone %cookie, i64 noundef %offset) #2 {
entry:
  ret i64 -95
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal i64 @n_null_write(%struct.tty_struct* nocapture noundef readnone %tty, %struct.file* nocapture noundef readnone %file, i8* nocapture noundef readnone %buf, i64 noundef %nr) #2 {
entry:
  ret i64 -95
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @n_null_receivebuf(%struct.tty_struct* nocapture noundef %tty, i8* nocapture noundef %cp, i8* nocapture noundef %fp, i32 noundef %cnt) #2 {
entry:
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @tty_register_ldisc(%struct.tty_ldisc_ops* noundef) local_unnamed_addr #1
