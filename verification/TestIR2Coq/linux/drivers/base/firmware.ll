; ModuleID = 'drivers/base/firmware.c'
...
@firmware_kobj = dso_local local_unnamed_addr global %struct.kobject* null, align 8

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define dso_local i32 @firmware_init() local_unnamed_addr #0 section ".init.text" {
entry:
  %call = call %struct.kobject* @kobject_create_and_add(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), %struct.kobject* noundef null) #2
  store %struct.kobject* %call, %struct.kobject** @firmware_kobj, align 8
