; ModuleID = 'drivers/base/container.c'
...
@container_subsys = dso_local global %struct.bus_type { i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), %struct.device* null, %struct.attribute_group** null, %struct.attribute_group** null, %struct.attribute_group** null, i32 (%struct.device*, %struct.device_driver*)* null, i32 (%struct.device*, %struct.kobj_uevent_env*)* null, i32 (%struct.device*)* null, void (%struct.device*)* null, void (%struct.device*)* null, void (%struct.device*)* null, i32 (%struct.device*)* @trivial_online, i32 (%struct.device*)* @container_offline, i32 (%struct.device*, i64)* null, i32 (%struct.device*)* null, i32 (%struct.device*)* null, i32 (%struct.device*)* null, %struct.dev_pm_ops* null, %struct.iommu_ops* null, %struct.subsys_private* null, %struct.lock_class_key zeroinitializer, i8 0 }, align 8
...
define internal i32 @trivial_online(%struct.device* nocapture noundef readnone %dev) #0 {
entry:
  ret i32 0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @container_offline(%struct.device* noundef %dev) #1 {
entry:
  %call = call fastcc %struct.container_dev* @to_container_dev(%struct.device* noundef %dev) #5
  %offline = getelementptr inbounds %struct.container_dev, %struct.container_dev* %call, i64 0, i32 1
  %0 = load i32 (%struct.container_dev*)*, i32 (%struct.container_dev*)** %offline, align 8
  %tobool.not = icmp eq i32 (%struct.container_dev*)* %0, null
  br i1 %tobool.not, label %cond.end, label %cond.true

cond.true:                                        ; preds = %entry
  %call2 = call i32 %0(%struct.container_dev* noundef %call) #6
  br label %cond.end
...
define dso_local void @container_dev_init() local_unnamed_addr #2 section ".init.text" {
entry:
  %call = call i32 @subsys_system_register(%struct.bus_type* noundef nonnull @container_subsys, %struct.attribute_group** noundef null) #6
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.end, label %do.end

do.end:                                           ; preds = %entry
  %call1 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.container_dev_init, i64 0, i64 0), i32 noundef %call) #7
  br label %if.end
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal fastcc %struct.container_dev* @to_container_dev(%struct.device* noundef readnone %dev) unnamed_addr #0 {
entry:
  %0 = bitcast %struct.device* %dev to %struct.container_dev*
  ret %struct.container_dev* %0
}
