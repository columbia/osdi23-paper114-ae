...
@.str = private unnamed_addr constant [15 x i8] c"max-link-speed\00", align 1

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @of_pci_get_max_link_speed(%struct.device_node* noundef %node) local_unnamed_addr #0 {
entry:
  %max_link_speed = alloca i32, align 4
  %0 = bitcast i32* %max_link_speed to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #3
  store i32 0, i32* %max_link_speed, align 4, !annotation !7
  %call = call fastcc i32 @of_property_read_u32(%struct.device_node* noundef %node, i32* noundef nonnull %max_link_speed) #4
  %tobool = icmp ne i32 %call, 0
  %1 = load i32, i32* %max_link_speed, align 4
  %cmp = icmp eq i32 %1, 0
  %or.cond = select i1 %tobool, i1 true, i1 %cmp
  %cmp2 = icmp ugt i32 %1, 4
  %or.cond3 = select i1 %or.cond, i1 true, i1 %cmp2
  %. = select i1 %or.cond3, i32 -22, i32 %1
...
entry:
  %call = call fastcc i32 @of_property_read_u32_array(%struct.device_node* noundef %np, i32* noundef %out_value) #4
  ret i32 %call
}
...
entry:
  %call = call i32 @of_property_read_variable_u32_array(%struct.device_node* noundef %np, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32* noundef %out_values, i64 noundef 1, i64 noundef 0) #5
