; ModuleID = 'drivers/clk/clk-gpio.c'
source_filename = "drivers/clk/clk-gpio.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall6.init\22, \22a\22\09\09"
module asm "__initcall__kmod_clk_gpio__179_249_gpio_clk_driver_init6:\09\09\09"
module asm ".long\09gpio_clk_driver_init - .\09"
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_gpio_clk_driver_init180 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @gpio_clk_driver_init() #0 section ".init.text" {
entry:
  %call = call i32 @__platform_driver_register(%struct.platform_driver* noundef nonnull @gpio_clk_driver, %struct.module* noundef null) #4
  ret i32 %call
}
...
define internal i32 @gpio_clk_driver_probe(%struct.platform_device* noundef %pdev) #2 {
entry:
  ...
  %call = call i32 @of_device_is_compatible(%struct.device_node* noundef %0, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0)) #4
  %tobool = icmp ne i32 %call, 0
  %call2 = call i32 @of_clk_get_parent_count(%struct.device_node* noundef %0) #4
  %cmp = icmp ne i32 %call2, 2
  %or.cond = select i1 %tobool, i1 %cmp, i1 false
  br i1 %or.cond, label %do.end, label %if.end

do.end:                                           ; preds = %entry
  %dev1 = getelementptr inbounds %struct.platform_device, %struct.platform_device* %pdev, i64 0, i32 3
  call void (%struct.device*, i8*, ...) @_dev_err(%struct.device* noundef %dev1, i8* noundef getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i64 0, i64 0)) #5
  br label %cleanup

if.end:                                           ; preds = %entry
  %cond = select i1 %tobool, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)
  %call16 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5, i64 0, i64 0), %struct.device_node* noundef %0, i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @__func__.gpio_clk_driver_probe, i64 0, i64 0), i8* noundef %cond) #5
  br label %cleanup

cleanup:                                          ; preds = %if.end, %do.end
  %retval.0 = phi i32 [ -22, %do.end ], [ -38, %if.end ]
  ret i32 %retval.0
}
