; ModuleID = 'drivers/irqchip/irqchip.c'
...
@irqchip_of_match_end = internal constant %struct.of_device_id zeroinitializer, section "__irqchip_of_table_end", align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* getelementptr inbounds (%struct.of_device_id, %struct.of_device_id* @irqchip_of_match_end, i32 0, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define dso_local void @irqchip_init() local_unnamed_addr #0 section ".init.text" {
entry:
  call void @of_irq_init(%struct.of_device_id* noundef getelementptr inbounds ([0 x %struct.of_device_id], [0 x %struct.of_device_id]* @__irqchip_of_table, i64 0, i64 0)) #6
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @of_irq_init(%struct.of_device_id* noundef) local_unnamed_addr #1
...
define dso_local i32 @platform_irqchip_probe(%struct.platform_device* noundef %pdev) local_unnamed_addr #3 {
entry:
  ...
  %call = call %struct.device_node* @of_irq_find_parent(%struct.device_node* noundef %0) #6
  %call2 = call i8* @of_device_get_match_data(%struct.device* noundef %dev) #6
  %1 = bitcast i8* %call2 to i32 (%struct.device_node*, %struct.device_node*)*
  %tobool.not = icmp eq i8* %call2, null
  br i1 %tobool.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %cmp = icmp eq %struct.device_node* %call, %0
  %spec.store.select = select i1 %cmp, %struct.device_node* null, %struct.device_node* %call
  %tobool5.not = icmp eq %struct.device_node* %spec.store.select, null
  br i1 %tobool5.not, label %if.end9, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end
  %call6 = call fastcc %struct.irq_domain* @irq_find_matching_host(%struct.device_node* noundef nonnull %spec.store.select) #7
  %tobool7.not = icmp eq %struct.irq_domain* %call6, null
  br i1 %tobool7.not, label %cleanup, label %if.end9

if.end9:                                          ; preds = %land.lhs.true, %if.end
  %call10 = call i32 %1(%struct.device_node* noundef %0, %struct.device_node* noundef %spec.store.select) #6
  br label %cleanup

cleanup:                                          ; preds = %land.lhs.true, %entry, %if.end9
  %retval.0 = phi i32 [ %call10, %if.end9 ], [ -22, %entry ], [ -517, %land.lhs.true ]
  ret i32 %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.device_node* @of_irq_find_parent(%struct.device_node* noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i8* @of_device_get_match_data(%struct.device* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc %struct.irq_domain* @irq_find_matching_host(%struct.device_node* noundef %node) unnamed_addr #3 {
entry:
  %call = call fastcc %struct.fwnode_handle* @of_node_to_fwnode(%struct.device_node* noundef %node) #7
  %call1 = call fastcc %struct.irq_domain* @irq_find_matching_fwnode(%struct.fwnode_handle* noundef %call) #7
  ret %struct.irq_domain* %call1
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc %struct.irq_domain* @irq_find_matching_fwnode(%struct.fwnode_handle* noundef %fwnode) unnamed_addr #3 {
entry:
  ...
  %call = call %struct.irq_domain* @irq_find_matching_fwspec(%struct.irq_fwspec* noundef nonnull %fwspec, i32 noundef 0) #6
...
; Function Attrs: null_pointer_is_valid
declare dso_local %struct.irq_domain* @irq_find_matching_fwspec(%struct.irq_fwspec* noundef, i32 noundef) local_unnamed_addr #1
