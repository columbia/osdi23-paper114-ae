...
define dso_local i32 @generic_fadvise(%struct.file* noundef %file, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) local_unnamed_addr #0 {
entry:
  %nr_pagevec = alloca i64, align 8
  %call = call fastcc %struct.inode* @file_inode(%struct.file* noundef %file) #5
  %i_mode = getelementptr inbounds %struct.inode, %struct.inode* %call, i64 0, i32 0
  %0 = load i16, i16* %i_mode, align 8
  %1 = and i16 %0, -4096
  %cmp = icmp eq i16 %1, 4096
...
if.end:                                           ; preds = %entry
  ...
  %tobool = icmp eq %struct.address_space* %2, null
...
if.end5:                                          ; preds = %if.end
  ...
  %call6 = call fastcc %struct.backing_dev_info* @inode_to_bdi(%struct.inode* noundef %3) #5
  %cmp10 = icmp eq %struct.backing_dev_info* %call6, @noop_backing_dev_info
...
if.end13:                                         ; preds = %if.end5
  ...
  %or.cond137 = or i1 %tobool14.not, %cmp16
  %dec = add i64 %add, -1
  %endbyte.0 = select i1 %or.cond137, i64 -1, i64 %dec
  switch i32 %advice, label %cleanup [
    i32 0, label %sw.bb20
    i32 1, label %sw.bb25
    i32 2, label %sw.bb29
    i32 3, label %sw.bb38
    i32 5, label %sw.epilog76
    i32 4, label %sw.bb44
  ]

sw.bb20:                                          ; preds = %if.end13
  %ra_pages = getelementptr inbounds %struct.backing_dev_info, %struct.backing_dev_info* %call6, i64 0, i32 3
  %4 = load i64, i64* %ra_pages, align 8
  %conv21 = trunc i64 %4 to i32
  %ra_pages22 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 13, i32 3
  store i32 %conv21, i32* %ra_pages22, align 8
  %rlock.i = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 4, i32 0, i32 0
  call fastcc void @__raw_spin_lock(%struct.raw_spinlock* noundef %rlock.i) #6
  %f_mode = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 8
  %5 = load i32, i32* %f_mode, align 4
  %and23 = and i32 %5, -4097
  store i32 %and23, i32* %f_mode, align 4
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i) #6
  br label %sw.epilog76

sw.bb25:                                          ; preds = %if.end13
  %rlock.i139 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 4, i32 0, i32 0
  call fastcc void @__raw_spin_lock(%struct.raw_spinlock* noundef %rlock.i139) #6
  %f_mode27 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 8
  %6 = load i32, i32* %f_mode27, align 4
  %or = or i32 %6, 4096
  store i32 %or, i32* %f_mode27, align 4
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i139) #6
  br label %sw.epilog76

sw.bb29:                                          ; preds = %if.end13
  %ra_pages30 = getelementptr inbounds %struct.backing_dev_info, %struct.backing_dev_info* %call6, i64 0, i32 3
  %7 = load i64, i64* %ra_pages30, align 8
  %.tr = trunc i64 %7 to i32
  %conv31 = shl i32 %.tr, 1
  %ra_pages33 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 13, i32 3
  store i32 %conv31, i32* %ra_pages33, align 8
  %rlock.i141 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 4, i32 0, i32 0
  call fastcc void @__raw_spin_lock(%struct.raw_spinlock* noundef %rlock.i141) #6
  %f_mode35 = getelementptr inbounds %struct.file, %struct.file* %file, i64 0, i32 8
  %8 = load i32, i32* %f_mode35, align 4
  %and36 = and i32 %8, -4097
  store i32 %and36, i32* %f_mode35, align 4
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i141) #6
  br label %sw.epilog76

sw.bb38:                                          ; preds = %if.end13
  %shr = ashr i64 %offset, 12
  %shr39 = ashr i64 %endbyte.0, 12
  %sub = sub nsw i64 %shr39, %shr
  %add40 = add nsw i64 %sub, 1
  %tobool41.not = icmp eq i64 %add40, 0
  %spec.store.select = select i1 %tobool41.not, i64 -1, i64 %add40
  call fastcc void @force_page_cache_readahead(%struct.address_space* noundef nonnull %2, %struct.file* noundef %file, i64 noundef %shr, i64 noundef %spec.store.select) #5
  br label %sw.epilog76

sw.bb44:                                          ; preds = %if.end13
  %9 = load %struct.inode*, %struct.inode** %host, align 8
  %call46 = call fastcc i32 @inode_write_congested(%struct.inode* noundef %9) #5
  %tobool47.not = icmp eq i32 %call46, 0
  br i1 %tobool47.not, label %if.then48, label %if.end50

if.then48:                                        ; preds = %sw.bb44
  %call49 = call i32 @__filemap_fdatawrite_range(%struct.address_space* noundef nonnull %2, i64 noundef %offset, i64 noundef %endbyte.0, i32 noundef 0) #6
  br label %if.end50

if.end50:                                         ; preds = %if.then48, %sw.bb44
  %add51 = add i64 %offset, 4095
  %shr52 = lshr i64 %add51, 12
  %shr53 = ashr i64 %endbyte.0, 12
  %and54 = and i64 %endbyte.0, 4095
  %cmp55.not = icmp eq i64 %and54, 4095
  br i1 %cmp55.not, label %if.end66, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end50
  %i_size = getelementptr inbounds %struct.inode, %struct.inode* %call, i64 0, i32 11
  %10 = load i64, i64* %i_size, align 8
  %sub57 = add i64 %10, -1
  %cmp58.not = icmp eq i64 %endbyte.0, %sub57
  br i1 %cmp58.not, label %if.end66, label %if.then60

if.then60:                                        ; preds = %land.lhs.true
  %cmp61 = icmp ult i64 %endbyte.0, 4096
  br i1 %cmp61, label %sw.epilog76, label %if.end64

if.end64:                                         ; preds = %if.then60
  %dec65 = add nsw i64 %shr53, -1
  br label %if.end66

if.end66:                                         ; preds = %if.end64, %land.lhs.true, %if.end50
  %end_index.0 = phi i64 [ %dec65, %if.end64 ], [ %shr53, %land.lhs.true ], [ %shr53, %if.end50 ]
  %cmp67.not = icmp ult i64 %end_index.0, %shr52
  br i1 %cmp67.not, label %sw.epilog76, label %if.then69

if.then69:                                        ; preds = %if.end66
  %11 = bitcast i64* %nr_pagevec to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %11) #7
  store i64 0, i64* %nr_pagevec, align 8
  call void @lru_add_drain() #6
  call void @invalidate_mapping_pagevec(%struct.address_space* noundef nonnull %2, i64 noundef %shr52, i64 noundef %end_index.0, i64* noundef nonnull %nr_pagevec) #6
  %12 = load i64, i64* %nr_pagevec, align 8
  %tobool70.not = icmp eq i64 %12, 0
  br i1 %tobool70.not, label %if.end73, label %if.then71

if.then71:                                        ; preds = %if.then69
  call void @lru_add_drain_all() #6
  %call72 = call i64 @invalidate_mapping_pages(%struct.address_space* noundef nonnull %2, i64 noundef %shr52, i64 noundef %end_index.0) #6
  br label %if.end73
...
sw.epilog76:                                      ; preds = %if.end66, %if.end73, %if.then60, %if.end13, %sw.bb38, %sw.bb29, %sw.bb25, %sw.bb20
  br label %cleanup

cleanup:                                          ; preds = %if.end13, %if.then12, %if.end, %entry, %sw.epilog76
  %retval.0 = phi i32 [ 0, %sw.epilog76 ], [ -29, %entry ], [ -22, %if.end ], [ %., %if.then12 ], [ -22, %if.end13 ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %entry
  ...
  %call = call fastcc i1 @sb_is_blkdev_sb(%struct.super_block* noundef %0) #5
  br i1 %call, label %if.then1, label %if.end3

if.then1:                                         ; preds = %if.end
  %call2 = call %struct.block_device* @I_BDEV(%struct.inode* noundef nonnull %inode) #6
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @force_page_cache_readahead(%struct.address_space* noundef %mapping, %struct.file* noundef %file, i64 noundef %index, i64 noundef %nr_to_read) unnamed_addr #0 {
entry:
  ...
  store %struct.file_ra_state* %f_ra, %struct.file_ra_state** %ra, align 8
  ...
  call void @force_page_cache_ra(%struct.readahead_control* noundef nonnull %ractl, i64 noundef %nr_to_read) #6
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %0) #7
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @inode_write_congested(%struct.inode* noundef %inode) unnamed_addr #0 {
entry:
  %call = call fastcc i32 @inode_congested(%struct.inode* noundef %inode) #5
  ret i32 %call
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__filemap_fdatawrite_range(%struct.address_space* noundef, i64 noundef, i64 noundef, i32 noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @lru_add_drain() local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @invalidate_mapping_pagevec(%struct.address_space* noundef, i64 noundef, i64 noundef, i64* noundef) local_unnamed_addr #3
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @vfs_fadvise(%struct.file* noundef %file, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) local_unnamed_addr #0 {
entry:
  ...
  %fadvise = getelementptr inbounds %struct.file_operations, %struct.file_operations* %0, i64 0, i32 31
  %fadvise1 = bitcast {}** %fadvise to i32 (%struct.file*, i64, i64, i32)**
  %1 = load i32 (%struct.file*, i64, i64, i32)*, i32 (%struct.file*, i64, i64, i32)** %fadvise1, align 8
  %tobool.not = icmp eq i32 (%struct.file*, i64, i64, i32)* %1, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call = call i32 %1(%struct.file* noundef %file, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) #6
  br label %return

if.end:                                           ; preds = %entry
  %call5 = call i32 @generic_fadvise(%struct.file* noundef %file, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) #5
  br label %return
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @ksys_fadvise64_64(i32 noundef %fd, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) local_unnamed_addr #0 {
entry:
  %call = call fastcc [2 x i64] @fdget(i32 noundef %fd) #5
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @vfs_fadvise(%struct.file* noundef nonnull %0, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) #5
  call fastcc void @fdput([2 x i64] %call) #5
  br label %cleanup
...
entry:
  ...
  %call1 = call fastcc [2 x i64] @__to_fd(i64 noundef %call) #5
  ret [2 x i64] %call1
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i64 @__arm64_sys_fadvise64_64(%struct.pt_regs* nocapture noundef readonly %regs) local_unnamed_addr #0 {
entry:
  ...
  %call = call fastcc i64 @__se_sys_fadvise64_64(i64 noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef %3) #5
  ret i64 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__se_sys_fadvise64_64(i64 noundef %fd, i64 noundef %offset, i64 noundef %len, i64 noundef %advice) unnamed_addr #0 {
entry:
  %conv = trunc i64 %fd to i32
  %conv1 = trunc i64 %advice to i32
  %call = call fastcc i64 @__do_sys_fadvise64_64(i32 noundef %conv, i64 noundef %offset, i64 noundef %len, i32 noundef %conv1) #5
  ret i64 %call
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i1 @sb_is_blkdev_sb(%struct.super_block* nocapture noundef readnone %sb) unnamed_addr #2 {
entry:
...
entry:
  call void asm sideeffect "", "~{memory}"() #7, !srcloc !7
...
entry:
  ...
  %1 = call { i64, i32 } asm sideeffect "\09prfm\09pstl1strm, $2\0A1:\09ldaxr\09${1:w}, $2\0A\09eor\09${0:w}, ${1:w}, ${3:w}\0A\09cbnz\09${0:w}, 2f\0A\09stxr\09${0:w}, ${4:w}, $2\0A\09cbnz\09${0:w}, 1b\0A\09\0A2:", "=&r,=&r,=*Q,Kr,r,*Q,~{memory}"(i32* elementtype(i32) %0, i64 %old, i32 1, i32* elementtype(i32) %0) #7, !srcloc !9
...
entry:
  ...
  call void asm sideeffect "stlrb ${1:w}, $0", "=*Q,r,~{memory}"(i8* elementtype(i8) %locked.i, i8 0) #7, !srcloc !11
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @force_page_cache_ra(%struct.readahead_control* noundef, i64 noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @inode_congested(%struct.inode* noundef %inode) unnamed_addr #0 {
entry:
  %call = call fastcc %struct.backing_dev_info* @inode_to_bdi(%struct.inode* noundef %inode) #5
  %wb = getelementptr inbounds %struct.backing_dev_info, %struct.backing_dev_info* %call, i64 0, i32 11
  %call1 = call fastcc i32 @wb_congested(%struct.bdi_writeback* noundef %wb) #5
  ret i32 %call1
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i32 @wb_congested(%struct.bdi_writeback* nocapture noundef readonly %wb) unnamed_addr #2 {
entry:
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__do_sys_fadvise64_64(i32 noundef %fd, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) unnamed_addr #0 {
entry:
  %call = call i32 @ksys_fadvise64_64(i32 noundef %fd, i64 noundef %offset, i64 noundef %len, i32 noundef %advice) #5
...
!9 = !{i64 2147820632, i64 2147820665, i64 2147820718, i64 2147820777, i64 2147820811, i64 2147820866, i64 2147820895, i64 2147820915}
!10 = !{i64 2149548674}
!11 = !{i64 2149340904}
