...
%struct.vm_area_struct = type { i64, i64, %struct.vm_area_struct*, %struct.vm_area_struct*, %struct.rb_node, i64, %struct.mm_struct*, %struct.pgprot_t, i64, %struct.anon.68, %struct.list_head, %struct.anon_vma*, %struct.vm_operations_struct*, i64, %struct.file*, i8*, %struct.vm_userfaultfd_ctx }
%struct.mm_struct = type { %struct.anon, [0 x i64] }
%struct.pgprot_t = type { i64 }
%struct.anon.68 = type { %struct.rb_node, i64 }
%struct.anon_vma = type opaque
%struct.vm_operations_struct = type { void (%struct.vm_area_struct*)*, void (%struct.vm_area_struct*)*, i32 (%struct.vm_area_struct*, i64)*, i32 (%struct.vm_area_struct*)*, i32 (%struct.vm_area_struct*, i64, i64, i64)*, i32 (%struct.vm_fault*)*, i32 (%struct.vm_fault*, i32)*, i32 (%struct.vm_fault*, i64, i64)*, i64 (%struct.vm_area_struct*)*, i32 (%struct.vm_fault*)*, i32 (%struct.vm_fault*)*, i32 (%struct.vm_area_struct*, i64, i8*, i32, i32)*, i8* (%struct.vm_area_struct*)*, %struct.page* (%struct.vm_area_struct*, i64)* }
%struct.vm_fault = type { %struct.anon.51, i32, %struct.pmd_t*, %struct.pud_t*, %union.anon.52, %struct.page*, %struct.page*, %struct.pte_t*, %struct.spinlock*, %struct.page* }
%struct.anon.51 = type { %struct.vm_area_struct*, i32, i64, i64 }
%struct.pmd_t = type { i64 }
%struct.pud_t = type { %struct.p4d_t }
%struct.p4d_t = type { %struct.pgd_t }
%union.anon.52 = type { %struct.pte_t }
%struct.pte_t = type { i64 }
%struct.page = type { i64, %union.anon.36, %union.anon.54, %struct.atomic_t, [8 x i8] }
...
@init_mm = dso_local global { %struct.anon, [4 x i64] } { %struct.anon { %struct.vm_area_struct* null, %struct.rb_root zeroinitializer, i64 0, i64 (%struct.file*, i64, i64, i64, i64)* null, i64 0, i64 0, i64 0, i64 0, %struct.pgd_t* getelementptr inbounds ([512 x %struct.pgd_t], [512 x %struct.pgd_t]* @init_pg_dir, i32 0, i32 0), %struct.atomic_t zeroinitializer, %struct.atomic_t { i32 2 }, %struct.atomic_t { i32 1 }, %struct.atomic64_t zeroinitializer, i32 0, %struct.spinlock zeroinitializer, %struct.rw_semaphore { %struct.atomic64_t zeroinitializer, %struct.atomic64_t zeroinitializer, %struct.optimistic_spin_queue zeroinitializer, %struct.raw_spinlock zeroinitializer, %struct.list_head { %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast ({ %struct.anon, [4 x i64] }* @init_mm to i8*), i64 128) to %struct.list_head*), %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast ({ %struct.anon, [4 x i64] }* @init_mm to i8*), i64 128) to %struct.list_head*) } }, %struct.list_head { %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast ({ %struct.anon, [4 x i64] }* @init_mm to i8*), i64 144) to %struct.list_head*), %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast ({ %struct.anon, [4 x i64] }* @init_mm to i8*), i64 144) to %struct.list_head*) }, i64 0, i64 0, i64 0, i64 0, %struct.atomic64_t zeroinitializer, i64 0, i64 0, i64 0, i64 0, %struct.seqcount zeroinitializer, %struct.spinlock zeroinitializer, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, [46 x i64] zeroinitializer, %struct.mm_rss_stat zeroinitializer, %struct.linux_binfmt* null, %struct.mm_context_t zeroinitializer, i64 0, %struct.core_state* null, %struct.spinlock zeroinitializer, %struct.kioctx_table* null, %struct.user_namespace* @init_user_ns, %struct.file* null, %struct.atomic_t zeroinitializer, %struct.uprobes_state zeroinitializer, %struct.work_struct zeroinitializer }, [4 x i64] zeroinitializer }, align 8

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn writeonly
define dso_local void @setup_initial_init_mm(i8* noundef %start_code, i8* noundef %end_code, i8* noundef %end_data, i8* noundef %brk) local_unnamed_addr #0 {
entry:
  %0 = ptrtoint i8* %start_code to i64
  store i64 %0, i64* getelementptr inbounds ({ %struct.anon, [4 x i64] }, { %struct.anon, [4 x i64] }* @init_mm, i64 0, i32 0, i32 28), align 8
  %1 = ptrtoint i8* %end_code to i64
  store i64 %1, i64* getelementptr inbounds ({ %struct.anon, [4 x i64] }, { %struct.anon, [4 x i64] }* @init_mm, i64 0, i32 0, i32 29), align 8
  %2 = ptrtoint i8* %end_data to i64
  store i64 %2, i64* getelementptr inbounds ({ %struct.anon, [4 x i64] }, { %struct.anon, [4 x i64] }* @init_mm, i64 0, i32 0, i32 31), align 8
  %3 = ptrtoint i8* %brk to i64
  store i64 %3, i64* getelementptr inbounds ({ %struct.anon, [4 x i64] }, { %struct.anon, [4 x i64] }* @init_mm, i64 0, i32 0, i32 33), align 8
  ret void
}
