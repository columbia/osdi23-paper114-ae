...
@.str = private unnamed_addr constant [27 x i8] c"\013%s:%d: bad pgd %016llx.\0A\00", align 1
@.str.1 = private unnamed_addr constant [21 x i8] c"mm/pgtable-generic.c\00", align 1
@.str.2 = private unnamed_addr constant [27 x i8] c"\013%s:%d: bad pmd %016llx.\0A\00", align 1
...
define dso_local void @pgd_clear_bad(%struct.pgd_t* nocapture noundef readonly %pgd) local_unnamed_addr #0 {
entry:
  %pgd1 = getelementptr inbounds %struct.pgd_t, %struct.pgd_t* %pgd, i64 0, i32 0
  %0 = load i64, i64* %pgd1, align 8
  %call = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 noundef 23, i64 noundef %0) #3
  ret void
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @pmd_clear_bad(%struct.pmd_t* noundef %pmd) local_unnamed_addr #0 {
entry:
  %pmd1 = getelementptr inbounds %struct.pmd_t, %struct.pmd_t* %pmd, i64 0, i32 0
  %0 = load i64, i64* %pmd1, align 8
  %call = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 noundef 50, i64 noundef %0) #3
  call fastcc void @pmd_clear(%struct.pmd_t* noundef %pmd) #4
  ret void
}
...
entry:
  call fastcc void @set_pmd(%struct.pmd_t* noundef %pmdp) #4
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i64 @ptep_clear_flush(%struct.vm_area_struct* nocapture noundef readonly %vma, i64 noundef %address, %struct.pte_t* noundef %ptep) local_unnamed_addr #0 {
entry:
  ...
  %call = call fastcc i64 @ptep_get_and_clear(%struct.pte_t* noundef %ptep) #4
  %call1 = call fastcc i1 @mm_tlb_flush_pending(%struct.mm_struct* noundef %0) #4
  br i1 %call1, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %and = and i64 %call, 288230376151711745
...
if.then:                                          ; preds = %cond.false, %cond.true
  call fastcc void @flush_tlb_page(%struct.vm_area_struct* noundef %vma, i64 noundef %address) #4
  br label %if.end
...
entry:
  ...
  %call11.i = call fastcc i64 @__xchg_case_64(i8* noundef %0) #5
  ret i64 %call11.i
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i1 @mm_tlb_flush_pending(%struct.mm_struct* noundef %mm) unnamed_addr #2 {
entry:
...
entry:
  call fastcc void @flush_tlb_page_nosync(%struct.vm_area_struct* noundef %vma, i64 noundef %uaddr) #4
  call void asm sideeffect "dsb ish", "~{memory}"() #6, !srcloc !7
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @set_pmd(%struct.pmd_t* noundef %pmdp) unnamed_addr #0 {
entry:
  %pmd.sroa.0 = alloca i64, align 8
  store i64 0, i64* %pmd.sroa.0, align 8
...
if.then:                                          ; preds = %entry
  call void asm sideeffect "dsb ishst", "~{memory}"() #6, !srcloc !8
  call void asm sideeffect "isb", "~{memory}"() #6, !srcloc !9
  br label %if.end
...
entry:
  ...
  %1 = call { i64, i64 } asm sideeffect "\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09stxr\09${1:w}, $3, $2\0A\09cbnz\09${1:w}, 1b\0A\09", "=&r,=&r,=*Q,r,*Q"(i64* elementtype(i64) %0, i64 0, i64* elementtype(i64) %0) #6, !srcloc !10
...
entry:
  %call.i.i = call fastcc i32 @static_key_count(%struct.static_key* noundef getelementptr inbounds (%struct.static_key_false, %struct.static_key_false* @arm64_const_caps_ready, i64 0, i32 0)) #5
  %cmp.i.i = icmp sgt i32 %call.i.i, 0
  br i1 %cmp.i.i, label %if.then3.i, label %if.else5.i

if.then3.i:                                       ; preds = %entry
  %call.i1.i = call fastcc i32 @static_key_count(%struct.static_key* noundef getelementptr inbounds ([61 x %struct.static_key_false], [61 x %struct.static_key_false]* @cpu_hwcap_keys, i64 0, i64 41, i32 0)) #5
  %cmp1.i.i = icmp sgt i32 %call.i1.i, 0
  br label %cpus_have_const_cap.exit

if.else5.i:                                       ; preds = %entry
  %call6.i = call fastcc i1 @cpus_have_cap() #5
  br label %cpus_have_const_cap.exit
...
attributes #3 = { cold nobuiltin nounwind "no-builtins" }
...
!8 = !{i64 2151536009}
!9 = !{i64 2151536058}
!10 = !{i64 2148105575, i64 2148105607, i64 2148105651, i64 2148105697, i64 2148105723}
!11 = !{i64 2151325335}
!12 = !{i64 2151326737, i64 2151326464, i64 2151327099, i64 2151327145, i64 2151327151, i64 2151328539, i64 2151327188, i64 2151327206, i64 2151328613, i64 2151328661, i64 2151328709, i64 2151328772, i64 2151328821, i64 2151327284, i64 2151327309, i64 2151327335, i64 2151327341, i64 2151328560, i64 2151327378, i64 2151327384, i64 2151327434, i64 2151327480, i64 2151327513}
!13 = !{i64 2151329575, i64 2151329270, i64 2151329937, i64 2151329983, i64 2151329989, i64 2151331377, i64 2151330026, i64 2151330044, i64 2151331451, i64 2151331499, i64 2151331547, i64 2151331610, i64 2151331659, i64 2151330122, i64 2151330147, i64 2151330173, i64 2151330179, i64 2151331398, i64 2151330216, i64 2151330222, i64 2151330272, i64 2151330318, i64 2151330351}
