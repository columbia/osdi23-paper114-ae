; ModuleID = 'fs/anon_inodes.c'
source_filename = "fs/anon_inodes.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_anon_inodes__252_241_anon_inode_init5:\09\09\09"
...
@__UNIQUE_ID___addressable_anon_inode_init253 = internal global i8* bitcast (i32 ()* @anon_inode_init to i8*), section ".discard.addressable", align 8
@anon_inode_inode = internal unnamed_addr global %struct.inode* null, align 8
@anon_inode_mnt = internal unnamed_addr global %struct.vfsmount* null, section ".data..read_mostly", align 8
@anon_inode_fs_type = internal global %struct.file_system_type { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0), i32 0, i32 (%struct.fs_context*)* @anon_inodefs_init_fs_context, %struct.fs_parameter_spec* null, %struct.dentry* (%struct.file_system_type*, i32, i8*, i8*)* null, void (%struct.super_block*)* @kill_anon_super, %struct.module* null, %struct.file_system_type* null, %struct.hlist_head zeroinitializer, %struct.lock_class_key zeroinitializer, %struct.lock_class_key zeroinitializer, %struct.lock_class_key zeroinitializer, [3 x %struct.lock_class_key] zeroinitializer, %struct.lock_class_key zeroinitializer, %struct.lock_class_key zeroinitializer, %struct.lock_class_key zeroinitializer, %struct.lock_class_key zeroinitializer }, align 8
...
@anon_inodefs_dentry_operations = internal constant %struct.dentry_operations { i32 (%struct.dentry*, i32)* null, i32 (%struct.dentry*, i32)* null, i32 (%struct.dentry*, %struct.qstr*)* null, i32 (%struct.dentry*, i32, i8*, %struct.qstr*)* null, i32 (%struct.dentry*)* null, i32 (%struct.dentry*)* null, void (%struct.dentry*)* null, void (%struct.dentry*)* null, void (%struct.dentry*, %struct.inode*)* null, i8* (%struct.dentry*, i8*, i32)* @anon_inodefs_dname, %struct.vfsmount* (%struct.path*)* null, i32 (%struct.path*, i1)* null, %struct.dentry* (%struct.dentry*, %struct.inode*)* null, [24 x i8] undef }, align 64
@.str.3 = private unnamed_addr constant [14 x i8] c"anon_inode:%s\00", align 1
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_anon_inode_init253 to i8*)], section "llvm.metadata"

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local %struct.file* @anon_inode_getfile(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags) local_unnamed_addr #0 {
entry:
  %call = call fastcc %struct.file* @__anon_inode_getfile(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef false) #5
  ret %struct.file* %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc %struct.file* @__anon_inode_getfile(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef %secure) unnamed_addr #0 {
entry:
  br i1 %secure, label %if.then4, label %if.else

if.then4:                                         ; preds = %entry
  %call5 = call fastcc %struct.inode* @anon_inode_make_secure_inode(i8* noundef %name) #5
  %0 = bitcast %struct.inode* %call5 to i8*
  %call6 = call fastcc i1 @IS_ERR(i8* noundef %0) #5
  br i1 %call6, label %if.then7, label %if.end14

if.then7:                                         ; preds = %if.then4
  %1 = bitcast %struct.inode* %call5 to %struct.file*
  br label %cleanup

if.else:                                          ; preds = %entry
  %2 = load %struct.inode*, %struct.inode** @anon_inode_inode, align 8
  %3 = bitcast %struct.inode* %2 to i8*
  %call10 = call fastcc i1 @IS_ERR(i8* noundef %3) #5
  br i1 %call10, label %cleanup, label %if.end13

if.end13:                                         ; preds = %if.else
  call void @ihold(%struct.inode* noundef %2) #6
  br label %if.end14

if.end14:                                         ; preds = %if.then4, %if.end13
  %inode.0 = phi %struct.inode* [ %call5, %if.then4 ], [ %2, %if.end13 ]
  %4 = load %struct.vfsmount*, %struct.vfsmount** @anon_inode_mnt, align 8
  %and = and i32 %flags, 2051
  %call15 = call %struct.file* @alloc_file_pseudo(%struct.inode* noundef %inode.0, %struct.vfsmount* noundef %4, i8* noundef %name, i32 noundef %and, %struct.file_operations* noundef %fops) #6
  %5 = bitcast %struct.file* %call15 to i8*
  %call16 = call fastcc i1 @IS_ERR(i8* noundef %5) #5
  br i1 %call16, label %err_iput, label %if.end18

if.end18:                                         ; preds = %if.end14
  %i_mapping = getelementptr inbounds %struct.inode, %struct.inode* %inode.0, i64 0, i32 7
  %6 = load %struct.address_space*, %struct.address_space** %i_mapping, align 8
  %f_mapping = getelementptr inbounds %struct.file, %struct.file* %call15, i64 0, i32 17
  store %struct.address_space* %6, %struct.address_space** %f_mapping, align 8
  %private_data = getelementptr inbounds %struct.file, %struct.file* %call15, i64 0, i32 15
  store i8* %priv, i8** %private_data, align 8
  br label %cleanup

err_iput:                                         ; preds = %if.end14
  call void @iput(%struct.inode* noundef %inode.0) #6
  br label %cleanup

cleanup:                                          ; preds = %if.then7, %err_iput, %if.else, %if.end18
  %retval.0 = phi %struct.file* [ %call15, %if.end18 ], [ %1, %if.then7 ], [ %call15, %err_iput ], [ inttoptr (i64 -19 to %struct.file*), %if.else ]
  ret %struct.file* %retval.0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @anon_inode_getfd(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags) local_unnamed_addr #0 {
entry:
  %call = call fastcc i32 @__anon_inode_getfd(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef false) #5
  ret i32 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @__anon_inode_getfd(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef %secure) unnamed_addr #0 {
entry:
  %call = call i32 @get_unused_fd_flags(i32 noundef %flags) #6
  %cmp = icmp slt i32 %call, 0
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %call1 = call fastcc %struct.file* @__anon_inode_getfile(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef %secure) #5
  %0 = bitcast %struct.file* %call1 to i8*
  %call2 = call fastcc i1 @IS_ERR(i8* noundef %0) #5
  br i1 %call2, label %if.then3, label %if.end5

if.then3:                                         ; preds = %if.end
  %call4 = call fastcc i64 @PTR_ERR(i8* noundef %0) #5
  %conv = trunc i64 %call4 to i32
  call void @put_unused_fd(i32 noundef %call) #6
  br label %cleanup

if.end5:                                          ; preds = %if.end
  call void @fd_install(i32 noundef %call, %struct.file* noundef %call1) #6
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.then3, %if.end5
  %retval.0 = phi i32 [ %conv, %if.then3 ], [ %call, %if.end5 ], [ %call, %entry ]
  ret i32 %retval.0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @anon_inode_getfd_secure(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, %struct.inode* nocapture noundef readnone %context_inode) local_unnamed_addr #0 {
entry:
  %call = call fastcc i32 @__anon_inode_getfd(i8* noundef %name, %struct.file_operations* noundef %fops, i8* noundef %priv, i32 noundef %flags, i1 noundef true) #5
  ret i32 %call
}
...
entry:
  %call = call %struct.vfsmount* @kern_mount(%struct.file_system_type* noundef nonnull @anon_inode_fs_type) #6
  store %struct.vfsmount* %call, %struct.vfsmount** @anon_inode_mnt, align 8
...
if.then:                                          ; preds = %entry
  ...
  call void (i8*, ...) @panic(i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0), i64 noundef %call2) #7
  unreachable
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call %struct.inode* @alloc_anon_inode(%struct.super_block* noundef %1) #6
  store %struct.inode* %call3, %struct.inode** @anon_inode_inode, align 8
  %2 = bitcast %struct.inode* %call3 to i8*
  %call4 = call fastcc i1 @IS_ERR(i8* noundef %2) #5
  br i1 %call4, label %if.then5, label %if.end7

if.then5:                                         ; preds = %if.end
  %call6 = call fastcc i64 @PTR_ERR(i8* noundef %2) #5
  call void (i8*, ...) @panic(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str.1, i64 0, i64 0), i64 noundef %call6) #7
  unreachable
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc %struct.inode* @anon_inode_make_secure_inode(i8* noundef %name) unnamed_addr #0 {
entry:
  %call = call i64 @strlen(i8* noundef %name) #6
  %0 = load %struct.vfsmount*, %struct.vfsmount** @anon_inode_mnt, align 8
  %mnt_sb = getelementptr inbounds %struct.vfsmount, %struct.vfsmount* %0, i64 0, i32 1
  %1 = load %struct.super_block*, %struct.super_block** %mnt_sb, align 8
  %call2 = call %struct.inode* @alloc_anon_inode(%struct.super_block* noundef %1) #6
  %2 = bitcast %struct.inode* %call2 to i8*
  %call3 = call fastcc i1 @IS_ERR(i8* noundef %2) #5
  br i1 %call3, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %i_flags = getelementptr inbounds %struct.inode, %struct.inode* %call2, i64 0, i32 4
...
; Function Attrs: null_pointer_is_valid
declare dso_local %struct.file* @alloc_file_pseudo(%struct.inode* noundef, %struct.vfsmount* noundef, i8* noundef, i32 noundef, %struct.file_operations* noundef) local_unnamed_addr #3
...
; Function Attrs: null_pointer_is_valid
declare dso_local %struct.inode* @alloc_anon_inode(%struct.super_block* noundef) local_unnamed_addr #3
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @anon_inodefs_init_fs_context(%struct.fs_context* noundef %fc) #0 {
entry:
  %call = call %struct.pseudo_fs_context* @init_pseudo(%struct.fs_context* noundef %fc, i64 noundef 151263540) #6
...
if.end:                                           ; preds = %entry
  ...
  store %struct.dentry_operations* @anon_inodefs_dentry_operations, %struct.dentry_operations** %dops, align 8
  br label %cleanup
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i8* @anon_inodefs_dname(%struct.dentry* noundef %dentry, i8* noundef %buffer, i32 noundef %buflen) #0 {
entry:
  %name = getelementptr inbounds %struct.dentry, %struct.dentry* %dentry, i64 0, i32 4, i32 1
  %0 = load i8*, i8** %name, align 8
  %call = call i8* (%struct.dentry*, i8*, i32, i8*, ...) @dynamic_dname(%struct.dentry* noundef %dentry, i8* noundef %buffer, i32 noundef %buflen, i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i8* noundef %0) #6
  ret i8* %call
}

; Function Attrs: null_pointer_is_valid
declare dso_local i8* @dynamic_dname(%struct.dentry* noundef, i8* noundef, i32 noundef, i8* noundef, ...) local_unnamed_addr #3
