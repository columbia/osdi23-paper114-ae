...
@sysfs_root_kn = external dso_local local_unnamed_addr global %struct.kernfs_node*, align 8
@kmalloc_caches = external dso_local local_unnamed_addr global [3 x [14 x %struct.kmem_cache*]], align 8

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @sysfs_warn_dup(%struct.kernfs_node* noundef %parent, i8* noundef %name) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  call fastcc void @kernfs_path(%struct.kernfs_node* noundef %parent, i8* noundef nonnull %call) #6
  br label %do.end

do.end:                                           ; preds = %entry, %if.then
  %call2 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([51 x i8], [51 x i8]* @.str, i64 0, i64 0), i8* noundef %call, i8* noundef %name) #7
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @kernfs_path(%struct.kernfs_node* noundef %kn, i8* noundef %buf) unnamed_addr #0 {
entry:
  %call = call i32 @kernfs_path_from_node(%struct.kernfs_node* noundef %kn, %struct.kernfs_node* noundef null, i8* noundef %buf, i64 noundef 4096) #8
  ret void
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @sysfs_create_dir_ns(%struct.kobject* noundef %kobj, i8* noundef %ns) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22fs/sysfs/dir.c\22; .popsection; .long 14472b - 14470b; .short 46; .short (1 << 0)|(((9) << 8)); .popsection; 14471: brk 0x800", ""() #9, !srcloc !9
  br label %cleanup

if.end18:                                         ; preds = %entry
  %parent19 = getelementptr inbounds %struct.kobject, %struct.kobject* %kobj, i64 0, i32 2
  %4 = load %struct.kobject*, %struct.kobject** %parent19, align 8
  %tobool20.not = icmp eq %struct.kobject* %4, null
  %sd = getelementptr inbounds %struct.kobject, %struct.kobject* %4, i64 0, i32 5
  %parent.0.in = select i1 %tobool20.not, %struct.kernfs_node** @sysfs_root_kn, %struct.kernfs_node** %sd
  %parent.0 = load %struct.kernfs_node*, %struct.kernfs_node** %parent.0.in, align 8
  %tobool24.not = icmp eq %struct.kernfs_node* %parent.0, null
  br i1 %tobool24.not, label %cleanup, label %if.end26

if.end26:                                         ; preds = %if.end18
  call void @kobject_get_ownership(%struct.kobject* noundef nonnull %kobj, %struct.kuid_t* noundef nonnull %uid, %struct.kgid_t* noundef nonnull %gid) #8
  %call = call fastcc i8* @kobject_name(%struct.kobject* noundef nonnull %kobj) #6
  %5 = bitcast %struct.kobject* %kobj to i8*
  %6 = load i32, i32* %1, align 4
  %coerce.val.ii = zext i32 %6 to i64
  %7 = load i32, i32* %3, align 4
  %coerce.val.ii28 = zext i32 %7 to i64
  %call29 = call %struct.kernfs_node* @kernfs_create_dir_ns(%struct.kernfs_node* noundef nonnull %parent.0, i8* noundef %call, i16 noundef 493, i64 %coerce.val.ii, i64 %coerce.val.ii28, i8* noundef nonnull %5, i8* noundef %ns) #8
  %8 = bitcast %struct.kernfs_node* %call29 to i8*
  %call30 = call fastcc i1 @IS_ERR(i8* noundef %8) #6
  br i1 %call30, label %if.then31, label %if.end39

if.then31:                                        ; preds = %if.end26
  %call32 = call fastcc i64 @PTR_ERR(i8* noundef %8) #6
  %cmp = icmp eq i64 %call32, -17
  br i1 %cmp, label %if.then34, label %if.end36

if.then34:                                        ; preds = %if.then31
  %call35 = call fastcc i8* @kobject_name(%struct.kobject* noundef nonnull %kobj) #6
  call void @sysfs_warn_dup(%struct.kernfs_node* noundef nonnull %parent.0, i8* noundef %call35) #6
  br label %if.end36
...
if.end39:                                         ; preds = %if.end26
  %sd40 = getelementptr inbounds %struct.kobject, %struct.kobject* %kobj, i64 0, i32 5
  store %struct.kernfs_node* %call29, %struct.kernfs_node** %sd40, align 8
  br label %cleanup

cleanup:                                          ; preds = %if.then, %if.end18, %if.end39, %if.end36
  %retval.0 = phi i32 [ %conv38, %if.end36 ], [ 0, %if.end39 ], [ -22, %if.then ], [ -2, %if.end18 ]
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @kobject_get_ownership(%struct.kobject* noundef, %struct.kuid_t* noundef, %struct.kgid_t* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.kernfs_node* @kernfs_create_dir_ns(%struct.kernfs_node* noundef, i8* noundef, i16 noundef, i64, i64, i8* noundef, i8* noundef) local_unnamed_addr #3
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @sysfs_remove_dir(%struct.kobject* nocapture noundef %kobj) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @__raw_spin_lock() #8
  store %struct.kernfs_node* null, %struct.kernfs_node** %sd, align 8
  call fastcc void @__raw_spin_unlock() #8
  %tobool.not = icmp eq %struct.kernfs_node* %0, null
  br i1 %tobool.not, label %if.end17, label %if.then

if.then:                                          ; preds = %entry
  %call = call fastcc i32 @kernfs_type(%struct.kernfs_node* noundef nonnull %0) #6
  %cmp.not = icmp eq i32 %call, 1
  br i1 %cmp.not, label %if.end, label %if.then9, !prof !10

if.then9:                                         ; preds = %if.then
  call void asm sideeffect ".pushsection __bug_table,\22aw\22; .align 2; 14470: .long 14471f - 14470b; .pushsection .rodata.str,\22aMS\22,@progbits,1; 14472: .string \22fs/sysfs/dir.c\22; .popsection; .long 14472b - 14470b; .short 101; .short (1 << 0)|((1 << 1) | ((9) << 8)); .popsection; 14471: brk 0x800", ""() #9, !srcloc !11
  br label %if.end

if.end:                                           ; preds = %if.then9, %if.then
  call void @kernfs_remove(%struct.kernfs_node* noundef nonnull %0) #8
  br label %if.end17
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @kernfs_remove(%struct.kernfs_node* noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @sysfs_rename_dir_ns(%struct.kobject* nocapture noundef readonly %kobj, i8* noundef %new_name, i8* noundef %new_ns) local_unnamed_addr #0 {
entry:
  %sd = getelementptr inbounds %struct.kobject, %struct.kobject* %kobj, i64 0, i32 5
  %0 = load %struct.kernfs_node*, %struct.kernfs_node** %sd, align 8
  %call = call %struct.kernfs_node* @kernfs_get_parent(%struct.kernfs_node* noundef %0) #8
  %1 = load %struct.kernfs_node*, %struct.kernfs_node** %sd, align 8
  %call2 = call i32 @kernfs_rename_ns(%struct.kernfs_node* noundef %1, %struct.kernfs_node* noundef %call, i8* noundef %new_name, i8* noundef %new_ns) #8
  call void @kernfs_put(%struct.kernfs_node* noundef %call) #8
  ret i32 %call2
}

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.kernfs_node* @kernfs_get_parent(%struct.kernfs_node* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @kernfs_rename_ns(%struct.kernfs_node* noundef, %struct.kernfs_node* noundef, i8* noundef, i8* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @kernfs_put(%struct.kernfs_node* noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @sysfs_move_dir_ns(%struct.kobject* nocapture noundef readonly %kobj, %struct.kobject* noundef readonly %new_parent_kobj, i8* noundef %new_ns) local_unnamed_addr #0 {
entry:
  %sd = getelementptr inbounds %struct.kobject, %struct.kobject* %kobj, i64 0, i32 5
  %0 = load %struct.kernfs_node*, %struct.kernfs_node** %sd, align 8
  %tobool.not = icmp eq %struct.kobject* %new_parent_kobj, null
  br i1 %tobool.not, label %cond.false, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %sd1 = getelementptr inbounds %struct.kobject, %struct.kobject* %new_parent_kobj, i64 0, i32 5
  %1 = load %struct.kernfs_node*, %struct.kernfs_node** %sd1, align 8
  %tobool2.not = icmp eq %struct.kernfs_node* %1, null
  br i1 %tobool2.not, label %cond.false, label %cond.end

cond.false:                                       ; preds = %land.lhs.true, %entry
  %2 = load %struct.kernfs_node*, %struct.kernfs_node** @sysfs_root_kn, align 8
  br label %cond.end

cond.end:                                         ; preds = %land.lhs.true, %cond.false
  %cond = phi %struct.kernfs_node* [ %2, %cond.false ], [ %1, %land.lhs.true ]
  %name = getelementptr inbounds %struct.kernfs_node, %struct.kernfs_node* %0, i64 0, i32 3
  %3 = load i8*, i8** %name, align 8
  %call = call i32 @kernfs_rename_ns(%struct.kernfs_node* noundef %0, %struct.kernfs_node* noundef %cond, i8* noundef %3, i8* noundef %new_ns) #8
  ret i32 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local i32 @sysfs_create_mount_point(%struct.kobject* nocapture noundef readonly %parent_kobj, i8* noundef %name) local_unnamed_addr #0 {
entry:
  %sd = getelementptr inbounds %struct.kobject, %struct.kobject* %parent_kobj, i64 0, i32 5
  %0 = load %struct.kernfs_node*, %struct.kernfs_node** %sd, align 8
  %call = call %struct.kernfs_node* @kernfs_create_empty_dir(%struct.kernfs_node* noundef %0, i8* noundef %name) #8
  %1 = bitcast %struct.kernfs_node* %call to i8*
  %call1 = call fastcc i1 @IS_ERR(i8* noundef %1) #6
  br i1 %call1, label %if.then, label %cleanup

if.then:                                          ; preds = %entry
  %call2 = call fastcc i64 @PTR_ERR(i8* noundef %1) #6
  %cmp = icmp eq i64 %call2, -17
  br i1 %cmp, label %if.then3, label %if.end

if.then3:                                         ; preds = %if.then
  call void @sysfs_warn_dup(%struct.kernfs_node* noundef %0, i8* noundef %name) #6
  br label %if.end
...
; Function Attrs: null_pointer_is_valid
declare dso_local %struct.kernfs_node* @kernfs_create_empty_dir(%struct.kernfs_node* noundef, i8* noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @sysfs_remove_mount_point(%struct.kobject* nocapture noundef readonly %parent_kobj, i8* noundef %name) local_unnamed_addr #0 {
entry:
  %sd = getelementptr inbounds %struct.kobject, %struct.kobject* %parent_kobj, i64 0, i32 5
  %0 = load %struct.kernfs_node*, %struct.kernfs_node** %sd, align 8
  %call = call i32 @kernfs_remove_by_name_ns(%struct.kernfs_node* noundef %0, i8* noundef %name, i8* noundef null) #8
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @kernfs_remove_by_name_ns(%struct.kernfs_node* noundef, i8* noundef, i8* noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local noalias i8* @kmem_cache_alloc(%struct.kmem_cache* noundef, i32 noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @kernfs_path_from_node(%struct.kernfs_node* noundef, %struct.kernfs_node* noundef, i8* noundef, i64 noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @__raw_spin_lock() unnamed_addr #0 {
entry:
  call void asm sideeffect "", "~{memory}"() #9, !srcloc !12
  call fastcc void @do_raw_spin_lock() #6
  ret void
}
...
if.end.i:                                         ; preds = %entry
  call void @queued_spin_lock_slowpath(%struct.qspinlock* noundef getelementptr inbounds (%struct.spinlock, %struct.spinlock* @sysfs_symlink_target_lock, i64 0, i32 0, i32 0, i32 0), i32 noundef %call11.i.i.i.i) #8
...
entry:
  call void asm sideeffect "stlrb ${1:w}, $0", "=*Q,r,~{memory}"(i8* elementtype(i8) bitcast (%struct.spinlock* @sysfs_symlink_target_lock to i8*), i8 0) #9, !srcloc !15
  ret void
}
...
!11 = !{i64 2152004184}
!12 = !{i64 2149535916}
!13 = !{i64 2148028661, i64 2148028694, i64 2148028747, i64 2148028806, i64 2148028840, i64 2148028895, i64 2148028924, i64 2148028944}
!14 = !{i64 2149543197}
!15 = !{i64 2149335427}
