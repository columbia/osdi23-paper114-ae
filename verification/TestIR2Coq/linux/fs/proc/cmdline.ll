; ModuleID = 'fs/proc/cmdline.c'
source_filename = "fs/proc/cmdline.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__187_19_proc_cmdline_init5:\09\09\09"
module asm ".long\09proc_cmdline_init - .\09"
...
@__UNIQUE_ID___addressable_proc_cmdline_init188 = internal global i8* bitcast (i32 ()* @proc_cmdline_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [8 x i8] c"cmdline\00", align 1
@saved_command_line = external dso_local local_unnamed_addr global i8*, align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_cmdline_init188 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_cmdline_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @cmdline_proc_show, i8* noundef null) #3
  ret i32 0
}
...
define internal i32 @cmdline_proc_show(%struct.seq_file* noundef %m, i8* nocapture noundef readnone %v) #2 {
entry:
  %0 = load i8*, i8** @saved_command_line, align 8
  call void @seq_puts(%struct.seq_file* noundef %m, i8* noundef %0) #3
