; ModuleID = 'fs/proc/version.c'
source_filename = "fs/proc/version.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__187_23_proc_version_init5:\09\09\09"
module asm ".long\09proc_version_init - .\09"
...
@__UNIQUE_ID___addressable_proc_version_init188 = internal global i8* bitcast (i32 ()* @proc_version_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [8 x i8] c"version\00", align 1
@linux_proc_banner = external dso_local constant [0 x i8], align 1
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_version_init188 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_version_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @version_proc_show, i8* noundef null) #4
  ret i32 0
}
...
define internal i32 @version_proc_show(%struct.seq_file* noundef %m, i8* nocapture noundef readnone %v) #2 {
entry:
  %call = call fastcc %struct.new_utsname* @utsname() #5
  %arraydecay = getelementptr inbounds %struct.new_utsname, %struct.new_utsname* %call, i64 0, i32 0, i64 0
  %arraydecay2 = getelementptr inbounds %struct.new_utsname, %struct.new_utsname* %call, i64 0, i32 2, i64 0
  %arraydecay4 = getelementptr inbounds %struct.new_utsname, %struct.new_utsname* %call, i64 0, i32 3, i64 0
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([0 x i8], [0 x i8]* @linux_proc_banner, i64 0, i64 0), i8* noundef %arraydecay, i8* noundef %arraydecay2, i8* noundef %arraydecay4) #4
  ret i32 0
}
...
define internal fastcc %struct.new_utsname* @utsname() unnamed_addr #3 {
entry:
