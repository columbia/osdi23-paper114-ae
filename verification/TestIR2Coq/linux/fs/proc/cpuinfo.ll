; ModuleID = 'fs/proc/cpuinfo.c'
source_filename = "fs/proc/cpuinfo.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__200_32_proc_cpuinfo_init5:\09\09\09"
module asm ".long\09proc_cpuinfo_init - .\09"
...
%struct.page = type { i64, %union.anon.34, %union.anon.48, %struct.atomic_t, [8 x i8] }
...
@__UNIQUE_ID___addressable_proc_cpuinfo_init201 = internal global i8* bitcast (i32 ()* @proc_cpuinfo_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [8 x i8] c"cpuinfo\00", align 1
@cpuinfo_proc_ops = internal constant %struct.proc_ops { i32 1, i32 (%struct.inode*, %struct.file*)* @cpuinfo_open, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.kiocb*, %struct.iov_iter*)* @seq_read_iter, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.file*, i64, i32)* @seq_lseek, i32 (%struct.inode*, %struct.file*)* @seq_release, i32 (%struct.file*, %struct.poll_table_struct*)* null, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* null, i64 (%struct.file*, i64, i64, i64, i64)* null }, align 8
@cpuinfo_op = external dso_local constant %struct.seq_operations, align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_cpuinfo_init201 to i8*)], section "llvm.metadata"
...
entry:
  %call = call %struct.proc_dir_entry* @proc_create(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, %struct.proc_ops* noundef nonnull @cpuinfo_proc_ops) #3
  ret i32 0
}

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.proc_dir_entry* @proc_create(i8* noundef, i16 noundef, %struct.proc_dir_entry* noundef, %struct.proc_ops* noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @cpuinfo_open(%struct.inode* nocapture noundef readnone %inode, %struct.file* noundef %file) #0 {
entry:
  call void @arch_freq_prepare_all() #4
  %call = call i32 @seq_open(%struct.file* noundef %file, %struct.seq_operations* noundef nonnull @cpuinfo_op) #3
  ret i32 %call
}

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @seq_read_iter(%struct.kiocb* noundef, %struct.iov_iter* noundef) #2

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @seq_lseek(%struct.file* noundef, i64 noundef, i32 noundef) #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @seq_release(%struct.inode* noundef, %struct.file* noundef) #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @seq_open(%struct.file* noundef, %struct.seq_operations* noundef) local_unnamed_addr #2
