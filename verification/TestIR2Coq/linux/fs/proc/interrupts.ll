; ModuleID = 'fs/proc/interrupts.c'
source_filename = "fs/proc/interrupts.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__234_42_proc_interrupts_init5:\09\09\09"
module asm ".long\09proc_interrupts_init - .\09"
...
@__UNIQUE_ID___addressable_proc_interrupts_init235 = internal global i8* bitcast (i32 ()* @proc_interrupts_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [11 x i8] c"interrupts\00", align 1
@int_seq_ops = internal constant %struct.seq_operations { i8* (%struct.seq_file*, i64*)* @int_seq_start, void (%struct.seq_file*, i8*)* @int_seq_stop, i8* (%struct.seq_file*, i8*, i64*)* @int_seq_next, i32 (%struct.seq_file*, i8*)* @show_interrupts }, align 8
@nr_irqs = external dso_local local_unnamed_addr global i32, align 4
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_interrupts_init235 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_interrupts_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_seq_private(i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, %struct.seq_operations* noundef nonnull @int_seq_ops, i32 noundef 0, i8* noundef null) #5
  ret i32 0
}
...
define internal i8* @int_seq_start(%struct.seq_file* nocapture noundef readnone %f, i64* noundef readonly %pos) #2 {
entry:
  %0 = load i64, i64* %pos, align 8
  %1 = load i32, i32* @nr_irqs, align 4
  %conv = sext i32 %1 to i64
  %cmp.not = icmp sgt i64 %0, %conv
  %2 = bitcast i64* %pos to i8*
  %3 = select i1 %cmp.not, i8* null, i8* %2
  ret i8* %3
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @int_seq_stop(%struct.seq_file* nocapture noundef %f, i8* nocapture noundef %v) #3 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal i8* @int_seq_next(%struct.seq_file* nocapture noundef readnone %f, i8* nocapture noundef readnone %v, i64* noundef %pos) #4 {
entry:
  %0 = load i64, i64* %pos, align 8
  %inc = add i64 %0, 1
  ...
  %2 = bitcast i64* %pos to i8*
  %retval.0 = select i1 %cmp, i8* null, i8* %2
  ret i8* %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @show_interrupts(%struct.seq_file* noundef, i8* noundef) #1
