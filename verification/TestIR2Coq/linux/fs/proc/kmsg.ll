; ModuleID = 'fs/proc/kmsg.c'
source_filename = "fs/proc/kmsg.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__224_66_proc_kmsg_init5:\09\09\09"
...
@__UNIQUE_ID___addressable_proc_kmsg_init225 = internal global i8* bitcast (i32 ()* @proc_kmsg_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [5 x i8] c"kmsg\00", align 1
@kmsg_proc_ops = internal constant %struct.proc_ops { i32 1, i32 (%struct.inode*, %struct.file*)* @kmsg_open, i64 (%struct.file*, i8*, i64, i64*)* @kmsg_read, i64 (%struct.kiocb*, %struct.iov_iter*)* null, i64 (%struct.file*, i8*, i64, i64*)* null, i64 (%struct.file*, i64, i32)* @generic_file_llseek, i32 (%struct.inode*, %struct.file*)* @kmsg_release, i32 (%struct.file*, %struct.poll_table_struct*)* @kmsg_poll, i64 (%struct.file*, i32, i64)* null, i32 (%struct.file*, %struct.vm_area_struct*)* null, i64 (%struct.file*, i64, i64, i64, i64)* null }, align 8
@log_wait = external dso_local global %struct.wait_queue_head, align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_kmsg_init225 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_kmsg_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create(i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i16 noundef 256, %struct.proc_dir_entry* noundef null, %struct.proc_ops* noundef nonnull @kmsg_proc_ops) #3
  ret i32 0
}
...
define internal i32 @kmsg_open(%struct.inode* nocapture noundef readnone %inode, %struct.file* nocapture noundef readnone %file) #2 {
entry:
  %call = call i32 @do_syslog(i32 noundef 1, i8* noundef null, i32 noundef 0, i32 noundef 1) #3
  ret i32 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i64 @kmsg_read(%struct.file* nocapture noundef readonly %file, i8* noundef %buf, i64 noundef %count, i64* nocapture noundef readnone %ppos) #2 {
entry:
...
land.lhs.true:                                    ; preds = %entry
  %call = call i32 @do_syslog(i32 noundef 9, i8* noundef null, i32 noundef 0, i32 noundef 1) #3
  %tobool1.not = icmp eq i32 %call, 0
  br i1 %tobool1.not, label %return, label %if.end

if.end:                                           ; preds = %land.lhs.true, %entry
  %conv = trunc i64 %count to i32
  %call2 = call i32 @do_syslog(i32 noundef 2, i8* noundef %buf, i32 noundef %conv, i32 noundef 1) #3
  %conv3 = sext i32 %call2 to i64
  br label %return

return:                                           ; preds = %land.lhs.true, %if.end
  %retval.0 = phi i64 [ %conv3, %if.end ], [ -11, %land.lhs.true ]
  ret i64 %retval.0
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @kmsg_release(%struct.inode* nocapture noundef readnone %inode, %struct.file* nocapture noundef readnone %file) #2 {
entry:
  %call = call i32 @do_syslog(i32 noundef 0, i8* noundef null, i32 noundef 0, i32 noundef 1) #3
  ret i32 0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @kmsg_poll(%struct.file* noundef %file, %struct.poll_table_struct* noundef %wait) #2 {
entry:
  call fastcc void @poll_wait(%struct.file* noundef %file, %struct.poll_table_struct* noundef %wait) #4
  %call = call i32 @do_syslog(i32 noundef 9, i8* noundef null, i32 noundef 0, i32 noundef 1) #3
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @do_syslog(i32 noundef, i8* noundef, i32 noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @poll_wait(%struct.file* noundef %filp, %struct.poll_table_struct* noundef %p) unnamed_addr #2 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  call void %0(%struct.file* noundef %filp, %struct.wait_queue_head* noundef nonnull @log_wait, %struct.poll_table_struct* noundef nonnull %p) #3
  br label %if.end
