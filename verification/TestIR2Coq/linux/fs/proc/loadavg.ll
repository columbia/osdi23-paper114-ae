; ModuleID = 'fs/proc/loadavg.c'
source_filename = "fs/proc/loadavg.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__245_33_proc_loadavg_init5:\09\09\09"
...
@__UNIQUE_ID___addressable_proc_loadavg_init246 = internal global i8* bitcast (i32 ()* @proc_loadavg_init to i8*), section ".discard.addressable", align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_loadavg_init246 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_loadavg_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @loadavg_proc_show, i8* noundef null) #6
  ret i32 0
}
...
define internal i32 @loadavg_proc_show(%struct.seq_file* noundef %m, i8* nocapture noundef readnone %v) #2 {
entry:
  %avnrun = alloca [3 x i64], align 8
  %0 = bitcast [3 x i64]* %avnrun to i8*
  ...
  %arraydecay = getelementptr inbounds [3 x i64], [3 x i64]* %avnrun, i64 0, i64 0
  call void @get_avenrun(i64* noundef nonnull %arraydecay, i64 noundef 10, i32 noundef 0) #6
  %1 = load i64, i64* %arraydecay, align 8
  %shr = lshr i64 %1, 11
  %and = and i64 %1, 2047
  %mul = mul nuw nsw i64 %and, 100
  %shr2 = lshr i64 %mul, 11
  %arrayidx3 = getelementptr inbounds [3 x i64], [3 x i64]* %avnrun, i64 0, i64 1
  %2 = load i64, i64* %arrayidx3, align 8
  %shr4 = lshr i64 %2, 11
  %and6 = and i64 %2, 2047
  %mul7 = mul nuw nsw i64 %and6, 100
  %shr8 = lshr i64 %mul7, 11
  %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* %avnrun, i64 0, i64 2
  %3 = load i64, i64* %arrayidx9, align 8
  %shr10 = lshr i64 %3, 11
  %and12 = and i64 %3, 2047
  %mul13 = mul nuw nsw i64 %and12, 100
  %shr14 = lshr i64 %mul13, 11
  %call = call i32 @nr_running() #6
  %4 = load i32, i32* @nr_threads, align 4
  %5 = call i64 asm "mrs $0, sp_el0", "=r"() #8, !srcloc !8
  %6 = inttoptr i64 %5 to %struct.task_struct*
  %call16 = call %struct.pid_namespace* @task_active_pid_ns(%struct.task_struct* noundef %6) #6
  %idr = getelementptr inbounds %struct.pid_namespace, %struct.pid_namespace* %call16, i64 0, i32 0
  %call17 = call fastcc i32 @idr_get_cursor(%struct.idr* noundef %idr) #9
  %sub = add i32 %call17, -1
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i64 noundef %shr, i64 noundef %shr2, i64 noundef %shr4, i64 noundef %shr8, i64 noundef %shr10, i64 noundef %shr14, i32 noundef %call, i32 noundef %4, i32 noundef %sub) #6
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @get_avenrun(i64* noundef, i64 noundef, i32 noundef) local_unnamed_addr #1
...
define internal fastcc i32 @idr_get_cursor(%struct.idr* noundef %idr) unnamed_addr #5 {
entry:
