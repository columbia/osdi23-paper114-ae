; ModuleID = 'fs/proc/softirqs.c'
source_filename = "fs/proc/softirqs.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__234_33_proc_softirqs_init5:\09\09\09"
...
@__UNIQUE_ID___addressable_proc_softirqs_init235 = internal global i8* bitcast (i32 ()* @proc_softirqs_init to i8*), section ".discard.addressable", align 8
...
@softirq_to_name = external dso_local local_unnamed_addr constant [10 x i8*], align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_softirqs_init235 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_softirqs_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @show_softirqs, i8* noundef null) #5
  ret i32 0
}
...
define internal i32 @show_softirqs(%struct.seq_file* noundef %p, i8* nocapture noundef readnone %v) #2 {
entry:
  call void @seq_puts(%struct.seq_file* noundef %p, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0)) #5
  %call26 = call i32 @cpumask_next(i32 noundef -1, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #6
  %0 = load i32, i32* @nr_cpu_ids, align 4
  %cmp27 = icmp ult i32 %call26, %0
  br i1 %cmp27, label %for.body, label %for.end

for.body:                                         ; preds = %entry, %for.body
  %call28 = phi i32 [ %call, %for.body ], [ %call26, %entry ]
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %p, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i32 noundef %call28) #5
  %call = call i32 @cpumask_next(i32 noundef %call28, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #6
  %1 = load i32, i32* @nr_cpu_ids, align 4
  %cmp = icmp ult i32 %call, %1
  br i1 %cmp, label %for.body, label %for.end

for.end:                                          ; preds = %for.body, %entry
  call void @seq_putc(%struct.seq_file* noundef %p, i8 noundef 10) #5
  br label %for.body3

for.body3:                                        ; preds = %for.end, %for.end9
  %indvars.iv = phi i64 [ 0, %for.end ], [ %indvars.iv.next, %for.end9 ]
  %arrayidx = getelementptr [10 x i8*], [10 x i8*]* @softirq_to_name, i64 0, i64 %indvars.iv
  %2 = load i8*, i8** %arrayidx, align 8
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %p, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i8* noundef %2) #5
  %call529 = call i32 @cpumask_next(i32 noundef -1, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #6
  %3 = load i32, i32* @nr_cpu_ids, align 4
  %cmp630 = icmp ult i32 %call529, %3
  br i1 %cmp630, label %for.body7.preheader, label %for.end9
...
for.body7:                                        ; preds = %for.body7.preheader, %for.body7
  %call531 = phi i32 [ %call5, %for.body7 ], [ %call529, %for.body7.preheader ]
  %call8 = call fastcc i32 @kstat_softirqs_cpu(i32 noundef %4, i32 noundef %call531) #7
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %p, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32 noundef %call8) #5
  %call5 = call i32 @cpumask_next(i32 noundef %call531, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #6
  %5 = load i32, i32* @nr_cpu_ids, align 4
  %cmp6 = icmp ult i32 %call5, %5
  br i1 %cmp6, label %for.body7, label %for.end9

for.end9:                                         ; preds = %for.body7, %for.body3
  call void @seq_putc(%struct.seq_file* noundef %p, i8 noundef 10) #5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 10
  br i1 %exitcond.not, label %for.end10, label %for.body3
...
define internal fastcc i32 @kstat_softirqs_cpu(i32 noundef %irq, i32 noundef %cpu) unnamed_addr #4 {
entry:
