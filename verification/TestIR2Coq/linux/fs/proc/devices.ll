; ModuleID = 'fs/proc/devices.c'
source_filename = "fs/proc/devices.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__403_60_proc_devices_init5:\09\09\09"
...
%struct.kernfs_node = type { %struct.atomic_t, %struct.atomic_t, %struct.kernfs_node*, i8*, %struct.rb_node, i8*, i32, %union.anon.57, i8*, i64, i16, i16, %struct.kernfs_iattrs* }
%struct.rb_node = type { i64, %struct.rb_node*, %struct.rb_node* }
%union.anon.57 = type { %struct.kernfs_elem_dir }
...
%struct.bio = type { %struct.bio*, %struct.block_device*, i32, i16, i16, i16, i8, %struct.atomic_t, %struct.bvec_iter, void (%struct.bio*)*, i8*, %union.anon.32, i16, i16, %struct.atomic_t, %struct.bio_vec*, %struct.bio_set*, [0 x %struct.bio_vec] }
%struct.bvec_iter = type { i64, i32, i32, i32 }
%union.anon.32 = type {}
%struct.bio_vec = type { %struct.page*, i32, i32 }
%struct.page = type { i64, %union.anon.6, %union.anon.52, %struct.atomic_t, [8 x i8] }
...
%struct.request = type { %struct.request_queue*, %struct.blk_mq_ctx*, %struct.blk_mq_hw_ctx*, i32, i32, i32, i32, i32, i64, %struct.bio*, %struct.bio*, %struct.list_head, %union.anon.58, %union.anon.59, %union.anon.60, %struct.gendisk*, %struct.block_device*, i64, i64, i16, i16, i16, i16, i32, %struct.refcount_struct, i32, i64, %union.anon.63, void (%struct.request*, i8)*, i8* }
%struct.blk_mq_hw_ctx = type opaque
%union.anon.58 = type { %struct.hlist_node }
%union.anon.59 = type { %struct.rb_node }
%union.anon.60 = type { %struct.anon.62 }
%struct.anon.62 = type { i32, %struct.list_head, void (%struct.request*, i8)* }
%union.anon.63 = type { %struct.__call_single_data }
...
@__UNIQUE_ID___addressable_proc_devices_init404 = internal global i8* bitcast (i32 ()* @proc_devices_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [8 x i8] c"devices\00", align 1
@devinfo_ops = internal constant %struct.seq_operations { i8* (%struct.seq_file*, i64*)* @devinfo_start, void (%struct.seq_file*, i8*)* @devinfo_stop, i8* (%struct.seq_file*, i8*, i64*)* @devinfo_next, i32 (%struct.seq_file*, i8*)* @devinfo_show }, align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_devices_init404 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_devices_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_seq_private(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, %struct.seq_operations* noundef nonnull @devinfo_ops, i32 noundef 0, i8* noundef null) #6
  ret i32 0
}
...
define internal i8* @devinfo_start(%struct.seq_file* nocapture noundef readnone %f, i64* noundef readonly %pos) #2 {
entry:
  %0 = load i64, i64* %pos, align 8
  %cmp = icmp slt i64 %0, 1024
  %1 = bitcast i64* %pos to i8*
  %retval.0 = select i1 %cmp, i8* %1, i8* null
  ret i8* %retval.0
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal void @devinfo_stop(%struct.seq_file* nocapture noundef %f, i8* nocapture noundef %v) #3 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal i8* @devinfo_next(%struct.seq_file* nocapture noundef readnone %f, i8* nocapture noundef readnone %v, i64* noundef %pos) #4 {
entry:
  %0 = load i64, i64* %pos, align 8
  %inc = add i64 %0, 1
  store i64 %inc, i64* %pos, align 8
  %cmp = icmp sgt i64 %inc, 1023
  %1 = bitcast i64* %pos to i8*
...
define internal i32 @devinfo_show(%struct.seq_file* noundef %f, i8* nocapture noundef readonly %v) #5 {
entry:
...
if.then4:                                         ; preds = %if.then
  call void @seq_puts(%struct.seq_file* noundef %f, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0)) #6
  br label %if.end

if.end:                                           ; preds = %if.then4, %if.then
  %sext = shl i64 %1, 32
  %conv5 = ashr exact i64 %sext, 32
  call void @chrdev_show(%struct.seq_file* noundef %f, i64 noundef %conv5) #6
  br label %if.end11
...
if.then8:                                         ; preds = %if.else
  call void @seq_puts(%struct.seq_file* noundef %f, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0)) #6
  br label %if.end9

if.end9:                                          ; preds = %if.then8, %if.else
  %2 = zext i32 %sub to i64
  call void @blkdev_show(%struct.seq_file* noundef %f, i64 noundef %2) #6
  br label %if.end11
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @chrdev_show(%struct.seq_file* noundef, i64 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @blkdev_show(%struct.seq_file* noundef, i64 noundef) local_unnamed_addr #1
