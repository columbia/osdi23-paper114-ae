...
@proc_self_inode_operations = internal constant %struct.inode_operations { %struct.dentry* (%struct.inode*, %struct.dentry*, i32)* null, i8* (%struct.dentry*, %struct.inode*, %struct.delayed_call*)* @proc_self_get_link, i32 (%struct.user_namespace*, %struct.inode*, i32)* null, %struct.posix_acl* (%struct.inode*, i32, i1)* null, i32 (%struct.dentry*, i8*, i32)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, i16, i1)* null, i32 (%struct.dentry*, %struct.inode*, %struct.dentry*)* null, i32 (%struct.inode*, %struct.dentry*)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, i8*)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, i16)* null, i32 (%struct.inode*, %struct.dentry*)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, i16, i32)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, %struct.inode*, %struct.dentry*, i32)* null, i32 (%struct.user_namespace*, %struct.dentry*, %struct.iattr*)* null, i32 (%struct.user_namespace*, %struct.path*, %struct.kstat*, i32, i32)* null, i64 (%struct.dentry*, i8*, i64)* null, i32 (%struct.inode*, %struct.fiemap_extent_info*, i64, i64)* null, i32 (%struct.inode*, %struct.timespec64*, i32)* null, i32 (%struct.inode*, %struct.dentry*, %struct.file*, i32, i16)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.dentry*, i16)* null, i32 (%struct.user_namespace*, %struct.inode*, %struct.posix_acl*, i32)* null, i32 (%struct.user_namespace*, %struct.dentry*, %struct.fileattr*)* null, i32 (%struct.dentry*, %struct.fileattr*)* null, [8 x i8] undef }, align 64
...
define dso_local i32 @proc_setup_self(%struct.super_block* noundef %s) local_unnamed_addr #0 {
entry:
  ...
  %call3 = call %struct.dentry* @d_alloc_name(%struct.dentry* noundef %1, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #9
...
do.end:                                           ; preds = %entry, %if.else
  ...
  %call14 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0)) #10
  br label %if.end16

if.else15:                                        ; preds = %if.then
  %2 = load i32, i32* @self_inum, align 4
  ...
  store %struct.inode_operations* @proc_self_inode_operations, %struct.inode_operations** %i_op, align 8
  ...
  store %struct.dentry* %call3, %struct.dentry** %proc_self, align 8
  br label %if.end16
...
entry:
  %call = call i32 @proc_alloc_inum(i32* noundef nonnull @self_inum) #9
  ret void
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i8* @proc_self_get_link(%struct.dentry* noundef readnone %dentry, %struct.inode* nocapture noundef readonly %inode, %struct.delayed_call* nocapture noundef writeonly %done) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %call3 = call fastcc i8* @ERR_PTR(i64 noundef -2) #8
  br label %cleanup

if.end:                                           ; preds = %entry
  %tobool4.not = icmp eq %struct.dentry* %dentry, null
  %cond = select i1 %tobool4.not, i32 2592, i32 3264
  ...
  %tobool6.not = icmp eq i8* %call.i.i, null
  br i1 %tobool6.not, label %if.then10, label %if.end15, !prof !8

if.then10:                                        ; preds = %if.end
  br i1 %tobool4.not, label %cond.false, label %cond.true

cond.true:                                        ; preds = %if.then10
  %call12 = call fastcc i8* @ERR_PTR(i64 noundef -12) #8
  br label %cleanup

cond.false:                                       ; preds = %if.then10
  %call13 = call fastcc i8* @ERR_PTR(i64 noundef -10) #8
  br label %cleanup

if.end15:                                         ; preds = %if.end
  %call16 = call i32 (i8*, i8*, ...) @sprintf(i8* noundef nonnull %call.i.i, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 noundef %call2) #9
  call fastcc void @set_delayed_call(%struct.delayed_call* noundef %done, i8* noundef nonnull %call.i.i) #8
  br label %cleanup

cleanup:                                          ; preds = %cond.true, %cond.false, %if.end15, %if.then
  %retval.0 = phi i8* [ %call.i.i, %if.end15 ], [ %call3, %if.then ], [ %call12, %cond.true ], [ %call13, %cond.false ]
  ret i8* %retval.0
}
