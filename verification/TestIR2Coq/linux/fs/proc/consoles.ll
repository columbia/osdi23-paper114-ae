; ModuleID = 'fs/proc/consoles.c'
source_filename = "fs/proc/consoles.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__210_98_proc_consoles_init5:\09\09\09"
...
@__UNIQUE_ID___addressable_proc_consoles_init211 = internal global i8* bitcast (i32 ()* @proc_consoles_init to i8*), section ".discard.addressable", align 8
@.str = private unnamed_addr constant [9 x i8] c"consoles\00", align 1
@consoles_op = internal constant %struct.seq_operations { i8* (%struct.seq_file*, i64*)* @c_start, void (%struct.seq_file*, i8*)* @c_stop, i8* (%struct.seq_file*, i8*, i64*)* @c_next, i32 (%struct.seq_file*, i8*)* @show_console_dev }, align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_consoles_init211 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_consoles_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_seq_private(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, %struct.seq_operations* noundef nonnull @consoles_op, i32 noundef 0, i8* noundef null) #5
  ret i32 0
}
...
define internal i8* @c_start(%struct.seq_file* nocapture noundef readnone %m, i64* nocapture noundef readonly %pos) #2 {
entry:
  call void @console_lock() #5
  %con.06 = load %struct.console*, %struct.console** @console_drivers, align 8
  %cmp.not7 = icmp eq %struct.console* %con.06, null
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %con.09 = phi %struct.console* [ %con.06, %for.body.lr.ph ], [ %con.0, %for.inc ]
  %off.08 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %for.inc ]
  %cmp1 = icmp eq i64 %off.08, %0
  br i1 %cmp1, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add i64 %off.08, 1
  %next = getelementptr inbounds %struct.console, %struct.console* %con.09, i64 0, i32 12
...
for.end:                                          ; preds = %for.inc, %for.body, %entry
  %con.0.lcssa = phi %struct.console* [ null, %entry ], [ %con.09, %for.body ], [ null, %for.inc ]
  %1 = getelementptr %struct.console, %struct.console* %con.0.lcssa, i64 0, i32 0, i64 0
  ret i8* %1
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal void @c_stop(%struct.seq_file* nocapture noundef readnone %m, i8* nocapture noundef readnone %v) #2 {
entry:
  call void @console_unlock() #5
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal i8* @c_next(%struct.seq_file* nocapture noundef readnone %m, i8* nocapture noundef readonly %v, i64* nocapture noundef %pos) #3 {
entry:
  %0 = load i64, i64* %pos, align 8
  %inc = add i64 %0, 1
  store i64 %inc, i64* %pos, align 8
  %next = getelementptr inbounds i8, i8* %v, i64 88
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @show_console_dev(%struct.seq_file* noundef %m, i8* noundef %v) #2 {
entry:
  %flags = alloca [7 x i8], align 4
  %index = alloca i32, align 4
  %0 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 7, i8* nonnull %0) #6
  %device = getelementptr inbounds i8, i8* %v, i64 32
  %1 = bitcast i8* %device to %struct.tty_driver* (%struct.console*, i32*)**
  %2 = load %struct.tty_driver* (%struct.console*, i32*)*, %struct.tty_driver* (%struct.console*, i32*)** %1, align 8
  %tobool.not = icmp eq %struct.tty_driver* (%struct.console*, i32*)* %2, null
  br i1 %tobool.not, label %if.end4, label %if.then

if.then:                                          ; preds = %entry
  %3 = bitcast i8* %v to %struct.console*
  %4 = bitcast i32* %index to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #6
  store i32 0, i32* %index, align 4, !annotation !7
  %call = call %struct.tty_driver* %2(%struct.console* noundef %3, i32* noundef nonnull %index) #5
...
if.then3:                                         ; preds = %if.then
  ...
  %shl = shl i32 %5, 20
  %minor_start = getelementptr inbounds %struct.tty_driver, %struct.tty_driver* %call, i64 0, i32 8
  %6 = load i32, i32* %minor_start, align 8
  %or = or i32 %shl, %6
...
if.end:                                           ; preds = %if.then3, %if.then
  %dev.0 = phi i32 [ %add, %if.then3 ], [ 0, %if.then ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #6
  br label %if.end4

if.end4:                                          ; preds = %if.end, %entry
  %dev.1 = phi i32 [ %dev.0, %if.end ], [ 0, %entry ]
  %flags6 = getelementptr inbounds i8, i8* %v, i64 72
  %8 = bitcast i8* %flags6 to i16*
  %9 = load i16, i16* %8, align 8
  %and59 = and i16 %9, 4
  %tobool9.not = icmp eq i16 %and59, 0
  %spec.select = select i1 %tobool9.not, i8 32, i8 69
  store i8 %spec.select, i8* %0, align 4
  %and59.1 = and i16 %9, 2
  %tobool9.not.1 = icmp eq i16 %and59.1, 0
  %cond.1 = select i1 %tobool9.not.1, i8 32, i8 67
  %arrayidx15.1 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 1
  store i8 %cond.1, i8* %arrayidx15.1, align 1
  %and59.2 = and i16 %9, 8
  %tobool9.not.2 = icmp eq i16 %and59.2, 0
  %cond.2 = select i1 %tobool9.not.2, i8 32, i8 66
  %arrayidx15.2 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 2
  store i8 %cond.2, i8* %arrayidx15.2, align 2
  %and59.3 = and i16 %9, 1
  %tobool9.not.3 = icmp eq i16 %and59.3, 0
  %cond.3 = select i1 %tobool9.not.3, i8 32, i8 112
  %arrayidx15.3 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 3
  store i8 %cond.3, i8* %arrayidx15.3, align 1
  %and59.4 = and i16 %9, 32
  %tobool9.not.4 = icmp eq i16 %and59.4, 0
  %cond.4 = select i1 %tobool9.not.4, i8 32, i8 98
  %arrayidx15.4 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 4
  store i8 %cond.4, i8* %arrayidx15.4, align 4
  %and59.5 = and i16 %9, 16
  %tobool9.not.5 = icmp eq i16 %and59.5, 0
  %cond.5 = select i1 %tobool9.not.5, i8 32, i8 97
  %arrayidx15.5 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 5
  store i8 %cond.5, i8* %arrayidx15.5, align 1
  %arrayidx17 = getelementptr inbounds [7 x i8], [7 x i8]* %flags, i64 0, i64 6
  store i8 0, i8* %arrayidx17, align 2
  call fastcc void @seq_setwidth(%struct.seq_file* noundef %m) #7
  %index19 = getelementptr inbounds i8, i8* %v, i64 74
  %10 = bitcast i8* %index19 to i16*
  %11 = load i16, i16* %10, align 2
  %conv20 = sext i16 %11 to i32
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* noundef %v, i32 noundef %conv20) #5
  call void @seq_pad(%struct.seq_file* noundef %m, i8 noundef 32) #5
  %read = getelementptr inbounds i8, i8* %v, i64 24
  %12 = bitcast i8* %read to i32 (%struct.console*, i8*, i32)**
  %13 = load i32 (%struct.console*, i8*, i32)*, i32 (%struct.console*, i8*, i32)** %12, align 8
  %tobool21.not = icmp eq i32 (%struct.console*, i8*, i32)* %13, null
  %cond22 = select i1 %tobool21.not, i32 45, i32 82
  %write = getelementptr inbounds i8, i8* %v, i64 16
  %14 = bitcast i8* %write to void (%struct.console*, i8*, i32)**
  %15 = load void (%struct.console*, i8*, i32)*, void (%struct.console*, i8*, i32)** %14, align 8
  %tobool23.not = icmp eq void (%struct.console*, i8*, i32)* %15, null
  %cond24 = select i1 %tobool23.not, i32 45, i32 87
  %unblank = getelementptr inbounds i8, i8* %v, i64 40
  %16 = bitcast i8* %unblank to void ()**
  %17 = load void ()*, void ()** %16, align 8
  %tobool25.not = icmp eq void ()* %17, null
  %cond26 = select i1 %tobool25.not, i32 45, i32 85
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i32 noundef %cond22, i32 noundef %cond24, i32 noundef %cond26, i8* noundef nonnull %0) #5
  %tobool28.not = icmp eq i32 %dev.1, 0
  br i1 %tobool28.not, label %if.end31, label %if.then29

if.then29:                                        ; preds = %if.end4
  %shr = lshr i32 %dev.1, 20
  %and30 = and i32 %dev.1, 1048575
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0), i32 noundef %shr, i32 noundef %and30) #5
  br label %if.end31

if.end31:                                         ; preds = %if.then29, %if.end4
  call void @seq_putc(%struct.seq_file* noundef %m, i8 noundef 10) #5
  call void @llvm.lifetime.end.p0i8(i64 7, i8* nonnull %0) #6
  ret i32 0
}
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn
define internal fastcc void @seq_setwidth(%struct.seq_file* nocapture noundef %m) unnamed_addr #3 {
entry:
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @seq_pad(%struct.seq_file* noundef, i8 noundef) local_unnamed_addr #1
