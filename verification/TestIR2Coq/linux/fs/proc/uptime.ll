; ModuleID = 'fs/proc/uptime.c'
source_filename = "fs/proc/uptime.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

module asm ".section\09\22.initcall5.init\22, \22a\22\09\09"
module asm "__initcall__kmod_proc__234_41_proc_uptime_init5:\09\09\09"
...
%struct.page = type { i64, %union.anon.17, %union.anon.32, %struct.atomic_t, [8 x i8] }
...
@__UNIQUE_ID___addressable_proc_uptime_init235 = internal global i8* bitcast (i32 ()* @proc_uptime_init to i8*), section ".discard.addressable", align 8
...
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_proc_uptime_init235 to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline nounwind null_pointer_is_valid optsize
define internal i32 @proc_uptime_init() #0 section ".init.text" {
entry:
  %call = call %struct.proc_dir_entry* @proc_create_single_data(i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i16 noundef 0, %struct.proc_dir_entry* noundef null, i32 (%struct.seq_file*, i8*)* noundef nonnull @uptime_proc_show, i8* noundef null) #7
  ret i32 0
}
...
define internal i32 @uptime_proc_show(%struct.seq_file* noundef %m, i8* nocapture noundef readnone %v) #2 {
entry:
  %uptime = alloca %struct.timespec64, align 8
  %rem = alloca i32, align 4
  %0 = bitcast %struct.timespec64* %uptime to i8*
  ...
  %call22 = call i32 @cpumask_next(i32 noundef -1, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #9
  %cmp23 = icmp ult i32 %call22, %2
  br i1 %cmp23, label %do.body, label %for.end

do.body:                                          ; preds = %entry, %do.body
  %call25 = phi i32 [ %call, %do.body ], [ %call22, %entry ]
  %nsec.024 = phi i64 [ %add3, %do.body ], [ 0, %entry ]
  %idxprom = sext i32 %call25 to i64
  %arrayidx = getelementptr [256 x i64], [256 x i64]* @__per_cpu_offset, i64 0, i64 %idxprom
  %3 = load i64, i64* %arrayidx, align 8
  %add = add i64 %3, ptrtoint (%struct.kernel_cpustat* @kernel_cpustat to i64)
  %4 = inttoptr i64 %add to %struct.kernel_cpustat*
  %arrayidx2 = getelementptr %struct.kernel_cpustat, %struct.kernel_cpustat* %4, i64 0, i32 0, i64 5
  %5 = load i64, i64* %arrayidx2, align 8
  %add3 = add i64 %5, %nsec.024
  %call = call i32 @cpumask_next(i32 noundef %call25, %struct.cpumask* noundef nonnull @__cpu_possible_mask) #9
  %cmp = icmp ult i32 %call, %2
  br i1 %cmp, label %do.body, label %for.end

for.end:                                          ; preds = %do.body, %entry
  %nsec.0.lcssa = phi i64 [ 0, %entry ], [ %add3, %do.body ]
  call fastcc void @ktime_get_boottime_ts64(%struct.timespec64* noundef nonnull %uptime) #10
  %call4 = call fastcc i64 @div_u64_rem(i64 noundef %nsec.0.lcssa, i32* noundef nonnull %rem) #10
  %6 = load i32, i32* %rem, align 4
  %tv_sec5 = getelementptr inbounds %struct.timespec64, %struct.timespec64* %uptime, i64 0, i32 0
  %7 = load i64, i64* %tv_sec5, align 8
  %tv_nsec6 = getelementptr inbounds %struct.timespec64, %struct.timespec64* %uptime, i64 0, i32 1
  %8 = load i64, i64* %tv_nsec6, align 8
  %div = sdiv i64 %8, 10000000
  %9 = udiv i32 %6, 10000000
  %div9 = zext i32 %9 to i64
  call void (%struct.seq_file*, i8*, ...) @seq_printf(%struct.seq_file* noundef %m, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i64 noundef %7, i64 noundef %div, i64 noundef %call4, i64 noundef %div9) #7
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @ktime_get_boottime_ts64(%struct.timespec64* nocapture noundef writeonly %ts) unnamed_addr #2 {
entry:
  %call = call fastcc i64 @ktime_get_boottime() #10
  %call1 = call [2 x i64] @ns_to_timespec64(i64 noundef %call) #7
...
define internal fastcc i64 @div_u64_rem(i64 noundef %dividend, i32* nocapture noundef writeonly %remainder) unnamed_addr #6 {
entry:
  %div = udiv i64 %dividend, 1000000000
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @ktime_get_boottime() unnamed_addr #2 {
entry:
  %call = call i64 @ktime_get_with_offset(i32 noundef 1) #7
  ret i64 %call
}
