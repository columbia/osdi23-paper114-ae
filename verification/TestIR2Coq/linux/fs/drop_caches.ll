...
define dso_local i32 @drop_caches_sysctl_handler(%struct.ctl_table* noundef %table, i32 noundef %write, i8* noundef %buffer, i64* noundef %length, i64* noundef %ppos) local_unnamed_addr #0 {
entry:
  %call = call i32 @proc_dointvec_minmax(%struct.ctl_table* noundef %table, i32 noundef %write, i8* noundef %buffer, i64* noundef %length, i64* noundef %ppos) #7
...
if.then2:                                         ; preds = %entry
  %0 = load i32, i32* @sysctl_drop_caches, align 4
  %and = and i32 %0, 1
  %tobool3.not = icmp eq i32 %and, 0
  br i1 %tobool3.not, label %if.end5, label %if.then4

if.then4:                                         ; preds = %if.then2
  call void @iterate_supers(void (%struct.super_block*, i8*)* noundef nonnull @drop_pagecache_sb, i8* noundef null) #7
  call fastcc void @count_vm_event(i32 noundef 43) #8
  %.pre = load i32, i32* @sysctl_drop_caches, align 4
  br label %if.end5

if.end5:                                          ; preds = %if.then4, %if.then2
  %1 = phi i32 [ %.pre, %if.then4 ], [ %0, %if.then2 ]
  %and6 = and i32 %1, 2
  %tobool7.not = icmp eq i32 %and6, 0
  br i1 %tobool7.not, label %if.end9, label %if.then8

if.then8:                                         ; preds = %if.end5
  call void @drop_slab() #7
  call fastcc void @count_vm_event(i32 noundef 44) #8
  br label %if.end9

if.end9:                                          ; preds = %if.then8, %if.end5
  %2 = load i32, i32* @drop_caches_sysctl_handler.stfu, align 4
  %tobool10.not = icmp eq i32 %2, 0
  br i1 %tobool10.not, label %do.end, label %if.end16

do.end:                                           ; preds = %if.end9
  %3 = call i64 asm "mrs $0, sp_el0", "=r"() #9, !srcloc !8
  ...
  %call14 = call fastcc i32 @task_pid_nr(%struct.task_struct* noundef %4) #8
  %5 = load i32, i32* @sysctl_drop_caches, align 4
  %call15 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i8* noundef %arraydecay, i32 noundef %call14, i32 noundef %5) #10
  %.pre22 = load i32, i32* @drop_caches_sysctl_handler.stfu, align 4
  br label %if.end16

if.end16:                                         ; preds = %do.end, %if.end9
  %6 = phi i32 [ %.pre22, %do.end ], [ %2, %if.end9 ]
  %7 = load i32, i32* @sysctl_drop_caches, align 4
  %and17 = and i32 %7, 4
  %or = or i32 %6, %and17
  store i32 %or, i32* @drop_caches_sysctl_handler.stfu, align 4
  br label %cleanup
...
declare dso_local i32 @proc_dointvec_minmax(%struct.ctl_table* noundef, i32 noundef, i8* noundef, i64* noundef, i64* noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @iterate_supers(void (%struct.super_block*, i8*)* noundef, i8* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal void @drop_pagecache_sb(%struct.super_block* noundef %sb, i8* nocapture noundef readnone %unused) #0 {
entry:
  ...
  %0 = bitcast %struct.list_head* %s_inodes to i8**
  %.pn45 = load i8*, i8** %0, align 8
  %1 = bitcast i8* %.pn45 to %struct.list_head*
  %cmp.not48 = icmp eq %struct.list_head* %s_inodes, %1
  br i1 %cmp.not48, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %.pn51 = phi i8* [ %.pn, %for.inc ], [ %.pn45, %entry ]
  %toput_inode.049 = phi %struct.inode* [ %toput_inode.1, %for.inc ], [ null, %entry ]
  %inode.054.in = getelementptr i8, i8* %.pn51, i64 -240
  %inode.054 = bitcast i8* %inode.054.in to %struct.inode*
  %i_lock = getelementptr i8, i8* %.pn51, i64 -128
  %rlock.i39 = bitcast i8* %i_lock to %struct.raw_spinlock*
  call fastcc void @__raw_spin_lock(%struct.raw_spinlock* noundef %rlock.i39) #7
  %i_state = getelementptr i8, i8* %.pn51, i64 -112
  %2 = bitcast i8* %i_state to i64*
...
lor.lhs.false:                                    ; preds = %for.body
  %i_mapping = getelementptr i8, i8* %.pn51, i64 -208
  %4 = bitcast i8* %i_mapping to %struct.address_space**
  %5 = load %struct.address_space*, %struct.address_space** %4, align 8
  %call = call fastcc i1 @mapping_empty(%struct.address_space* noundef %5) #8
...
land.lhs.true:                                    ; preds = %lor.lhs.false
  ...
  %call1.i = call fastcc i32 @test_ti_thread_flag(%struct.thread_info* noundef %8) #7
  %tobool.i.not = icmp eq i32 %call1.i, 0
  br i1 %tobool.i.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true, %for.body
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i39) #7
  br label %for.inc

if.end:                                           ; preds = %land.lhs.true, %lor.lhs.false
  call void @__iget(%struct.inode* noundef %inode.054) #7
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i39) #7
  ...
  %call7 = call i64 @invalidate_mapping_pages(%struct.address_space* noundef %9, i64 noundef 0, i64 noundef -1) #7
  call void @iput(%struct.inode* noundef %toput_inode.049) #7
  call fastcc void @_cond_resched() #8
  call fastcc void @__raw_spin_lock(%struct.raw_spinlock* noundef %rlock.i) #7
  br label %for.inc

for.inc:                                          ; preds = %if.end, %if.then
  %toput_inode.1 = phi %struct.inode* [ %toput_inode.049, %if.then ], [ %inode.054, %if.end ]
  %10 = bitcast i8* %.pn51 to i8**
  %.pn = load i8*, i8** %10, align 8
  %11 = bitcast i8* %.pn to %struct.list_head*
  %cmp.not = icmp eq %struct.list_head* %s_inodes, %11
  br i1 %cmp.not, label %for.end, label %for.body

for.end:                                          ; preds = %for.inc, %entry
  %toput_inode.0.lcssa = phi %struct.inode* [ null, %entry ], [ %toput_inode.1, %for.inc ]
  call fastcc void @__raw_spin_unlock(%struct.raw_spinlock* noundef %rlock.i) #7
  call void @iput(%struct.inode* noundef %toput_inode.0.lcssa) #7
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @count_vm_event(i32 noundef %item) unnamed_addr #0 {
entry:
  ...
  call fastcc void @__percpu_add_case_64(i8* noundef %1) #8
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readonly willreturn
define internal fastcc i1 @mapping_empty(%struct.address_space* nocapture noundef readonly %mapping) unnamed_addr #3 {
entry:
  %i_pages = getelementptr inbounds %struct.address_space, %struct.address_space* %mapping, i64 0, i32 1
  %call = call fastcc i1 @xa_empty(%struct.xarray* noundef %i_pages) #8
  ret i1 %call
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @__iget(%struct.inode* noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @invalidate_mapping_pages(%struct.address_space* noundef, i64 noundef, i64 noundef) local_unnamed_addr #1
...
entry:
  ...
  %1 = call { i32, i64 } asm sideeffect "1:\09ldxr\09$1, $2\0Aadd\09$1, $1, $3\0A\09stxr\09${0:w}, $1, $2\0A\09cbnz\09${0:w}, 1b", "=&r,=&r,=*Q,r,*Q"(i64* elementtype(i64) %0, i64 1, i64* elementtype(i64) %0) #11, !srcloc !16
  ret void
}
...
!13 = !{i64 2148079889, i64 2148079922, i64 2148079975, i64 2148080034, i64 2148080068, i64 2148080123, i64 2148080152, i64 2148080172}
!14 = !{i64 2149576893}
!15 = !{i64 2149369123}
!16 = !{i64 2149168703, i64 2149168744, i64 2149168800, i64 2149168852}
!17 = !{i64 2149142757, i64 2149142804, i64 2149142810, i64 2149142847, i64 2149142865, i64 2149143792, i64 2149143840, i64 2149143888, i64 2149143951, i64 2149144000, i64 2149142943, i64 2149142968, i64 2149142994, i64 2149143000, i64 2149143037, i64 2149143043, i64 2149143093, i64 2149143139, i64 2149143172}
