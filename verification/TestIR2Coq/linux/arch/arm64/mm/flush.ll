; ModuleID = 'arch/arm64/mm/flush.c'
source_filename = "arch/arm64/mm/flush.c"
...
%struct.anon.45 = type { i64, i8, i8, %struct.atomic_t, i32 }

@memstart_addr = external dso_local local_unnamed_addr global i64, align 8
@__icache_flags = external dso_local global i64, align 8
...
define dso_local void @sync_icache_aliases(i64 noundef %start, i64 noundef %end) local_unnamed_addr #0 {
entry:
  %call = call fastcc i32 @icache_is_aliasing() #3
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  call void @dcache_clean_pou(i64 noundef %start, i64 noundef %end) #4
  %call.i.i.i = call fastcc i32 @static_key_count(%struct.static_key* noundef getelementptr inbounds (%struct.static_key_false, %struct.static_key_false* @arm64_const_caps_ready, i64 0, i32 0)) #4
...
if.then3.i.i:                                     ; preds = %if.then
  %call.i1.i.i = call fastcc i32 @static_key_count(%struct.static_key* noundef getelementptr inbounds ([61 x %struct.static_key_false], [61 x %struct.static_key_false]* @cpu_hwcap_keys, i64 0, i64 8, i32 0)) #4
  %cmp1.i.i.i = icmp sgt i32 %call.i1.i.i, 0
  br i1 %cmp1.i.i.i, label %if.end, label %if.end.i

cpus_have_const_cap.exit.i:                       ; preds = %if.then
  %call6.i.i = call fastcc i1 @cpus_have_cap() #4
  br i1 %call6.i.i, label %if.end, label %if.end.i

if.end.i:                                         ; preds = %cpus_have_const_cap.exit.i, %if.then3.i.i
  call void asm sideeffect "ic\09ialluis", ""() #5, !srcloc !7
  call void asm sideeffect "dsb ish", "~{memory}"() #5, !srcloc !8
  br label %if.end

if.else:                                          ; preds = %entry
  call void @caches_clean_inval_pou(i64 noundef %start, i64 noundef %end) #4
  br label %if.end

if.end:                                           ; preds = %if.end.i, %cpus_have_const_cap.exit.i, %if.then3.i.i, %if.else
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i32 @icache_is_aliasing() unnamed_addr #1 {
entry:
  %0 = load volatile i64, i64* @__icache_flags, align 8
...
declare dso_local void @dcache_clean_pou(i64 noundef, i64 noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @caches_clean_inval_pou(i64 noundef, i64 noundef) local_unnamed_addr #2

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @copy_to_user_page(%struct.vm_area_struct* nocapture noundef readonly %vma, %struct.page* nocapture noundef readnone %page, i64 noundef %uaddr, i8* noundef %dst, i8* noundef %src, i64 noundef %len) local_unnamed_addr #0 {
entry:
  %call = call i8* @memcpy(i8* noundef %dst, i8* noundef %src, i64 noundef %len) #4
  %0 = ptrtoint i8* %dst to i64
  %add = add i64 %0, %len
  call fastcc void @flush_ptrace_access(%struct.vm_area_struct* noundef %vma, i64 noundef %0, i64 noundef %add) #3
  ret void
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @flush_ptrace_access(%struct.vm_area_struct* nocapture noundef readonly %vma, i64 noundef %start, i64 noundef %end) unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  call void @sync_icache_aliases(i64 noundef %start, i64 noundef %end) #3
  br label %if.end
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @__sync_icache_dcache(i64 %pte.coerce) local_unnamed_addr #0 {
entry:
  ...
  %flags = getelementptr inbounds %struct.page, %struct.page* %add.ptr3, i64 0, i32 0
  %1 = load volatile i64, i64* %flags, align 64
  %2 = and i64 %1, 2048
  %tobool.not = icmp eq i64 %2, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = ptrtoint %struct.page* %add.ptr3 to i64
  %sub.i = shl i64 %3, 6
  %call6 = call fastcc i64 @page_size(%struct.page* noundef %add.ptr3) #3
  %add = add i64 %call6, %sub.i
  call void @sync_icache_aliases(i64 noundef %sub.i, i64 noundef %add) #3
  call fastcc void @set_bit(i64* noundef %flags) #3
  br label %if.end
...
; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i64 @page_size(%struct.page* noundef %page) unnamed_addr #1 {
entry:
  %call = call fastcc i32 @compound_order(%struct.page* noundef %page) #3
...
entry:
  ...
  call fastcc void @__ll_sc_atomic64_or(%struct.atomic64_t* noundef %0) #4
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @flush_dcache_page(%struct.page* noundef %page) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  call fastcc void @clear_bit(i64* noundef %flags) #3
  br label %if.end
...
entry:
  %0 = bitcast i64* %addr to %struct.atomic64_t*
  call fastcc void @__ll_sc_atomic64_andnot(%struct.atomic64_t* noundef %0) #4
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i1 @cpus_have_cap() unnamed_addr #1 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %3 = bitcast %union.anon.32* %2 to %struct.anon.45*
  %compound_order = getelementptr inbounds %struct.anon.45, %struct.anon.45* %3, i64 0, i32 2
...
entry:
  ...
  %0 = call { i64, i64 } asm sideeffect "// atomic64_or\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09orr\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,Lr,*Q"(i64* elementtype(i64) %counter, i64 2048, i64* elementtype(i64) %counter) #5, !srcloc !9
  ret void
}
...
entry:
  %counter = getelementptr inbounds %struct.atomic64_t, %struct.atomic64_t* %v, i64 0, i32 0
  %0 = call { i64, i64 } asm sideeffect "// atomic64_andnot\0A\09prfm\09pstl1strm, $2\0A1:\09ldxr\09$0, $2\0A\09bic\09$0, $0, $3\0A\09stxr\09${1:w}, $0, $2\0A\09cbnz\09${1:w}, 1b", "=&r,=&r,=*Q,r,*Q"(i64* elementtype(i64) %counter, i64 2048, i64* elementtype(i64) %counter) #5, !srcloc !10
  ret void
}
...
!7 = !{i64 5479434}
!8 = !{i64 2153644181}
!9 = !{i64 2148017348, i64 2148017859, i64 2148017889, i64 2148017915, i64 2148017947, i64 2148017976}
!10 = !{i64 2148027918, i64 2148028439, i64 2148028469, i64 2148028495, i64 2148028527, i64 2148028556}
