; ModuleID = 'arch/arm64/mm/pgd.c'
source_filename = "arch/arm64/mm/pgd.c"
...
define dso_local %struct.pgd_t* @pgd_alloc(%struct.mm_struct* nocapture noundef readnone %mm) local_unnamed_addr #0 {
entry:
  %call = call i64 @__get_free_pages(i32 noundef 4197824, i32 noundef 0) #3
  %0 = inttoptr i64 %call to %struct.pgd_t*
  ret %struct.pgd_t* %0
}
...
; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @pgd_free(%struct.mm_struct* nocapture noundef readnone %mm, %struct.pgd_t* noundef %pgd) local_unnamed_addr #0 {
entry:
  %0 = ptrtoint %struct.pgd_t* %pgd to i64
  call void @free_pages(i64 noundef %0, i32 noundef 0) #3
  ret void
}
...
define dso_local void @pgtable_cache_init() local_unnamed_addr #2 section ".init.text" {
entry:
  ret void
}
