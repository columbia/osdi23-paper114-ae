; ModuleID = 'arch/arm64/mm/copypage.c'
source_filename = "arch/arm64/mm/copypage.c"
...
define dso_local void @copy_highpage(%struct.page* noundef %to, %struct.page* noundef %from) local_unnamed_addr #0 {
entry:
  %0 = ptrtoint %struct.page* %to to i64
  %sub.i = shl i64 %0, 6
  %add.i = and i64 %sub.i, -4096
  %1 = inttoptr i64 %add.i to i8*
  %2 = ptrtoint %struct.page* %from to i64
  %sub.i12 = shl i64 %2, 6
  %add.i13 = and i64 %sub.i12, -4096
  %3 = inttoptr i64 %add.i13 to i8*
  call void @copy_page(i8* noundef %1, i8* noundef %3) #2
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @copy_page(i8* noundef, i8* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @copy_user_highpage(%struct.page* noundef %to, %struct.page* noundef %from, i64 noundef %vaddr, %struct.vm_area_struct* nocapture noundef readnone %vma) local_unnamed_addr #0 {
entry:
  call void @copy_highpage(%struct.page* noundef %to, %struct.page* noundef %from) #3
  call void @flush_dcache_page(%struct.page* noundef %to) #2
  ret void
}
