; ModuleID = 'arch/arm64/kernel/smp_spin_table.c'
source_filename = "arch/arm64/kernel/smp_spin_table.c"
...
@secondary_holding_pen_release = dso_local global i64 -1, section ".mmuoff.data.read", align 8
@.str = private unnamed_addr constant [11 x i8] c"spin-table\00", align 1
@smp_spin_table_ops = dso_local local_unnamed_addr constant %struct.cpu_operations { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 (i32)* @smp_spin_table_cpu_init, i32 (i32)* @smp_spin_table_cpu_prepare, i32 (i32)* @smp_spin_table_cpu_boot, void ()* null }, align 8
@.str.1 = private unnamed_addr constant [17 x i8] c"cpu-release-addr\00", align 1
@cpu_release_addr = internal global [256 x i64] zeroinitializer, align 8
...
define internal i32 @smp_spin_table_cpu_init(i32 noundef %cpu) #0 {
entry:
  %call = call %struct.device_node* @of_get_cpu_node(i32 noundef %cpu, i32* noundef null) #3
  %tobool.not = icmp eq %struct.device_node* %call, null
  br i1 %tobool.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %idxprom = zext i32 %cpu to i64
  %arrayidx = getelementptr [256 x i64], [256 x i64]* @cpu_release_addr, i64 0, i64 %idxprom
  %call1 = call i32 @of_property_read_u64(%struct.device_node* noundef nonnull %call, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i64* noundef %arrayidx) #3
  %tobool2.not = icmp eq i32 %call1, 0
  br i1 %tobool2.not, label %cleanup, label %do.end

do.end:                                           ; preds = %if.end
  %call4 = call i32 (i8*, ...) @_printk(i8* noundef getelementptr inbounds ([56 x i8], [56 x i8]* @.str.2, i64 0, i64 0), i32 noundef %cpu) #4
  br label %cleanup

cleanup:                                          ; preds = %if.end, %do.end, %entry
  %retval.0 = phi i32 [ -19, %entry ], [ %call1, %do.end ], [ 0, %if.end ]
  ret i32 %retval.0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @smp_spin_table_cpu_prepare(i32 noundef %cpu) #0 {
entry:
  %0 = load i64, i64* @kimage_voffset, align 8
  %sub = sub i64 ptrtoint (void ()* @secondary_holding_pen to i64), %0
  %idxprom = zext i32 %cpu to i64
  %arrayidx = getelementptr [256 x i64], [256 x i64]* @cpu_release_addr, i64 0, i64 %idxprom
...
if.end:                                           ; preds = %entry
  %call = call i8* @ioremap_cache(i64 noundef %1, i64 noundef 8) #3
  %tobool3.not = icmp eq i8* %call, null
  br i1 %tobool3.not, label %cleanup, label %if.end5

if.end5:                                          ; preds = %if.end
  call fastcc void @__raw_writeq(i64 noundef %sub, i8* noundef nonnull %call) #5
  %2 = ptrtoint i8* %call to i64
  %add6 = add i64 %2, 8
  call void @dcache_clean_inval_poc(i64 noundef %2, i64 noundef %add6) #3
  call void asm sideeffect "sev", "~{memory}"() #6, !srcloc !7
  call void @iounmap(i8* noundef nonnull %call) #3
  br label %cleanup

cleanup:                                          ; preds = %if.end, %entry, %if.end5
  %retval.0 = phi i32 [ 0, %if.end5 ], [ -19, %entry ], [ -12, %if.end ]
  ret i32 %retval.0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal i32 @smp_spin_table_cpu_boot(i32 noundef %cpu) #0 {
entry:
  %call = call i64 @cpu_logical_map(i32 noundef %cpu) #3
  call fastcc void @write_pen_release(i64 noundef %call) #5
  call void asm sideeffect "sev", "~{memory}"() #6, !srcloc !8
  ret i32 0
}

; Function Attrs: null_pointer_is_valid
declare dso_local %struct.device_node* @of_get_cpu_node(i32 noundef, i32* noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @of_property_read_u64(%struct.device_node* noundef, i8* noundef, i64* noundef) local_unnamed_addr #1

; Function Attrs: cold null_pointer_is_valid
declare dso_local i32 @_printk(i8* noundef, ...) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @secondary_holding_pen() #1

; Function Attrs: null_pointer_is_valid
declare dso_local i8* @ioremap_cache(i64 noundef, i64 noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @__raw_writeq(i64 noundef %val, i8* noundef %addr) unnamed_addr #0 {
entry:
  call void asm sideeffect "str ${0:x}, [$1]", "rZ,r"(i64 %val, i8* %addr) #6, !srcloc !9
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @dcache_clean_inval_poc(i64 noundef, i64 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @iounmap(i8* noundef) local_unnamed_addr #1

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @write_pen_release(i64 noundef %val) unnamed_addr #0 {
entry:
  store volatile i64 %val, i64* @secondary_holding_pen_release, align 8
  call void @dcache_clean_inval_poc(i64 noundef ptrtoint (i64* @secondary_holding_pen_release to i64), i64 noundef add (i64 ptrtoint (i64* @secondary_holding_pen_release to i64), i64 8)) #3
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local i64 @cpu_logical_map(i32 noundef) local_unnamed_addr #1
