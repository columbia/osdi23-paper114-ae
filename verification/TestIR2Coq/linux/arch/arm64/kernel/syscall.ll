; ModuleID = 'arch/arm64/kernel/syscall.c'
source_filename = "arch/arm64/kernel/syscall.c"
...
@sys_call_table = external dso_local local_unnamed_addr constant [0 x i64 (%struct.pt_regs*)*], align 8
@randomize_kstack_offset = external dso_local global %struct.static_key_false, align 4
@kstack_offset = external dso_local global i32, section ".data..percpu", align 4

; Function Attrs: noinline nounwind null_pointer_is_valid
define dso_local void @do_el0_svc(%struct.pt_regs* noundef %regs) local_unnamed_addr #0 {
entry:
  %arrayidx = getelementptr %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 0, i32 0, i32 0, i64 8
  %0 = load i64, i64* %arrayidx, align 8
  %conv = trunc i64 %0 to i32
  call fastcc void @el0_svc_common(%struct.pt_regs* noundef %regs, i32 noundef %conv) #8
  ret void
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @el0_svc_common(%struct.pt_regs* noundef %regs, i32 noundef %scno) unnamed_addr #0 {
entry:
  ...
  %2 = load i64, i64* %flags1, align 8
  %arrayidx = getelementptr %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 0, i32 0, i32 0, i64 0
  %3 = load i64, i64* %arrayidx, align 8
  %orig_x0 = getelementptr inbounds %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 1
  store i64 %3, i64* %orig_x0, align 8
  %syscallno = getelementptr inbounds %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 2
  store i32 %scno, i32* %syscallno, align 8
  call fastcc void @local_daif_restore() #8
  %and = and i64 %2, 32
  %tobool.not = icmp eq i64 %and, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  call fastcc void @syscall_set_return_value(%struct.task_struct* noundef %1, %struct.pt_regs* noundef %regs, i32 noundef -513, i64 noundef 0) #8
  br label %cleanup

if.end:                                           ; preds = %entry
  %call4 = call fastcc i1 @has_syscall_work(i64 noundef %2) #8
  br i1 %call4, label %if.then5, label %if.then15

if.then5:                                         ; preds = %if.end
  %cmp = icmp eq i32 %scno, -1
  br i1 %cmp, label %if.then6, label %if.end8

if.then6:                                         ; preds = %if.then5
  call fastcc void @syscall_set_return_value(%struct.task_struct* noundef %1, %struct.pt_regs* noundef %regs, i32 noundef -38, i64 noundef 0) #8
  br label %if.end8

if.end8:                                          ; preds = %if.then6, %if.then5
  %call9 = call i32 @syscall_trace_enter(%struct.pt_regs* noundef %regs) #10
  %cmp10 = icmp eq i32 %call9, -1
  br i1 %cmp10, label %trace_exit, label %if.end13.thread

if.end13.thread:                                  ; preds = %if.end8
  call fastcc void @invoke_syscall(%struct.pt_regs* noundef %regs, i32 noundef %call9) #8
  br label %trace_exit

if.then15:                                        ; preds = %if.end
  call fastcc void @invoke_syscall(%struct.pt_regs* noundef %regs, i32 noundef %scno) #8
  call fastcc void @local_daif_mask() #8
  %4 = load i64, i64* %flags1, align 8
  %call18 = call fastcc i1 @has_syscall_work(i64 noundef %4) #8
  %and19 = and i64 %4, 2097152
  %tobool20.not = icmp ne i64 %and19, 0
  %5 = or i1 %call18, %tobool20.not
  br i1 %5, label %if.end22, label %cleanup

if.end22:                                         ; preds = %if.then15
  call fastcc void @local_daif_restore() #8
  br label %trace_exit

trace_exit:                                       ; preds = %if.end13.thread, %if.end22, %if.end8
  call void @syscall_trace_exit(%struct.pt_regs* noundef %regs) #10
  br label %cleanup

cleanup:                                          ; preds = %if.then15, %trace_exit, %if.then
  ret void
}
...
entry:
  call void asm sideeffect "msr daif, ${0:x}", "rZ"(i64 0) #11, !srcloc !9
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid willreturn writeonly
define internal fastcc void @syscall_set_return_value(%struct.task_struct* nocapture noundef readnone %task, %struct.pt_regs* nocapture noundef writeonly %regs, i32 noundef %error, i64 noundef %val) unnamed_addr #1 {
entry:
  %tobool.not = icmp eq i32 %error, 0
  %conv = sext i32 %error to i64
  %spec.select = select i1 %tobool.not, i64 %val, i64 %conv
  %arrayidx = getelementptr %struct.pt_regs, %struct.pt_regs* %regs, i64 0, i32 0, i32 0, i32 0, i64 0
  store i64 %spec.select, i64* %arrayidx, align 8
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind null_pointer_is_valid readnone willreturn
define internal fastcc i1 @has_syscall_work(i64 noundef %flags) unnamed_addr #2 {
entry:
  %and = and i64 %flags, 7936
  %tobool = icmp ne i64 %and, 0
  ret i1 %tobool
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @syscall_trace_enter(%struct.pt_regs* noundef) local_unnamed_addr #3

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc void @invoke_syscall(%struct.pt_regs* noundef %regs, i32 noundef %scno) unnamed_addr #0 {
entry:
  %call5 = call fastcc i32 @static_key_count() #8
  %cmp6 = icmp sgt i32 %call5, 0
  br i1 %cmp6, label %if.then, label %do.end28, !prof !10

if.then:                                          ; preds = %entry
  %call24 = call fastcc i64 @__kern_my_cpu_offset() #8
  %add = add i64 %call24, ptrtoint (i32* @kstack_offset to i64)
  %0 = inttoptr i64 %add to i32*
  %1 = load i32, i32* %0, align 4
  %and = and i32 %1, 1023
  %conv26 = zext i32 %and to i64
  %2 = alloca i8, i64 %conv26, align 16
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %2, i8 0, i64 %conv26, i1 false), !annotation !11
  call void asm sideeffect "", "r,~{memory}"(i8* nonnull %2) #11, !srcloc !12
  br label %do.end28

do.end28:                                         ; preds = %if.then, %entry
  %cmp29 = icmp ult i32 %scno, 449
  br i1 %cmp29, label %if.then31, label %if.else

if.then31:                                        ; preds = %do.end28
  %conv32 = zext i32 %scno to i64
  %call34 = call fastcc i64 @array_index_mask_nospec(i64 noundef %conv32) #8
  %3 = trunc i64 %call34 to i32
  %conv44 = and i32 %3, %scno
  %idxprom = zext i32 %conv44 to i64
  %arrayidx = getelementptr [0 x i64 (%struct.pt_regs*)*], [0 x i64 (%struct.pt_regs*)*]* @sys_call_table, i64 0, i64 %idxprom
  %4 = load i64 (%struct.pt_regs*)*, i64 (%struct.pt_regs*)** %arrayidx, align 8
  %call45 = call fastcc i64 @__invoke_syscall(%struct.pt_regs* noundef %regs, i64 (%struct.pt_regs*)* noundef %4) #8
  br label %if.end47

if.else:                                          ; preds = %do.end28
  %call46 = call fastcc i64 @do_ni_syscall() #8
  br label %if.end47

if.end47:                                         ; preds = %if.else, %if.then31
  %ret.0 = phi i64 [ %call45, %if.then31 ], [ %call46, %if.else ]
  %5 = call i64 asm "mrs $0, sp_el0", "=r"() #9, !srcloc !8
  %6 = inttoptr i64 %5 to %struct.task_struct*
  call fastcc void @syscall_set_return_value(%struct.task_struct* noundef %6, %struct.pt_regs* noundef %regs, i32 noundef 0, i64 noundef %ret.0) #8
  %call65 = call fastcc i32 @static_key_count() #8
  %cmp66 = icmp sgt i32 %call65, 0
  br i1 %cmp66, label %if.then76, label %do.end117, !prof !10

if.then76:                                        ; preds = %if.end47
  %call91 = call fastcc i64 @__kern_my_cpu_offset() #8
  %add92 = add i64 %call91, ptrtoint (i32* @kstack_offset to i64)
  %7 = inttoptr i64 %add92 to i32*
  %8 = load i32, i32* %7, align 4
  %call94 = call fastcc i32 @get_random_int() #8
  %and95 = and i32 %call94, 511
  %xor = xor i32 %and95, %8
  %call109 = call fastcc i64 @__kern_my_cpu_offset() #8
  %add110 = add i64 %call109, ptrtoint (i32* @kstack_offset to i64)
  %9 = inttoptr i64 %add110 to i32*
  store i32 %xor, i32* %9, align 4
  br label %do.end117

do.end117:                                        ; preds = %if.then76, %if.end47
  ret void
}
...
entry:
  call void asm sideeffect "msr\09daifset, #0xf\09\09// local_daif_mask\0A", "~{memory}"() #11, !srcloc !13
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @syscall_trace_exit(%struct.pt_regs* noundef) local_unnamed_addr #3

; Function Attrs: mustprogress nofree noinline norecurse nounwind null_pointer_is_valid willreturn
define internal fastcc i32 @static_key_count() unnamed_addr #4 {
entry:
  %0 = load volatile i32, i32* getelementptr inbounds (%struct.static_key_false, %struct.static_key_false* @randomize_kstack_offset, i64 0, i32 0, i32 0, i32 0), align 4
  ret i32 %0
}
...
entry:
  %0 = call i64 asm sideeffect "\09cmp\09$1, $2\0A\09sbc\09$0, xzr, xzr\0A", "=r,r,Ir,~{cc}"(i64 %idx, i64 449) #11, !srcloc !15
  call void asm sideeffect "hint #20", "~{memory}"() #11, !srcloc !16
  ret i64 %0
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @__invoke_syscall(%struct.pt_regs* noundef %regs, i64 (%struct.pt_regs*)* nocapture noundef readonly %syscall_fn) unnamed_addr #0 {
entry:
  %call = call i64 %syscall_fn(%struct.pt_regs* noundef %regs) #10
  ret i64 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i64 @do_ni_syscall() unnamed_addr #0 {
entry:
  %call = call i64 @sys_ni_syscall() #10
  ret i64 %call
}

; Function Attrs: noinline nounwind null_pointer_is_valid
define internal fastcc i32 @get_random_int() unnamed_addr #0 {
entry:
  %call = call i32 @get_random_u32() #10
  ret i32 %call
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i64 @sys_ni_syscall() local_unnamed_addr #3
...
!12 = !{i64 2154953643}
!13 = !{i64 7278017}
!14 = !{i64 2149068741, i64 2149068788, i64 2149068794, i64 2149068831, i64 2149068849, i64 2149069776, i64 2149069824, i64 2149069872, i64 2149069935, i64 2149069984, i64 2149068927, i64 2149068952, i64 2149068978, i64 2149068984, i64 2149069021, i64 2149069027, i64 2149069077, i64 2149069123, i64 2149069156}
!15 = !{i64 356433, i64 356451}
!16 = !{i64 2147843635}
