; ModuleID = 'x509/crl_app.c'
source_filename = "x509/crl_app.c"
...
@.str = private unnamed_addr constant [98 x i8] c"\0A usage: crl_app param=<>...\0A\0A acceptable parameters:\0A    filename=%%s         default: crl.pem\0A\0A\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"crl.pem\00", align 1
...
@.str.3 = private unnamed_addr constant [25 x i8] c"\0A  . Loading the CRL ...\00", align 1
@stdout = external dso_local global %struct._IO_FILE*, align 8
@.str.4 = private unnamed_addr constant [55 x i8] c" failed\0A  !  mbedtls_x509_crl_parse_file returned %d\0A\0A\00", align 1
@.str.5 = private unnamed_addr constant [5 x i8] c" ok\0A\00", align 1
@.str.6 = private unnamed_addr constant [28 x i8] c"  . CRL information    ...\0A\00", align 1
@.str.7 = private unnamed_addr constant [7 x i8] c"      \00", align 1
@.str.8 = private unnamed_addr constant [49 x i8] c" failed\0A  !  mbedtls_x509_crl_info returned %d\0A\0A\00", align 1
...
entry:
  ...
  call void @mbedtls_x509_crl_init(%struct.mbedtls_x509_crl* noundef %crl) #4
...
usage:                                            ; preds = %if.else, %if.then4, %if.then
  %call = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str, i64 0, i64 0)) #4
  br label %exit

if.end:                                           ; preds = %entry
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i8** getelementptr inbounds (%struct.options, %struct.options* @opt, i32 0, i32 0), align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %call12 = call i32 @mbedtls_x509_crl_parse_file(%struct.mbedtls_x509_crl* noundef %crl, i8* noundef %12) #4
...
if.then14:                                        ; preds = %for.end
  ...
  call void @mbedtls_x509_crl_free(%struct.mbedtls_x509_crl* noundef %crl) #4
  br label %exit
...
if.end16:                                         ; preds = %for.end
  ...
  %call19 = call i32 @mbedtls_x509_crl_info(i8* noundef %arraydecay, i64 noundef 99999, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i64 0, i64 0), %struct.mbedtls_x509_crl* noundef %crl) #4
...
declare dso_local i32 @mbedtls_x509_crl_info(i8* noundef, i64 noundef, i8* noundef, %struct.mbedtls_x509_crl* noundef) #1
