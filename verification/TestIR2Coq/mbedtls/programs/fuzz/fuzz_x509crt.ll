; ModuleID = 'fuzz_x509crt.c'
source_filename = "fuzz_x509crt.c"
...
entry:
  ...
  call void @mbedtls_x509_crt_init(%struct.mbedtls_x509_crt* noundef %crt) #2
  %0 = load i8*, i8** %Data.addr, align 8
  %1 = load i64, i64* %Size.addr, align 8
  %call = call i32 @mbedtls_x509_crt_parse(%struct.mbedtls_x509_crt* noundef %crt, i8* noundef %0, i64 noundef %1) #2
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 @mbedtls_x509_crt_info(i8* noundef %arraydecay, i64 noundef 4095, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), %struct.mbedtls_x509_crt* noundef %crt) #2
  store i32 %call1, i32* %ret, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  call void @mbedtls_x509_crt_free(%struct.mbedtls_x509_crt* noundef %crt) #2
  ret i32 0
}
