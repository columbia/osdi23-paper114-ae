...
Section Accessors_get_int_gpr_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition get_int_gpr_spec_low (v_vmid: Z) (v_vcpuid: Z) (v_index: Z) (st: RData) : (option (Z * RData)) :=
    ...
    when v_0, st == ((load_RData 8 v_arrayidx3 st));
    let __return__ := true in
    let __retval__ := v_0 in
    (Some (__retval__, st)).

End Accessors_get_int_gpr_LowSpec.

#[global] Hint Unfold get_int_gpr_spec_low: spec.
