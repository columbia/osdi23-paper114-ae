...
Section Accessors_hypsec_vcpu_id_to_shadow_ctxt_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition hypsec_vcpu_id_to_shadow_ctxt_spec_low (v_vmid: Z) (v_vcpu_id: Z) (st: RData) : (option (Ptr * RData)) :=
    ...
    match (
      ...
      then (
        ...
        let v_arrayidx := (ptr_offset v_call ((33731152 * 0) + (33555568 + ((1808 * v_idxprom) + 0)))) in
...
End Accessors_hypsec_vcpu_id_to_shadow_ctxt_LowSpec.

#[global] Hint Unfold hypsec_vcpu_id_to_shadow_ctxt_spec_low: spec.
