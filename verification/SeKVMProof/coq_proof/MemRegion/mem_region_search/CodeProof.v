...
Section MemRegion_mem_region_search_CodeProof.
  ...
  Local Opaque get_mem_region_cnt_spec.
    ...
    Lemma f_mem_region_search_correct:
      forall v_addr st st' res
             (Hspec: mem_region_search_spec_low v_addr st = Some (res, st')),
        exec_func SmmuPTOps_layer code "mem_region_search"
                  [VInt v_addr]
                  st st' (Some (VInt res)).
    Proof.
      intros; simpl_func Hspec; simpl in *; try solve[try_solve];
        try solve[ eapply exec_func_call; try reflexivity; vcgen].
      remember (fbody Code.f_mem_region_search) as fcode eqn:Hc; simpl in Hc;
        match type of Hc with
        | context[ILoop ?body] => remember body as LoopBody eqn:Cloop; clear Hc
        end.
      match goal with
      | [H: mem_region_search_loop_low ?n ?_a0 ?_a1 ?_a2 ?_a3 ?_a4 ?_st =
          ...
          assert(HLoop: forall te,
                  ...
                  gets "v_i_019" te = Some (VInt _a2) ->
                  gets "v_res_018" te = Some (VInt _a3) ->
                  (forall s, inlist s ("v_addr"::"v_res_018"::"v_i_019"::"v_cmp17_not"::"v_call"::nil) = false -> gets s te = None) ->
                  exec SmmuPTOps_layer code (ILoop LoopBody :: nil) te _st
                      (sets "v_addr" (VInt _a0')
                      (sets "v_call" (VInt _a1')
                      (sets "v_i_019" (VInt _a2')
                      (sets "v_res_018" (VInt _a3')
                      (sets "v_res_0_lcssa" (VInt _a4')
                          te))))) out_normal _st')
      end.
      {
        intros te ? ? ? ? te_all.
        unfold mem_region_search_loop_rank in *.
        match goal with
        | [H: mem_region_search_loop_low (z_to_nat ?n) ?_a0 ?_a1 ?_a2 ?_a3 ?_a4 ?_st =
            ...
            set(Inv := fun t s w => exists _a0'' _a1'' _a2'' _a3'' _a4'' _st'',
                        mem_region_search_loop_low (z_to_nat (W0 - w)) _a0 _a1 _a2 _a3 _a4 _st = Some (_a0'', _a1'', _a2'', _a3'', _a4'', _st'')
                        /\ (mem_region_search_loop_rank _a0'' _a1'' _a2'' _a3'') = w
                        /\ 0 < w <= W0
                        /\ s = _st''
                        /\ (forall p v, gets p
                                        (sets "v_addr" (VInt _a0'')
            ...
            assert(loop_succ: forall W, Z.of_nat W <= W0 -> exists _a0'' _a1'' _a2'' _a3'' _a4'' _st'',
                    mem_region_search_loop_low (z_to_nat (W0 - Z.of_nat W)) _a0 _a1 _a2 _a3 _a4 _st =
                    Some (_a0'', _a1'', _a2'', _a3'', _a4'', _st''))
        end.
        ...
        assert(HLoop: Loop SmmuPTOps_layer code LoopBody P Q R).
        {
          ...
          - unfold P, Inv. intros ? ? (CC1 & CC2).
            ...
            subst; repeat eexists; try solve[unfold mem_region_search_loop_rank in *; simpl; try_solve].
...
End MemRegion_mem_region_search_CodeProof.
