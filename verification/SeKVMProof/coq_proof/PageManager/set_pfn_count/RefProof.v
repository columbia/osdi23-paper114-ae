...
Section PageManager_set_pfn_count_RefProof.
  ...
  Lemma f_set_pfn_count_refine:
    forall v_pfn v_count lst hst hst'
           (Hrel: refrel hst lst)
           (Hspec: set_pfn_count_spec v_pfn v_count hst = Some hst'),
      exists lst', set_pfn_count_spec_low v_pfn v_count lst = Some lst' /\ refrel hst' lst'.
    Proof.
      intros; inv Hrel.
