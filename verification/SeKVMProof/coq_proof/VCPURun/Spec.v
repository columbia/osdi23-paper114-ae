...
Section VCPURun_Spec.
  ...
  Fixpoint __kvm_vcpu_run_nvhe_loop (_N_: nat) (v_0: Ptr) (v_call1: Ptr) (v_call4: Ptr) (v_fp_regs: Ptr) (v_fp_regs8: Ptr) (v_retval_0: Z) (v_vcpu_id: Z) (v_vmid: Z) (st: RData) : (option (Ptr * Ptr * Ptr * Ptr * Ptr * Z * Z * Z * RData)) :=
    match (_N_) with
    | O => (Some (v_0, v_call1, v_call4, v_fp_regs, v_fp_regs8, v_retval_0, v_vcpu_id, v_vmid, st))
    | (S _N_) =>
      match ((__kvm_vcpu_run_nvhe_loop _N_ v_0 v_call1 v_call4 v_fp_regs v_fp_regs8 v_retval_0 v_vcpu_id v_vmid st)) with
  ...
  Definition __kvm_vcpu_run_nvhe_spec (v_vmid: Z) (v_vcpu_id: Z) (st: RData) : (option (Z * RData)) :=
...
#[global] Hint Unfold __kvm_vcpu_run_nvhe_loop_rank: spec.
#[global] Hint Unfold __kvm_vcpu_run_nvhe_loop: spec.
Opaque __kvm_vcpu_run_nvhe_spec.
