...
Section S2PTWalk_walk_pgd_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition walk_pgd_spec_low (v_vmid: Z) (v_vttbr: Z) (v_addr: Z) (v_alloc: Z) (st: RData) : (option (Z * RData)) :=
    let v_and1 := (v_vttbr & 281474976706560) in
    ...
    when v_ret_0, st == (
        ...
        then (
          ...
          when v_ret_0, st == (
              ...
              if v_or_cond
              then (
                when v_call8, st == ((alloc_s2pt_pgd_spec v_vmid st));
...
End S2PTWalk_walk_pgd_LowSpec.

#[global] Hint Unfold walk_pgd_spec_low: spec.
