...
Section S2PTWalk_walk_pud_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition walk_pud_spec_low (v_vmid: Z) (v_pgd: Z) (v_addr: Z) (v_alloc: Z) (st: RData) : (option (Z * RData)) :=
    ...
    when v_ret_0, st == (
        ...
        then (
          ...
          when v_ret_0, st == (
              ...
              if v_or_cond
              then (
                when v_call8, st == ((alloc_s2pt_pud_spec v_vmid st));
...
End S2PTWalk_walk_pud_LowSpec.

#[global] Hint Unfold walk_pud_spec_low: spec.
