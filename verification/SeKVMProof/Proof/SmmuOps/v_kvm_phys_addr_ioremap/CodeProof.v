...
Section SmmuOps_v_kvm_phys_addr_ioremap_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque map_io_spec.

    Lemma f_v_kvm_phys_addr_ioremap_correct:
      forall v_vmid v_gpa v_pa v_size st st'
             (Hspec: v_kvm_phys_addr_ioremap_spec_low v_vmid v_gpa v_pa v_size st = Some st'),
        exec_func SmmuOpsAux_layer code "v_kvm_phys_addr_ioremap"
                  [VInt v_vmid; VInt v_gpa; VInt v_pa; VInt v_size]
                  st st' None.
    Proof.
      intros; simpl_func Hspec; simpl in *; try solve[try_solve];
        try solve[ eapply exec_func_call; try reflexivity; vcgen].
      remember (fbody Code.f_v_kvm_phys_addr_ioremap) as fcode eqn:Hc; simpl in Hc;
        match type of Hc with
        | context[ILoop ?body] => remember body as LoopBody eqn:Cloop; clear Hc
        end.
      match goal with
      | [H: v_kvm_phys_addr_ioremap_loop_low ?n ?_a0 ?_a1 ?_a2 ?_a3 ?_st =
          Some (?_a0', ?_a1', ?_a2', ?_a3', ?_st') |- _] =>
          rename H into Hfinal;
          assert(HLoop: forall te,
                  gets "v_gpa_addr_010" te = Some (VInt _a0) ->
                  gets "v_n_011" te = Some (VInt _a1) ->
                  gets "v_pa_addr_09" te = Some (VInt _a2) ->
                  gets "v_vmid" te = Some (VInt _a3) ->
                  (forall s, inlist s ("v_vmid"::"v_gpa"::"v_pa"::"v_size"::"v_pa_addr_09"::"v_gpa_addr_010"::"v_n_011"::"v_div"::"v_cmp_not8"::"v_add"::nil) = false -> gets s te = None) ->
                  exec SmmuOpsAux_layer code (ILoop LoopBody :: nil) te _st
                      (sets "v_gpa_addr_010" (VInt _a0')
                      (sets "v_n_011" (VInt _a1')
                      (sets "v_pa_addr_09" (VInt _a2')
                      (sets "v_vmid" (VInt _a3')
                          te)))) out_normal _st')
      end.
      {
        intros te ? ? ? ? te_all.
        unfold v_kvm_phys_addr_ioremap_loop_rank in *.
        match goal with
        | [H: v_kvm_phys_addr_ioremap_loop_low (z_to_nat ?n) ?_a0 ?_a1 ?_a2 ?_a3 ?_st =
                Some (?_a0', ?_a1', ?_a2', ?_a3', ?_st') |-
            ...
            set(Inv := fun t s w => exists _a0'' _a1'' _a2'' _a3'' _st'',
                        v_kvm_phys_addr_ioremap_loop_low (z_to_nat (W0 - w)) _a0 _a1 _a2 _a3 _st = Some (_a0'', _a1'', _a2'', _a3'', _st'')
                        /\ (v_kvm_phys_addr_ioremap_loop_rank _a0'' _a1'' _a2'' _a3'') = w
                        /\ 0 < w <= W0
                        /\ s = _st''
                        /\ (forall p v, gets p
                                        (sets "v_gpa_addr_010" (VInt _a0'')
            ...
            assert(loop_succ: forall W, Z.of_nat W <= W0 -> exists _a0'' _a1'' _a2'' _a3'' _st'',
                    v_kvm_phys_addr_ioremap_loop_low (z_to_nat (W0 - Z.of_nat W)) _a0 _a1 _a2 _a3 _st =
                    Some (_a0'', _a1'', _a2'', _a3'', _st''))
        end.
        ...
        assert(HLoop: Loop SmmuOpsAux_layer code LoopBody P Q R).
        {
          ...
          - unfold P, Inv. intros ? ? (CC1 & CC2).
            ...
            subst; repeat eexists; try solve[unfold v_kvm_phys_addr_ioremap_loop_rank in *; simpl; try_solve].
...
End SmmuOps_v_kvm_phys_addr_ioremap_CodeProof.
