...
Require Import MemoryOps.v_revoke_stage2_sg_gpa.LowSpec.
...
Section MemoryOps_v_revoke_stage2_sg_gpa_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque revoke_vm_page_spec.
  Local Opaque walk_s2pt_spec.

    Lemma f_v_revoke_stage2_sg_gpa_correct:
      forall v_vmid v_addr v_size st st'
             (Hspec: v_revoke_stage2_sg_gpa_spec_low v_vmid v_addr v_size st = Some st'),
        exec_func VMOpsAux_layer code "v_revoke_stage2_sg_gpa"
    ...
    Proof.
      ...
      remember (fbody Code.f_v_revoke_stage2_sg_gpa) as fcode eqn:Hc; simpl in Hc;
        match type of Hc with
        | context[ILoop ?body] => remember body as LoopBody eqn:Cloop; clear Hc
        end.
      match goal with
      | [H: v_revoke_stage2_sg_gpa_loop_low ?n ?_a0 ?_a1 ?_a2 ?_st =
      ...
      {
        intros te ? ? ? te_all.
        unfold v_revoke_stage2_sg_gpa_loop_rank in *.
        match goal with
        | [H: v_revoke_stage2_sg_gpa_loop_low (z_to_nat ?n) ?_a0 ?_a1 ?_a2 ?_st =
            ...
            set(Inv := fun t s w => exists _a0'' _a1'' _a2'' _st'',
                        v_revoke_stage2_sg_gpa_loop_low (z_to_nat (W0 - w)) _a0 _a1 _a2 _st = Some (_a0'', _a1'', _a2'', _st'')
                        /\ (v_revoke_stage2_sg_gpa_loop_rank _a0'' _a1'' _a2'') = w
                        /\ 0 < w <= W0
                        /\ s = _st''
                        /\ (forall p v, gets p
                                        (sets "v_addr_addr_044" (VInt _a0'')
            ...
            assert(loop_succ: forall W, Z.of_nat W <= W0 -> exists _a0'' _a1'' _a2'' _st'',
                    v_revoke_stage2_sg_gpa_loop_low (z_to_nat (W0 - Z.of_nat W)) _a0 _a1 _a2 _st =
                    Some (_a0'', _a1'', _a2'', _st''))
        end.
        ...
        assert(HLoop: Loop VMOpsAux_layer code LoopBody P Q R).
        {
          ...
          - unfold P, Inv. intros ? ? (CC1 & CC2).
            ...
            subst; repeat eexists; try solve[unfold v_revoke_stage2_sg_gpa_loop_rank in *; simpl; try_solve].
...
End MemoryOps_v_revoke_stage2_sg_gpa_CodeProof.
