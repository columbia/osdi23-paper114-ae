...
Section Accessors_pud_pool_end_LowSpec.

  Context `{int_ptr: IntPtrCast}.

  Definition pud_pool_end_spec_low (v_vmid: Z) (st: RData) : (option (Z * RData)) :=
...
End Accessors_pud_pool_end_LowSpec.

#[global] Hint Unfold pud_pool_end_spec_low: spec.
