...
Section S2PTWalk_walk_pmd_CodeProof.

  Context `{int_ptr: IntPtrCast}.

  Local Opaque pt_store_spec.
  Local Opaque pt_load_spec.
  Local Opaque alloc_s2pt_pmd_spec.

    Lemma f_walk_pmd_correct:
      forall v_vmid v_pgd v_addr v_alloc st st' res
             (Hspec: walk_pmd_spec_low v_vmid v_pgd v_addr v_alloc st = Some (res, st')),
        exec_func S2PTAlloc_layer code "walk_pmd"
...
End S2PTWalk_walk_pmd_CodeProof.
