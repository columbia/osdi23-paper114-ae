...
Parameter SmmuReadWrite_init: RData.

Section SmmuReadWrite_Layer.

  Context `{int_ptr: IntPtrCast}.

  Definition SmmuReadWrite_load (size: Z) (p: Ptr) (st: RData) : option (Z * RData) := None.

  Definition SmmuReadWrite_store (size: Z) (p: Ptr) (val: Z) (st: RData) : option RData := None.

  Definition SmmuReadWrite_alloca (size: Z) (align: Z) (st: RData) : option (Ptr * RData) := None.

  Definition SmmuReadWrite_free (p: Ptr) (st: RData) : option RData := None.

  Definition SmmuReadWrite_get_reg (reg: regset) (st: RData) : option Z := None.

  Definition SmmuReadWrite_set_reg (reg: regset) (val: Z) (st: RData) : option RData := None.

  Definition SmmuReadWrite_get_flag (f: flag) (st: RData) : bool := false.

  Definition SmmuReadWrite_set_flag (f: flag) (val: bool) (st: RData) : option RData := None.

  Definition SmmuReadWrite_layer :=
    {|
      State := RData;
      Init := SmmuReadWrite_init;
      Load := SmmuReadWrite_load;
      Store := SmmuReadWrite_store;
      Alloca := SmmuReadWrite_alloca;
      Free := SmmuReadWrite_free;
      GetReg := SmmuReadWrite_get_reg;
      SetReg := SmmuReadWrite_set_reg;
      GetFlag := SmmuReadWrite_get_flag;
      SetFlag := SmmuReadWrite_set_flag;
      PrimCall :=
          ...
          :: ("handle_smmu_read", prim handle_smmu_read_spec)
          ...
          :: ("handle_smmu_write", prim handle_smmu_write_spec)
