...
Section SmmuPTOps_walk_spt_CodeProof.
  ...
  Local Opaque release_lock_spt_spec.
    ...
    Lemma f_walk_spt_correct:
      forall v_cbndx v_index v_addr st st' res
             (Hspec: walk_spt_spec_low v_cbndx v_index v_addr st = Some (res, st')),
        exec_func SmmuPTTreeOps_layer code "walk_spt"
...
End SmmuPTOps_walk_spt_CodeProof.
