...
Parameter GuestExit_init: RData.

Section GuestExit_Layer.

  Context `{int_ptr: IntPtrCast}.

  Definition GuestExit_load (size: Z) (p: Ptr) (st: RData) : option (Z * RData) := None.

  Definition GuestExit_store (size: Z) (p: Ptr) (val: Z) (st: RData) : option RData := None.

  Definition GuestExit_alloca (size: Z) (align: Z) (st: RData) : option (Ptr * RData) := None.

  Definition GuestExit_free (p: Ptr) (st: RData) : option RData := None.

  Definition GuestExit_get_reg (reg: regset) (st: RData) : option Z := None.

  Definition GuestExit_set_reg (reg: regset) (val: Z) (st: RData) : option RData := None.

  Definition GuestExit_get_flag (f: flag) (st: RData) : bool := false.

  Definition GuestExit_set_flag (f: flag) (val: bool) (st: RData) : option RData := None.

  Definition GuestExit_layer :=
    {|
      State := RData;
      Init := GuestExit_init;
      Load := GuestExit_load;
      Store := GuestExit_store;
      Alloca := GuestExit_alloca;
      Free := GuestExit_free;
      GetReg := GuestExit_get_reg;
      SetReg := GuestExit_set_reg;
      GetFlag := GuestExit_get_flag;
      SetFlag := GuestExit_set_flag;
      PrimCall :=
          ...
          :: ("fixup_guest_exit", prim fixup_guest_exit_spec)
